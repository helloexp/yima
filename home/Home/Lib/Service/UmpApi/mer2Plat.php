...
class MerToPlat {
    ...
    public static function makeRequestDataByGet($map) {
        ...
        $reqData = $util->makeRequestData(plat_pay_product_name, $map, 
            method_get);
        return $reqData;
    }
    ...
    public static function requestTransactionsByGet($map) {
        $util = new ReqDataUtil();
        $reqData = $util->getRequestData(plat_pay_product_name, $map, 
            method_get);
        return $reqData;
    }
    ...
    /**
     * 以GET请求方式获取统一支付方式请求数据 参数详见《UMPAY_SW_支付业务_手机银行卡商户接入规范》文档:商户向平台下订单接口，统一支付页面
     *
     * @param $map 请求数据,数据类型:HashMap
     * @return 请求数据对象ReqData
     */
    public static function webReqPayByGet($map) {
        $util = new ReqDataUtil();
        $reqData = $util->getReqData(plat_pay_product_name, $map, 
            funcode_webReqPay, method_get);
        return $reqData;
    }

    /**
     * 以POST请求方式获取统一支付方式请求数据 参数详见《UMPAY_SW_支付业务_手机银行卡商户接入规范》文档:商户向平台下订单接口，统一支付页面
     *
     * @param $map 请求数据,数据类型:HashMap
     * @return 请求数据对象ReqData
     */
    ...
    public static function reqWyByGet($map) {
        $util = new ReqDataUtil();
        $reqData = $util->getReqData(plat_pay_product_name, $map, 
            funcode_webDirectWyPay, method_get);
        return $reqData;
    }
    ...
    public static function reqWyByPost($map) {
        $util = new ReqDataUtil();
        $reqData = $util->getReqData(plat_pay_product_name, $map, 
            funcode_webDirectWyPay, method_post);
        return $reqData;
    }
    ...
    public static function queryTransByPost($map) {
        $util = new ReqDataUtil();
        $reqData = $util->getReqData(plat_pay_product_name, $map, 
            funcode_queryTrans, method_post);
        return $reqData;
    }
    ...
    public static function settleBillByPost($map) {
        $util = new ReqDataUtil();
        $reqData = $util->getReqData(plat_pay_product_name, $map, 
            funcode_settleBill, method_post);
        return $reqData;
    }
    ...
    public static function microPayReqByGet($map) {
        $util = new ReqDataUtil();
        $reqData = $util->getReqData(plat_micropay_product_name, $map, 
            funcode_microPayReq, method_get);
        return $reqData;
    }
    ...
    public static function microPayReqByPost($map) {
        $util = new ReqDataUtil();
        $reqData = $util->getReqData(plat_micropay_product_name, $map, 
            funcode_microPayReq, method_post);
        return $reqData;
    }
    ...
    public static function billFileHfByPost($map) {
        $util = new ReqDataUtil();
        $reqData = $util->getReqData(plat_pay_product_name, $map, 
            funcode_billFileHf, method_post);
        return $reqData;
    }
