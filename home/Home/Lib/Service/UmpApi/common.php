...
// 微支付撤销
define("umpay_urls", 
    "webReqPay=/ms/reqPayWeb.ms;directPay=/ms/directOrder.ms;" .
...
// ---------------------------------------------------------
// 分账下单数据字段
define("pay_req_split", 
    "service=32;charset=16;mer_id=8;sign_type=8;ret_url=128;notify_url=128;version=3;order_id=32;mer_date=8;amount=13;amt_type=8;");
define("pay_req_split1", 
    "res_format=16;goods_id=8;goods_inf=64;media_id=32;media_type=16;pay_type=16;gate_id=16;mer_priv=128;user_ip=16;expand=128;expire_time=8;split_data=256;split_type=9");
// 分账请求数据字段
// define ( "split_req",
// "service=32;charset=16;mer_id=8;sign_type=8;version=3;order_id=32;mer_date=8;amount=13;amt_type=8;split_type=2;split_data=256"
// );
// define ( "split_req1", "notify_url=128;res_format=128" );
// 分账退费数据字段
define("split_refund_req", 
    "service=32;charset=16;mer_id=8;sign_type=8;version=3;refund_no=16;order_id=32;mer_date=8;refund_amount=13;org_amount=13;sub_mer_id=8;sub_order_id=32");
define("split_refund_req1", "refund_desc=128;notify_url=128;res_format=128");
// 信用卡直连数据字段
define("credit_direct_pay", 
    "service=32;charset=16;mer_id=8;sign_type=8;version=3;order_id=32;mer_date=8;amount=13;amt_type=8;pay_type=16;card_id=32;valid_date=8;cvv2=32");
define("credit_direct_pay1", 
    "pass_wd=32;identity_type=32;identity_code=32;card_holder=32;mer_priv=128;expand=128;expire_time=8;split_data=256;split_type=9;goods_id=8;goods_inf=64;media_id=32;media_type=16;notify_url=128;res_format=128");
// 借记卡直连数据字段
define("debit_direct_pay", 
    "service=32;charset=16;mer_id=8;sign_type=8;version=3;order_id=32;mer_date=8;amount=13;amt_type=8;pay_type=16;card_id=32");
define("debit_direct_pay1", 
    "pass_wd=32;mer_priv=128;expand=128;expire_time=8;split_data=256;split_type=9;goods_id=8;goods_inf=64;media_id=32;media_type=16;notify_url=128;res_format=128;identity_type=32;identity_code=32;card_holder=32");
// 无线类支付数据字段
define("pay_req", 
    "service=32;charset=16;mer_id=8;sign_type=8;notify_url=128;version=3;order_id=32;mer_date=8;amount=13;amt_type=8");
define("pay_req1", 
    "goods_id=8;goods_inf=64;ret_url=128;media_id=32;media_type=16;pay_type=16;gate_id=16;mer_priv=128;user_ip=16;expand=128;expire_time=8;split_category=1;split_type=2;split_data=256");
// 订单查询请求数据字段
define("query_order", 
    "service=32;sign_type=8;charset=16;order_id=32;mer_id=8;version=3;mer_date=8");
define("query_order1", 
    "amount=13;trade_no=16;goods_id=8;media_id=32;media_type=16;res_format=16");
// 订单查询（支持12月）
define("mer_order_info_query", 
    "service=32;sign_type=8;charset=16;order_id=32;mer_id=8;version=3;mer_date=8;");
define("mer_order_info_query1", "res_format=16;order_type=1");
// 退费订单查询（支持12月）
define("mer_refund_query", 
    "service=32;sign_type=8;charset=16;mer_id=8;version=3;refund_no=16");
define("mer_refund_query1", "res_format=16;");
// 分账订单查询
define("query_split_order", 
    "service=32;sign_type=8;charset=16;order_id=32;mer_id=8;version=3;mer_date=8");
...
// 商户撤销请求数据字段
define("mer_cancel", 
    "service=32;sign_type=8;charset=16;order_id=32;mer_id=8;version=3;amount=13;mer_date=8");
define("mer_cancel1", "res_format=16");
// 商户退费请求数据字段
define("mer_refund", 
    "service=32;sign_type=8;charset=16;order_id=32;mer_id=8;version=3;org_amount=13;refund_no=16;mer_date=8");
define("mer_refund1", "res_format=16;notify_url=128;refund_amount=13");
// 商户退费请求数据字段
define("pay_guide", 
    "service=32;sign_type=8;charset=16;token=32;mer_id=8;version=3");
define("pay_guide1", "res_format=16");
// 商户清算队长请求数据字段
define("download_settle_file", 
    "service=32;sign_type=8;mer_id=8;version=3;settle_date=8");
define("download_settle_file1", "res_format=16");
// 信用卡快捷确认支付，必填字段，非必填字段
define("pay_confirm", 
    "service=32;charset=16;mer_id=8;sign_type=8;version=3;trade_no=16;verify_code=4;pay_category=2;card_id=32;valid_date=8;cvv2=32");
define("pay_confirm1", 
    "media_id=32;media_type=16;pass_wd=6;res_format=16;identity_type=32;identity_code=32;card_holder=32");
// 获取短信验证码
define("req_sms_verifycode", 
    "service=32;charset=16;mer_id=8;sign_type=8;version=3;trade_no=16;media_id=32;media_type=16");
define("req_sms_verifycode1", "res_format=16");
// 付款API-下单
define("transfer_direct_req", 
    "service=32;charset=16;mer_id=8;sign_type=8;notify_url=128;version=3;order_id=32;mer_date=8;amount=13;recv_account_type=2;recv_bank_acc_pro=1;recv_account=30;recv_user_name=30;recv_gate_id=16;purpose=20;prov_name=20;city_name=20;bank_brhname=60");
define("transfer_direct_req1", 
    "res_format=16;media_id=32;media_type=16;identity_type=2;identity_code=32;identity_holder=30");
// 付款API-订单查询
define("transfer_query", 
    "service=32;sign_type=8;charset=16;order_id=32;mer_id=8;version=3;mer_date=8");
define("transfer_query1", "res_format=16");
// 商户现金账户余额查询
define("query_account_balance", 
    "service=32;sign_type=8;charset=16;mer_id=8;version=3");
define("query_account_balance1", "res_format=16");
// 一键快捷-前台支付请求
define("pay_req_shortcut_front", 
    "service=32;charset=16;mer_id=8;sign_type=8;ret_url=128;notify_url=128;version=3;order_id=32;mer_date=8;amount=13;amt_type=8");
define("pay_req_shortcut_front1", 
    "res_format=16;goods_id=8;goods_inf=64;media_id=32;media_type=16;pay_type=16;gate_id=16;mer_priv=128;user_ip=16;expand=128;expire_time=8;split_category=1;split_type=2;split_data=256");
// 一键快捷-API下单
define("pay_req_shortcut", 
    "service=32;charset=16;mer_id=8;sign_type=8;notify_url=128;version=3;order_id=32;mer_date=8;amount=13;amt_type=8");
define("pay_req_shortcut1", 
    "goods_id=8;goods_inf=64;mer_priv=128;expand=128;expire_time=8;split_category=1;split_type=2;split_data=256");
// 一键快捷-获取短信验证码
define("req_smsverify_shortcut", 
    "service=32;charset=16;mer_id=8;sign_type=8;version=3;trade_no=16;media_id=32;media_type=16");
define("req_smsverify_shortcut1", 
    "pay_type=16;card_id=32;valid_date=8;cvv2=32;identity_type=32;identity_code=32;card_holder=32;mer_cust_id=32;usr_busi_agreement_id=64;usr_pay_agreement_id=64");
// 一键快捷-确认支付
define("pay_confirm_shortcut", 
    "service=32;charset=16;mer_id=8;sign_type=8;version=3;trade_no=16;media_id=32;media_type=16");
define("pay_confirm_shortcut1", 
    "pay_type=16;card_id=32;valid_date=8;cvv2=32;identity_type=32;identity_code=32;card_holder=32;mer_cust_id=32;usr_busi_agreement_id=64;usr_pay_agreement_id=64");
// 一键快捷-首次支付确认支付
define("first_pay_confirm_shortcut", 
    "service=32;charset=16;mer_id=8;sign_type=8;version=3;trade_no=16;media_id=32;media_type=16;card_id=32");
define("first_pay_confirm_shortcut1", 
    "verify_code=8;valid_date=8;cvv2=32;identity_type=32;identity_code=32;card_holder=32;mer_cust_id=32");
// 一键快捷-协议支付确认支付
define("agreement_pay_confirm_shortcut", 
    "service=32;charset=16;mer_id=8;sign_type=8;version=3;trade_no=16;usr_pay_agreement_id=64");
define("agreement_pay_confirm_shortcut1", 
    "verify_code=8;birthday=8;valid_date=8;cvv2=32;mer_cust_id=32;usr_busi_agreement_id=64");
// 一键快捷-API绑定协议申请
define("req_bind_verify_shortcut", 
    "service=32;mer_id=8;sign_type=8;version=3;media_id=32;media_type=16;card_id=32");
define("req_bind_verify_shortcut1", 
    "valid_date=8;cvv2=32;identity_type=32;identity_code=32;card_holder=32");
// 一键快捷-API绑定协议确认
define("req_bind_confirm_shortcut", 
    "service=32;charset=16;mer_id=8;sign_type=8;version=3;media_id=32;media_type=16;card_id=32");
define("req_bind_confirm_shortcut1", 
    "verify_code=8;reg_no=16;valid_date=8;cvv2=32;identity_type=32;identity_code=32;card_holder=32;mer_cust_id=32");

// 一键快捷-查询商户支持的银行列表
define("query_mer_bank_shortcut", 
    "service=32;charset=16;mer_id=8;sign_type=8;version=3;pay_type=16");
define("query_mer_bank_shortcut1", "res_format=16");
// 一键快捷-查询商户用户已签约的银行列表
define("query_mercust_bank_shortcut", 
    "service=32;charset=16;mer_id=8;sign_type=8;version=3;pay_type=16;");
define("query_mercust_bank_shortcut1", 
    "res_format=16;mer_cust_id=32;usr_busi_agreement_id=64");
// 一键快捷-商户解除用户关联
define("unbind_mercust_protocol_shortcut", 
    "service=32;charset=16;mer_id=8;sign_type=8;version=3;");
define("unbind_mercust_protocol_shortcut1", 
    "res_format=16;mer_cust_id=32;usr_busi_agreement_id=64");
// 实名认证
define("card_auth", 
    "service=32;charset=16;mer_id=8;sign_type=8;version=3;mer_date=8;card_id=32;valid_date=8;cvv2=32;identity_type=32;identity_code=32;card_holder=32;");
...
class HashMap {
    ...
    /*
     * 向HashMap中添加一个键值对 @param $key 插入的键 @param $value 插入的值
     */
     ...
     */
    /*
     * 删除指定key的键值对 @param $key 要移除键值对的key
     */
...
class StringUtil {
    ...
    /**
     * getPlainSortAndByAnd方法
     * 使用&符号组织签名明文串排序a-z，如：merId=9996&goodsId=100&version=3.0
     *
     * @param HashMap $map
     */
    public static function getPlainSortAndByAnd($map) {
        ...
        if ((! $map->isEmpty()) && ($map->size() > 0)) {
            $keys = $map->keys();
            foreach ($keys as $key) {
                // $log->logInfo (" ssssssgetRequestData plain111122333=" .
                // $keys );
                // 如果是sign_type 不许要参与RAS签名
                if ("sign_type" != $key) {
                    $plain = $plain . $key . "=" . trim($map->get($key)) . "|";
                    // $paramter = explode ( "&", $plain );
                    $paramter[$key . "=" . trim($map->get($key))] = $key . "=" .
                         trim($map->get($key));
                }
            }
            $plain = substr($plain, 0, strlen($plain) - 1);
            ...
            $arg = substr($arg, 0, count($arg) - 2); // 去掉最后一个&字符
                                                     // die (
                                                     // "使用&组织签名明文串失败:传入参数为空!".$arg."|".plain
                                                     // );
            return $arg;
        } else {
            die(
                "Use & organize signature plaintext string failure: incoming parameters is empty!");
            return null;
        }
    ...
    /**
     * V4.0排序方法 arg_sort方法 对数组排序排序a-z
     *
     * @param $array $map排序前的数组 return 排序后的数组
     */
        ...
        if ((! $map->isEmpty()) && ($map->size() > 0)) {
            ...
            foreach ($keys as $key) {
                $param = $param . $key . "=" . urlencode(trim($map->get($key))) .
                     "&";
                $paramter[$key . "=" . urlencode(trim($map->get($key)))] = $key .
                     "=" . urlencode(trim($map->get($key)));
            }
            $param = substr($param, 0, strlen($param) - 1);
        ...
        if (count($fields) > 0) {
            foreach ($fields as $field) {
                ...
                if (count($values) == 2) {
                    ...
                    $map->put($values[0], 
                        substr($field, strlen($values[0]) + 1));
                }
            }
        }
        return $map;
...
class Logger {
    ...
    public static function logInfo($msg) {
        ...
        $msg = date("[Y-m-d H:i:s]") . "-[" . $_SERVER['HTTP_REFERER'] .
             "]-[data] :" . $msg . "\n";
...
class CheckReqDataAndEncrypt {
    ...
    public static function doCheck($map) {
        ...
        if (count(CheckReqDataAndEncrypt::$keysarray) <= 0) {
            ...
            CheckReqDataAndEncrypt::$keysarray = parse_ini_file(
                "mapping_keys.ini");
        }
        $keys = CheckReqDataAndEncrypt::$keysarray["Service." . $service];
        if (empty($keys)) {
            $log->logInfo(
                "Not configure corresponding " . $service .
                     " interface parameter information,Please in mapping_keys.ini configuration file");
            return;
        }
        // 对每个key进行正则表达式校验
        $chkKeys = array();
    ...
    public static function doEncrypt($map) {
        ...
        if (count($chkKeys) > 0) {
            foreach ($chkKeys as $key) {
                ...
                $log->logInfo(
                    "The parameters of the request " . $key . " RSA encryption");
    ...
    protected static function doCheckParams($key, $map) {
        ...
        if (CheckReqDataAndEncrypt::isOptional($key)) {
            ...
            CheckReqDataAndEncrypt::check(
                CheckReqDataAndEncrypt::removBrackets($key), $map, false);
        } else {
    ...
    protected static function isOptional($key) {
        return CheckReqDataAndEncrypt::startsWith($key, "[") &&
             CheckReqDataAndEncrypt::endsWith($key, "]");
    }
    ...
    protected static function check($key, $map, $must) {
        ...
        if (empty($value)) {
            ...
            if (count(CheckReqDataAndEncrypt::$regexkeysarray) <= 0) {
                ...
                CheckReqDataAndEncrypt::$regexkeysarray = parse_ini_file(
                    "mapping_regex.ini");
            }
            $regex = CheckReqDataAndEncrypt::$regexkeysarray["Regex." . $key];
            if (empty($regex)) {
                $log->logInfo(
                    "The parameters of the request " . $key .
                         " not configured regular validation rules");
                return;
            }
            // 不符合正则表达式
            if (! preg_match($regex, $tValue)) {
                $log->logInfo(
                    "Request parameters [" . $key . "(" . $tValue .
                         ")] format or value can not match the regular rules [" .
                         $regex . "]");
                die(
                    "Request parameters [" . $key . "(" . $tValue .
                         ")] format or value is not correct");
            } else {
                $log->logInfo(
                    "Request parameters [" . $key . "(" . $tValue .
                         ")] format or value match the regular rules [" . $regex .
                         "]");
            }
        }
    }
