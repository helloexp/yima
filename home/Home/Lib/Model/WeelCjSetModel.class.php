 ...
 */
class WeelCjSetModel extends CjSetModel {
    ...
    public function verifyReqDataForWeel($requestedValue, $nodeId) {
        ...
        try {
            ...
            // 修正14889
            // $phoneDayPart = M('tcj_rule')->where(array('batch_id' =>
            // $batchInfo['id']))->getField('phone_day_part');
            // if ($batchInfo['click_count'] > 0 && $result['phone_day_part'] !=
            // $phoneDayPart) {
