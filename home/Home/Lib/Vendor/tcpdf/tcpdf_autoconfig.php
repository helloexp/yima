...
/**
 * @file Try to automatically configure some TCPDF constants if not defined.
 *
...
if ((! isset($_SERVER['DOCUMENT_ROOT'])) or (empty($_SERVER['DOCUMENT_ROOT']))) {
    if (isset($_SERVER['SCRIPT_FILENAME'])) {
        ...
        // define here your DOCUMENT_ROOT path if the previous fails (e.g.
        // '/var/www')
...
// Load main configuration file only if the K_TCPDF_EXTERNAL_CONFIG constant is
// set to false.
...
if (! defined('K_PATH_URL')) {
    ...
    if (isset($_SERVER['HTTP_HOST']) and (! empty($_SERVER['HTTP_HOST']))) {
        if (isset($_SERVER['HTTPS']) and (! empty($_SERVER['HTTPS'])) and
