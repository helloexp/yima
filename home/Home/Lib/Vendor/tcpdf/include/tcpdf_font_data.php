...
/**
 * @file Unicode data and encoding maps for TCPDF.
 *
 * @author Nicola Asuni
...
/**
 * @class TCPDF_FONT_DATA Unicode data and encoding maps for TCPDF.
 *
 * @package com.tecnick.tcpdf
 * @version 1.0.001
...
class TCPDF_FONT_DATA {
    ...
    /**
     * Unicode code for Left-to-Right Mark. @public
     */
    public static $uni_LRM = 8206;

    /**
     * Unicode code for Right-to-Left Mark. @public
     */
    public static $uni_RLM = 8207;

    /**
     * Unicode code for Left-to-Right Embedding. @public
     */
    public static $uni_LRE = 8234;

    /**
     * Unicode code for Right-to-Left Embedding. @public
     */
    public static $uni_RLE = 8235;

    /**
     * Unicode code for Pop Directional Format. @public
     */
    public static $uni_PDF = 8236;

    /**
     * Unicode code for Left-to-Right Override. @public
     */
    public static $uni_LRO = 8237;

    /**
     * Unicode code for Right-to-Left Override. @public
     */
     ...
     * http://www.w3.org/International/questions/qa-forms-utf-8 @public
     */
    ...
    /**
     * Mirror unicode characters. For information on bidi mirroring, see UAX #9:
    ...
    /**
     * Arabic shape substitutions: char code => (isolated, final, initial,
     * medial). @public
     */
     ...
     * Putting the combining mark and character in the same glyph allows us to
     * avoid the two marks overlapping each other in an illegible manner. second
     * NSM char code => substitution char @public
     */
    ...
    /**
     * Array of character substitutions from UTF-8 Unicode to Latin1. @public
     */
    ...
    /**
     * Array of Encoding Maps. @public static
     */
    ...
    /**
     * ToUnicode map for Identity-H stream @public static
     */
