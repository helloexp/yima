...
/**
 * @file !!! THIS CLASS IS UNDER DEVELOPMENT !!! This is a PHP class extension
 * of the TCPDF (http://www.tcpdf.org) library to import existing PDF
 * documents.<br>
 *
...
/**
 * @class TCPDF_IMPORT !!! THIS CLASS IS UNDER DEVELOPMENT !!! PHP class
 * extension of the TCPDF (http://www.tcpdf.org) library to import existing PDF
 * documents.<br>
 *
 * @package com.tecnick.tcpdf @brief PHP class extension of the TCPDF library to
 *          import existing PDF documents.
 * @version 1.0.001
...
class TCPDF_IMPORT extends TCPDF {
     ...
     * @return true in case of success, false otherwise @public
