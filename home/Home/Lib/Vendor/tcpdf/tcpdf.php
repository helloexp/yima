...
//
// Description :
// This is a PHP class for generating PDF documents without requiring external
// extensions.
//
// NOTE:
...
// * supports JPEG, PNG and SVG images natively, all images supported by GD (GD,
// GD2, GD2PART, GIF, JPEG, PNG, BMP, XBM, XPM) and all images supported via
...
// RMS4CC (Royal Mail 4-state Customer Code), CBC (Customer Bar Code), KIX
// (Klant index - Customer index), Intelligent Mail Barcode, Onecode,
// USPS-B-3200, CODABAR, CODE 11, PHARMACODE, PHARMACODE TWO-TRACKS, Datamatrix,
// QR-Code, PDF417;
// * JPEG and PNG ICC profiles, Grayscale, RGB, CMYK, Spot Colors and
// Transparencies;
...
/**
 * @file This is a PHP class for generating PDF documents without requiring
 * external extensions.<br> TCPDF project (http://www.tcpdf.org) was originally
 * derived in 2002 from the Public Domain FPDF class by Olivier Plathey
 * (http://www.fpdf.org), but now is almost entirely rewritten.<br> <h3>TCPDF
 * main features are:</h3> <ul> <li>no external libraries are required for the
 * basic functions;</li> <li>all standard page formats, custom page formats,
 * custom margins and units of measure;</li> <li>UTF-8 Unicode and Right-To-Left
 * languages;</li> <li>TrueTypeUnicode, TrueType, Type1 and CID-0 fonts;</li>
 * <li>font subsetting;</li> <li>methods to publish some XHTML + CSS code,
 * Javascript and Forms;</li> <li>images, graphic (geometric figures) and
 * transformation methods; <li>supports JPEG, PNG and SVG images natively, all
 * images supported by GD (GD, GD2, GD2PART, GIF, JPEG, PNG, BMP, XBM, XPM) and
 * all images supported via ImagMagick
 * (http://www.imagemagick.org/www/formats.html)</li> <li>1D and 2D barcodes:
 * CODE 39, ANSI MH10.8M-1983, USD-3, 3 of 9, CODE 93, USS-93, Standard 2 of 5,
 * Interleaved 2 of 5, CODE 128 A/B/C, 2 and 5 Digits UPC-Based Extension, EAN
 * 8, EAN 13, UPC-A, UPC-E, MSI, POSTNET, PLANET, RMS4CC (Royal Mail 4-state
 ...
 * PHARMACODE TWO-TRACKS, Datamatrix, QR-Code, PDF417;</li> <li>JPEG and PNG ICC
 * profiles, Grayscale, RGB, CMYK, Spot Colors and Transparencies;</li>
 * <li>automatic page header and footer management;</li> <li>document encryption
 * up to 256 bit and digital signature certifications;</li> <li>transactions to
 * UNDO commands;</li> <li>PDF annotations, including links, text and file
 * attachments;</li> <li>text rendering modes (fill, stroke and clipping);</li>
 * <li>multiple columns mode;</li> <li>no-write page regions;</li>
 * <li>bookmarks, named destinations and table of content;</li> <li>text
 * hyphenation;</li> <li>text stretching and spacing (tracking);</li>
 * <li>automatic page break, line break and text alignments including
 * justification;</li> <li>automatic page numbering and page groups;</li>
 * <li>move and delete pages;</li> <li>page compression (requires php-zlib
 * extension);</li> <li>XOBject Templates;</li> <li>Layers and object
 * visibility;</li> <li>PDF/A-1b support.</li> </ul> Tools to encode your
 * unicode fonts are on fonts/utils directory.</p>
 *
...
/**
 * @class TCPDF PHP class for generating PDF documents without requiring
 * external extensions. TCPDF project (http://www.tcpdf.org) has been originally
 * derived in 2002 from the Public Domain FPDF class by Olivier Plathey
 * (http://www.fpdf.org), but now is almost entirely rewritten.<br>
 *
 * @package com.tecnick.tcpdf @brief PHP class for generating PDF documents
...
class TCPDF {
    ...
    /**
     * Current page number. @protected
     */
    protected $page;

    /**
     * Current object number. @protected
     */
    protected $n;

    /**
     * Array of object offsets. @protected
     */
    protected $offsets = array();

    /**
     * Array of object IDs for each page. @protected
     */
    protected $pageobjects = array();

    /**
     * Buffer holding in-memory PDF. @protected
     */
    protected $buffer;

    /**
     * Array containing pages. @protected
     */
    protected $pages = array();

    /**
     * Current document state. @protected
     */
    protected $state;

    /**
     * Compression flag. @protected
     */
    protected $compress;

    /**
     * Current page orientation (P = Portrait, L = Landscape). @protected
     */
    protected $CurOrientation;

    /**
     * Page dimensions. @protected
     */
    protected $pagedim = array();

    /**
     * Scale factor (number of points in user unit). @protected
     */
    protected $k;

    /**
     * Width of page format in points. @protected
     */
    protected $fwPt;

    /**
     * Height of page format in points. @protected
     */
    protected $fhPt;

    /**
     * Current width of page in points. @protected
     */
    protected $wPt;

    /**
     * Current height of page in points. @protected
     */
    protected $hPt;

    /**
     * Current width of page in user unit. @protected
     */
    protected $w;

    /**
     * Current height of page in user unit. @protected
     */
    protected $h;

    /**
     * Left margin. @protected
     */
    protected $lMargin;

    /**
     * Right margin. @protected
     */
    protected $rMargin;

    /**
     * Cell left margin (used by regions). @protected
     */
    protected $clMargin;

    /**
     * Cell right margin (used by regions). @protected
     */
    protected $crMargin;

    /**
     * Top margin. @protected
     */
    protected $tMargin;

    /**
     * Page break margin. @protected
     */
    protected $bMargin;

    /**
     * Array of cell internal paddings ('T' => top, 'R' => right, 'B' => bottom,
     * 'L' => left).
     *
     * @since 5.9.000 (2010-10-03) @protected
     */
    ...
    /**
     * Array of cell margins ('T' => top, 'R' => right, 'B' => bottom, 'L' =>
     * left).
     *
     * @since 5.9.000 (2010-10-04) @protected
     */
    ...
    /**
     * Current horizontal position in user unit for cell positioning. @protected
     */
    protected $x;

    /**
     * Current vertical position in user unit for cell positioning. @protected
     */
    protected $y;

    /**
     * Height of last cell printed. @protected
     */
    protected $lasth;

    /**
     * Line width in user unit. @protected
     */
    protected $LineWidth;

    /**
     * Array of standard font names. @protected
     */
    protected $CoreFonts;

    /**
     * Array of used fonts. @protected
     */
    protected $fonts = array();

    /**
     * Array of font files. @protected
     */
    protected $FontFiles = array();

    /**
     * Array of encoding differences. @protected
     */
    protected $diffs = array();

    /**
     * Array of used images. @protected
     */
    protected $images = array();

    /**
     * Depth of the svg tag, to keep track if the svg tag is a subtag or the
     * root tag. @protected
     */
    protected $svg_tag_depth = 0;

    /**
     * Array of Annotations in pages. @protected
     */
    protected $PageAnnots = array();

    /**
     * Array of internal links. @protected
     */
    protected $links = array();

    /**
     * Current font family. @protected
     */
    protected $FontFamily;

    /**
     * Current font style. @protected
     */
    protected $FontStyle;

    /**
     * Current font ascent (distance between font top and baseline). @protected
     *
    ...
    /**
     * Underlining flag. @protected
     */
    protected $underline;

    /**
     * Overlining flag. @protected
     */
    protected $overline;

    /**
     * Current font info. @protected
     */
    protected $CurrentFont;

    /**
     * Current font size in points. @protected
     */
    protected $FontSizePt;

    /**
     * Current font size in user unit. @protected
     */
    protected $FontSize;

    /**
     * Commands for drawing color. @protected
     */
    protected $DrawColor;

    /**
     * Commands for filling color. @protected
     */
    protected $FillColor;

    /**
     * Commands for text color. @protected
     */
    protected $TextColor;

    /**
     * Indicates whether fill and text colors are different. @protected
     */
    protected $ColorFlag;

    /**
     * Automatic page breaking. @protected
     */
    protected $AutoPageBreak;

    /**
     * Threshold used to trigger page breaks. @protected
     */
    protected $PageBreakTrigger;

    /**
     * Flag set when processing page header. @protected
     */
    protected $InHeader = false;

    /**
     * Flag set when processing page footer. @protected
     */
    protected $InFooter = false;

    /**
     * Zoom display mode. @protected
     */
    protected $ZoomMode;

    /**
     * Layout display mode. @protected
     */
    protected $LayoutMode;

    /**
     * If true set the document information dictionary in Unicode. @protected
     */
    ...
    /**
     * Document subject. @protected
     */
    protected $subject = '';

    /**
     * Document author. @protected
     */
    protected $author = '';

    /**
     * Document keywords. @protected
     */
    protected $keywords = '';

    /**
     * Document creator. @protected
     */
    protected $creator = '';

    /**
     * Starting page number. @protected
     */
    protected $starting_page_number = 1;

    /**
     * The right-bottom (or left-bottom for RTL) corner X coordinate of last
     * inserted image.
     *
     * @since 2002-07-31
     * @author Nicola Asuni @protected
     */
    protected $img_rb_x;
    ...
    /**
     * Boolean flag set to true when the input text is unicode (require unicode
     * fonts).
     *
     * @since 2005-01-02
     * @author Nicola Asuni @protected
     ...
     * PDF version.
     *
     * @since 1.5.3 @protected
     */
    protected $PDFVersion = '1.7';

    /**
     * ID of the stored default header template (-1 = not set). @protected
     */
    protected $header_xobjid = false;

    /**
     * If true reset the Header Xobject template at each page @protected
     */
    protected $header_xobj_autoreset = false;

    /**
     * Minimum distance between header and top page margin. @protected
     */
    protected $header_margin;

    /**
     * Minimum distance between footer and bottom page margin. @protected
     */
    protected $footer_margin;

    /**
     * Original left margin value. @protected
     *
     * @since 1.53.0.TC013
     */
    ...
    /**
     * Original right margin value. @protected
     *
     * @since 1.53.0.TC013
     */
    ...
    /**
     * Default font used on page header. @protected
     */
    protected $header_font;

    /**
     * Default font used on page footer. @protected
     */
    protected $footer_font;

    /**
     * Language templates. @protected
     */
    protected $l;

    /**
     * Barcode to print on page footer (only if set). @protected
     */
    protected $barcode = false;

    /**
     * Boolean flag to print/hide page header. @protected
     */
    protected $print_header = true;

    /**
     * Boolean flag to print/hide page footer. @protected
     */
    protected $print_footer = true;

    /**
     * Header image logo. @protected
     */
    protected $header_logo = '';

    /**
     * Width of header image logo in user units. @protected
     */
    protected $header_logo_width = 30;

    /**
     * Title to be printed on default page header. @protected
     */
    protected $header_title = '';

    /**
     * String to pring on page header after title. @protected
     */
     ...
     *
     * @since 5.9.174 (2012-07-25) @protected
     */
    ...
    /**
     * Default number of columns for html table. @protected
     */
    ...
    /**
     * HTML PARSER: array to store current link and rendering styles. @protected
     */
    protected $HREF = array();

    /**
     * List of available fonts on filesystem. @protected
     */
    protected $fontlist = array();

    /**
     * Current foreground color. @protected
     */
    protected $fgcolor;

    /**
     * HTML PARSER: array of boolean values, true in case of ordered list (OL),
     * false otherwise. @protected
     */
    protected $listordered = array();

    /**
     * HTML PARSER: array count list items on nested lists. @protected
     */
    protected $listcount = array();

    /**
     * HTML PARSER: current list nesting level. @protected
     */
    protected $listnum = 0;

    /**
     * HTML PARSER: indent amount for lists. @protected
     */
    protected $listindent = 0;

    /**
     * HTML PARSER: current list indententation level. @protected
     */
    protected $listindentlevel = 0;

    /**
     * Current background color. @protected
     */
    protected $bgcolor;

    /**
     * Temporary font size in points. @protected
     */
    protected $tempfontsize = 10;

    /**
     * Spacer string for LI tags. @protected
     */
    protected $lispacer = '';

    /**
     * Default encoding. @protected
     *
     * @since 1.53.0.TC010
     */
    ...
    /**
     * PHP internal encoding. @protected
     *
     * @since 1.53.0.TC016
     */
    ...
    /**
     * Boolean flag used to force RTL or LTR string direction. @protected
     *
     * @since 2.0.000
     */
    ...
    /**
     * IBoolean flag indicating whether document is protected. @protected
     *
    ...
    /**
     * File ID (used on document trailer). @protected
     *
    ...
    /**
     * DPI (Dot Per Inch) Document Resolution (do not change). @protected
     *
    ...
    /**
     * Array of page numbers were a new page group was started (the page numbers
     * are the keys of the array). @protected
     *
     * @since 3.0.000 (2008-03-27)
     */
    ...
    /**
     * Array that contains the number of pages in each page group. @protected
     *
     * @since 3.0.000 (2008-03-27)
     */
    ...
    /**
     * Current page group number. @protected
     *
     * @since 3.0.000 (2008-03-27)
     */
    ...
    /**
     * Array of transparency objects and parameters. @protected
     *
     * @since 3.0.000 (2008-03-27)
     */
    ...
    /**
     * Default cell height ratio. @protected
     *
    ...
    /**
     * PDF viewer preferences. @protected
     *
    ...
    /**
     * Array for storing gradient information. @protected
     *
     * @since 3.1.000 (2008-06-09)
     */
    ...
    /**
     * Array used to store positions inside the pages buffer (keys are the page
     * numbers). @protected
     *
    ...
    /**
     * Array used to store page positions to track empty pages (keys are the
     * page numbers). @protected
     *
    ...
    /**
     * Array used to store content positions inside the pages buffer (keys are
     * the page numbers). @protected
     *
    ...
    /**
     * Array used to store footer positions of each page. @protected
     *
    ...
    /**
     * Array used to store footer length of each page. @protected
     *
    ...
    /**
     * Boolean flag to indicate if a new line is created. @protected
     *
     * @since 3.2.000 (2008-07-01)
     */
    ...
    /**
     * PDF string for width value of the last line. @protected
     *
    ...
    /**
     * PDF string for CAP value of the last line. @protected
     *
     * @since 4.0.006 (2008-07-16)
     */
    ...
    /**
     * PDF string for join value of the last line. @protected
     *
     * @since 4.0.006 (2008-07-16)
     */
    ...
    /**
     * PDF string for dash value of the last line. @protected
     *
     * @since 4.0.006 (2008-07-16)
     */
    ...
    /**
     * Boolean flag to indicate if marked-content sequence is open. @protected
     *
    ...
    /**
     * HTML PARSER: custom indent amount for lists. Negative value means
     * disabled. @protected
     *
    ...
    /**
     * Boolean flag to indicate if the border of the cell sides that cross the
     * page should be removed. @protected
     *
    ...
    /**
     * Array of files to embedd. @protected
     *
    ...
    /**
     * Boolean flag to indicate if we are inside a PRE tag. @protected
     *
    ...
    /**
     * Array used to store positions of graphics transformation blocks inside
     * the page buffer. keys are the page numbers @protected
     *
    ...
    /**
     * Counts the number of pages. @protected
     *
    ...
    /**
     * Array containing page lengths in bytes. @protected
     *
     * @since 4.5.000 (2008-12-31)
     */
    ...
    /**
     * Store the image keys. @protected
     *
     * @since 4.5.000 (2008-12-31)
     */
    ...
    /**
     * Length of the buffer in bytes. @protected
     *
     * @since 4.5.000 (2008-12-31)
     */
    ...
    /**
     * Counts the number of fonts. @protected
     *
    ...
    /**
     * Store the font object IDs. @protected
     *
    ...
    /**
     * Store the fage status (true when opened, false when closed). @protected
     *
     * @since 4.5.000 (2009-01-02)
     */
    ...
    /**
     * Default monospace font. @protected
     *
    ...
    /**
     * Cloned copy of the current class object. @protected
     *
    ...
    /**
     * Margins used for table header. @protected
     *
     * @since 4.5.030 (2009-03-20)
     */
    ...
    /**
     * Boolean flag to enable document digital signature. @protected
     *
    ...
    /**
     * Digital signature data. @protected
     *
     * @since 4.6.005 (2009-04-24)
     */
    ...
    /**
     * Digital signature max length. @protected
     *
     * @since 4.6.005 (2009-04-24)
     */
    ...
    /**
     * Data for digital signature appearance. @protected
     *
    ...
    /**
     * Array of empty digital signature appearances. @protected
     *
    ...
    /**
     * Boolean flag to enable document timestamping with TSA. @protected
     *
    ...
    /**
     * Regular expression used to find blank characters (required for
     * word-wrapping). @protected
     *
    ...
    /**
     * Array of $re_spaces parts. @protected
     *
    ...
    /**
     * Digital signature object ID. @protected
     *
    ...
    /**
     * Deafult Javascript field properties. Possible values are described on
     * official Javascript for Acrobat API reference. Annotation options can be
     * directly specified using the 'aopt' entry. @protected
     *
     * @since 4.8.000 (2009-09-07)
     */
    ...
    /**
     * Current method to submit forms. @protected
     *
     * @since 4.8.000 (2009-09-07)
     */
    ...
    /**
     * List of fonts used on form fields (fontname => fontkey). @protected
     *
     * @since 4.8.001 (2009-09-09)
     */
    ...
    /**
     * List of radio buttons parent objects. @protected
     *
     * @since 4.8.001 (2009-09-09)
     */
    ...
    /**
     * Store page number when startTransaction() is called. @protected
     *
     * @since 4.8.006 (2009-09-23)
     */
    ...
    /**
     * Store Y position when startTransaction() is called. @protected
     *
    ...
    /**
     * Array of: X difference between table cell x start and starting page
     * margin, cellspacing, cellpadding. @protected
     *
     * @since 5.8.000 (2010-08-11)
     */
    ...
    /**
     * Text rendering mode: 0 = Fill text; 1 = Stroke text; 2 = Fill, then
     * stroke text; 3 = Neither fill nor stroke text (invisible); 4 = Fill text
     * and add to path for clipping; 5 = Stroke text and add to path for
     * clipping; 6 = Fill, then stroke text and add to path for clipping; 7 =
     * Add text to path for clipping. @protected
     *
    ...
    /**
     * Current stroke color. @protected
     *
     * @since 4.9.008 (2010-04-03)
     */
    ...
    /**
     * Default unit of measure for document. @protected
     *
    ...
    /**
     * Boolean flag true when we are on TOC (Table Of Content) page. @protected
     */
    protected $tocpage = false;

    /**
     * Boolean flag: if true convert vector images (SVG, EPS) to raster image
     * using GD or ImageMagick library. @protected
     *
    ...
    /**
     * Boolean flag: if true enables font subsetting by default. @protected
     *
    ...
    /**
     * Array of default graphic settings. @protected
     *
    ...
    /**
     * Boolean value true when we are inside an XObject. @protected
     *
    ...
    /**
     * Percentage of character stretching. @protected
     *
    ...
    /**
     * Increases or decreases the space between characters in a text by the
     * specified amount (tracking). @protected
     *
     * @since 5.9.000 (2010-09-29)
     */
    ...
    /**
     * Array of no-write regions. ('page' => page number or empy for current
     * page, 'xt' => X top, 'yt' => Y top, 'xb' => X bottom, 'yb' => Y bottom,
     * 'side' => page side 'L' = left or 'R' = right) @protected
     *
    ...
    /**
     * Boolean value true when page region check is active. @protected
     */
    protected $check_page_regions = true;

    /**
     * Array of PDF layers data. @protected
     *
    ...
    /**
     * A dictionary of names and corresponding destinations (Dests key on
     * document Catalog). @protected
     *
    ...
    /**
     * Object ID for Named Destinations @protected
     *
     * @since 5.9.097 (2011-06-23)
     */
    protected $n_dests;
    ...
    /**
     * Embedded Files Names @protected
     *
    ...
    /**
     * Directory used for the last SVG image. @protected
     *
    ...
    /**
     * Deafult unit of measure for SVG. @protected
     *
    ...
    /**
     * Array of SVG gradients. @protected
     *
     * @since 5.0.000 (2010-05-02)
     */
    ...
    /**
     * ID of last SVG gradient. @protected
     *
     * @since 5.0.000 (2010-05-02)
     */
    ...
    /**
     * Boolean value true when in SVG defs group. @protected
     *
     * @since 5.0.000 (2010-05-02)
     */
    ...
    /**
     * Boolean value true when in SVG clipPath tag. @protected
     *
     * @since 5.0.000 (2010-04-26)
     */
    ...
    /**
     * Array of SVG clipPath commands. @protected
     *
     * @since 5.0.000 (2010-05-02)
     */
    ...
    /**
     * Array of SVG clipPath tranformation matrix. @protected
     *
    ...
    /**
     * ID of last SVG clipPath. @protected
     *
     * @since 5.0.000 (2010-05-02)
     */
    ...
    /**
     * Array of SVG properties. @protected
     *
     * @since 5.0.000 (2010-05-02)
     */
    ...
    /**
     * If true force sRGB color profile for all document. @protected
     *
    ...
    /**
     * If true set the document to PDF/A mode. @protected
     *
    ...
    /**
     * Document creation date-time @protected
     *
    ...
    /**
     * Document modification date-time @protected
     *
     * @since 5.9.152 (2012-03-22)
     */
    ...
    /**
     * Overprint mode array. (Check the "Entries in a Graphics State Parameter
     * Dictionary" on PDF 32000-1:2008). @protected
     *
    ...
    /**
     * Alpha mode array. (Check the "Entries in a Graphics State Parameter
     * Dictionary" on PDF 32000-1:2008). @protected
     *
     * @since 5.9.152 (2012-03-23)
     */
    ...
    /**
     * Define the page boundaries boxes to be set on document. @protected
     *
     * @since 5.9.152 (2012-03-23)
     */
    ...
    /**
     * If true print TCPDF meta link. @protected
     *
     * @since 5.9.152 (2012-03-23)
     */
    ...
    /**
     * Cache array for computed GD gamma values. @protected
     *
     ...
     * orientation and the measure unit used in all the methods (except for the
     * font sizes). IMPORTANT: Please note that this method sets the
     * mb_internal_encoding to ASCII, so if you are using the mbstring module
     * functions with TCPDF you need to correctly set/unset the
     * mb_internal_encoding when needed.
     *
     * @param $orientation (string) page orientation. Possible values are (case
     *            insensitive):<ul><li>P or Portrait (default)</li><li>L or
     *            Landscape</li><li>'' (empty string) for automatic
     *            orientation</li></ul>
     * @param $unit (string) User measure unit. Possible values are:<ul><li>pt:
     *            point</li><li>mm: millimeter (default)</li><li>cm:
     *            centimeter</li><li>in: inch</li></ul><br />A point equals 1/72
     *            of inch, that is to say about 0.35 mm (an inch being 2.54 cm).
     *            This is a very common unit in typography; font sizes are
     *            expressed in that unit.
     * @param $format (mixed) The format used for pages. It can be either: one
     *            of the string values specified at getPageSizeFromFormat() or
     *            an array of parameters specified at setPageFormat().
     * @param $unicode (boolean) TRUE means that the input text is unicode
     *            (default = true)
     * @param $encoding (string) Charset encoding (used only when converting
     *            back html entities); default is UTF-8.
     * @param $diskcache (boolean) DEPRECATED FEATURE
     * @param $pdfa (boolean) If TRUE set the document to PDF/A mode. @public
    ...
    public function __construct($orientation = 'P', $unit = 'mm', $format = 'A4', 
        ...
        if ($this->isunicode and (@preg_match('/\pL/u', 'a') == 1)) {
            ...
            // \p{Z} : any separator
            // \p{Lo} : Unicode letter or ideograph that does not have lowercase
            // and uppercase variants. Is used to chunk chinese words.
        ...
        $this->custom_xmp = '';
        // Call cleanup method after script execution finishes or exit() is
        // called.
        // NOTE: This will not be executed if the process is killed with a
    ...
    public function __destruct() {
        ...
        if (isset($this->internal_encoding) and ! empty(
     ...
     *
     * @param $format (mixed) The format used for pages. It can be either: one
     *            of the string values specified at getPageSizeFromFormat()
     *            documentation or an array of two numbers (width, height) or an
     *            array containing the following measures and options:<ul>
     *            <li>['format'] = page format name (one of the above);</li>
     *            <li>['Rotate'] : The number of degrees by which the page shall
     *            be rotated clockwise when displayed or printed. The value
     *            shall be a multiple of 90.</li> <li>['PZ'] : The page's
     *            preferred zoom (magnification) factor.</li> <li>['MediaBox'] :
     *            the boundaries of the physical medium on which the page shall
     *            be displayed or printed:</li> <li>['MediaBox']['llx'] :
     *            lower-left x coordinate</li> <li>['MediaBox']['lly'] :
     *            lower-left y coordinate</li> <li>['MediaBox']['urx'] :
     *            upper-right x coordinate</li> <li>['MediaBox']['ury'] :
     *            upper-right y coordinate</li> <li>['CropBox'] : the visible
     *            region of default user space:</li> <li>['CropBox']['llx'] :
     *            lower-left x coordinate</li> <li>['CropBox']['lly'] :
     *            lower-left y coordinate</li> <li>['CropBox']['urx'] :
     *            upper-right x coordinate</li> <li>['CropBox']['ury'] :
     *            upper-right y coordinate</li> <li>['BleedBox'] : the region to
     *            which the contents of the page shall be clipped when output in
     *            a production environment:</li> <li>['BleedBox']['llx'] :
     *            lower-left x coordinate</li> <li>['BleedBox']['lly'] :
     *            lower-left y coordinate</li> <li>['BleedBox']['urx'] :
     *            upper-right x coordinate</li> <li>['BleedBox']['ury'] :
     *            upper-right y coordinate</li> <li>['TrimBox'] : the intended
     *            dimensions of the finished page after trimming:</li>
     ...
     *            <li>['ArtBox'] : the extent of the page's meaningful
     *            content:</li> <li>['ArtBox']['llx'] : lower-left x
     *            coordinate</li> <li>['ArtBox']['lly'] : lower-left y
     *            coordinate</li> <li>['ArtBox']['urx'] : upper-right x
     *            coordinate</li> <li>['ArtBox']['ury'] : upper-right y
     *            coordinate</li> <li>['BoxColorInfo'] :specify the colours and
     *            other visual characteristics that should be used in displaying
     *            guidelines on the screen for each of the possible page
     *            boundaries other than the MediaBox:</li>
     *            <li>['BoxColorInfo'][BOXTYPE]['C'] : an array of three numbers
     *            in the range 0-255, representing the components in the
     *            DeviceRGB colour space.</li>
     *            <li>['BoxColorInfo'][BOXTYPE]['W'] : the guideline width in
     *            default user units</li> <li>['BoxColorInfo'][BOXTYPE]['S'] :
     *            the guideline style: S = Solid; D = Dashed</li>
     *            <li>['BoxColorInfo'][BOXTYPE]['D'] : dash array defining a
     *            pattern of dashes and gaps to be used in drawing dashed
     *            guidelines</li> <li>['trans'] : the style and duration of the
     *            visual transition to use when moving from another page to the
     *            given page during a presentation</li> <li>['trans']['Dur'] :
     *            The page's display duration (also called its advance timing):
     *            the maximum length of time, in seconds, that the page shall be
     *            displayed during presentations before the viewer application
     *            shall automatically advance to the next page.</li>
     *            <li>['trans']['S'] : transition style : Split, Blinds, Box,
     *            Wipe, Dissolve, Glitter, R, Fly, Push, Cover, Uncover,
     *            Fade</li> <li>['trans']['D'] : The duration of the transition
     *            effect, in seconds.</li> <li>['trans']['Dm'] : (Split and
     *            Blinds transition styles only) The dimension in which the
     *            specified transition effect shall occur: H = Horizontal, V =
     *            Vertical. Default value: H.</li> <li>['trans']['M'] : (Split,
     *            Box and Fly transition styles only) The direction of motion
     *            for the specified transition effect: I = Inward from the edges
     *            of the page, O = Outward from the center of the pageDefault
     *            value: I.</li> <li>['trans']['Di'] : (Wipe, Glitter, Fly,
     *            Cover, Uncover and Push transition styles only) The direction
     *            in which the specified transition effect shall moves,
     *            expressed in degrees counterclockwise starting from a
     *            left-to-right direction. If the value is a number, it shall be
     *            one of: 0 = Left to right, 90 = Bottom to top (Wipe only), 180
     *            = Right to left (Wipe only), 270 = Top to bottom, 315 =
     *            Top-left to bottom-right (Glitter only). If the value is a
     *            name, it shall be None, which is relevant only for the Fly
     *            transition when the value of SS is not 1.0. Default value:
     *            0.</li> <li>['trans']['SS'] : (Fly transition style only) The
     *            starting or ending scale at which the changes shall be drawn.
     *            If M specifies an inward transition, the scale of the changes
     *            drawn shall progress from SS to 1.0 over the course of the
     *            transition. If M specifies an outward transition, the scale of
     *            the changes drawn shall progress from 1.0 to SS over the
     *            course of the transition. Default: 1.0.</li>
     *            <li>['trans']['B'] : (Fly transition style only) If true, the
     *            area that shall be flown in is rectangular and opaque.
     *            Default: false.</li> </ul>
     * @param $orientation (string) page orientation. Possible values are (case
     *            insensitive):<ul> <li>P or Portrait (default)</li> <li>L or
     *            Landscape</li> <li>'' (empty string) for automatic
     *            orientation</li> </ul> @protected
     * @since 3.0.015 (2008-06-06)
    ...
    protected function setPageFormat($format, $orientation = 'P') {
        ...
        if (is_string($format)) {
            ...
            if (isset($format['MediaBox'])) {
                $this->pagedim = TCPDF_STATIC::setPageBoxes($this->page, 
                    'MediaBox', $format['MediaBox']['llx'], 
                    $format['MediaBox']['lly'], $format['MediaBox']['urx'], 
                    $format['MediaBox']['ury'], false, $this->k, $this->pagedim);
                $this->fwPt = (($format['MediaBox']['urx'] -
                     $format['MediaBox']['llx']) * $this->k);
                $this->fhPt = (($format['MediaBox']['ury'] -
                     $format['MediaBox']['lly']) * $this->k);
            } else {
                if (isset($format[0]) and is_numeric($format[0]) and
                     isset($format[1]) and is_numeric($format[1])) {
                    $pf = array(
                        ($format[0] * $this->k), 
                        ($format[1] * $this->k));
                } else {
                ...
                $this->fhPt = $pf[1];
                $this->pagedim = TCPDF_STATIC::setPageBoxes($this->page, 
                    'MediaBox', 0, 0, $this->fwPt, $this->fhPt, true, $this->k, 
                    $this->pagedim);
            }
            // the visible region of default user space
            if (isset($format['CropBox'])) {
                $this->pagedim = TCPDF_STATIC::setPageBoxes($this->page, 
                    'CropBox', $format['CropBox']['llx'], 
                    $format['CropBox']['lly'], $format['CropBox']['urx'], 
                    $format['CropBox']['ury'], false, $this->k, $this->pagedim);
            }
            // the region to which the contents of the page shall be clipped
            // when output in a production environment
            if (isset($format['BleedBox'])) {
                $this->pagedim = TCPDF_STATIC::setPageBoxes($this->page, 
                    'BleedBox', $format['BleedBox']['llx'], 
                    $format['BleedBox']['lly'], $format['BleedBox']['urx'], 
                    $format['BleedBox']['ury'], false, $this->k, $this->pagedim);
            }
            // the intended dimensions of the finished page after trimming
            if (isset($format['TrimBox'])) {
                $this->pagedim = TCPDF_STATIC::setPageBoxes($this->page, 
                    'TrimBox', $format['TrimBox']['llx'], 
                    $format['TrimBox']['lly'], $format['TrimBox']['urx'], 
                    $format['TrimBox']['ury'], false, $this->k, $this->pagedim);
            }
            // the page's meaningful content (including potential white space)
            if (isset($format['ArtBox'])) {
                $this->pagedim = TCPDF_STATIC::setPageBoxes($this->page, 
                    'ArtBox', $format['ArtBox']['llx'], $format['ArtBox']['lly'], 
                    $format['ArtBox']['urx'], $format['ArtBox']['ury'], false, 
                    $this->k, $this->pagedim);
            }
            // specify the colours and other visual characteristics that should
            // be used in displaying guidelines on the screen for the various
            // page boundaries
            ...
            if (isset($format['Rotate']) and (($format['Rotate'] % 90) == 0)) {
                // The number of degrees by which the page shall be rotated
                // clockwise when displayed or printed. The value shall be a
                // multiple of 90.
                $this->pagedim[$this->page]['Rotate'] = intval(
                    $format['Rotate']);
            }
            if (isset($format['PZ'])) {
            ...
            if (isset($format['trans'])) {
                // The style and duration of the visual transition to use when
                // moving from another page to the given page during a
                // presentation
                if (isset($format['trans']['Dur'])) {
                    // The page's display duration
                    $this->pagedim[$this->page]['trans']['Dur'] = floatval(
                        $format['trans']['Dur']);
                }
                $stansition_styles = array(
                    ...
                    'Uncover', 
                    'Fade');
                if (isset($format['trans']['S']) and
                     in_array($format['trans']['S'], $stansition_styles)) {
                    // The transition style that shall be used when moving to
                    // this page from another during a presentation
                    ...
                    $valid_vals = array(
                        'H', 
                        'V');
                    if (isset($format['trans']['Dm']) and
                         in_array($format['trans']['S'], $valid_effect) and
                         in_array($format['trans']['Dm'], $valid_vals)) {
                    ...
                    $valid_vals = array(
                        'I', 
                        'O');
                    if (isset($format['trans']['M']) and
                         in_array($format['trans']['S'], $valid_effect) and
                         in_array($format['trans']['M'], $valid_vals)) {
                    ...
                    $valid_effect = array(
                        ...
                        'Uncover', 
                        'Push');
                    if (isset($format['trans']['Di']) and
                         in_array($format['trans']['S'], $valid_effect)) {
                        if (((($format['trans']['Di'] == 90) or
                         ($format['trans']['Di'] == 180)) and
                         ($format['trans']['S'] == 'Wipe')) or (($format['trans']['Di'] ==
                         315) and ($format['trans']['S'] == 'Glitter')) or (($format['trans']['Di'] ==
                         0) or ($format['trans']['Di'] == 270))) {
                        $this->pagedim[$this->page]['trans']['Di'] = intval(
                            $format['trans']['Di']);
                    }
                }
                if (isset($format['trans']['SS']) and
                     ($format['trans']['S'] == 'Fly')) {
                    $this->pagedim[$this->page]['trans']['SS'] = floatval(
                        $format['trans']['SS']);
                }
                if (isset($format['trans']['B']) and
                     ($format['trans']['B'] === true) and
                     ($format['trans']['S'] == 'Fly')) {
            ...
            if (isset($format['trans']['D'])) {
                ...
                $this->pagedim[$this->page]['trans']['D'] = floatval(
                    $format['trans']['D']);
            } else {
 ...
 *            should be on or off.
 * @param $bottommargin (float) bottom margin of the page. @public
 * @since 3.0.015 (2008-06-06)
 */
public function setPageOrientation($orientation, $autopagebreak = '', 
    ...
    if (! isset($this->pagedim[$this->page]['MediaBox'])) {
        // the boundaries of the physical medium on which the page shall be
        // displayed or printed
        $this->pagedim = TCPDF_STATIC::setPageBoxes($this->page, 'MediaBox', 0, 
            0, $this->fwPt, $this->fhPt, true, $this->k, $this->pagedim);
    }
    if (! isset($this->pagedim[$this->page]['CropBox'])) {
        // the visible region of default user space
        $this->pagedim = TCPDF_STATIC::setPageBoxes($this->page, 'CropBox', 
            $this->pagedim[$this->page]['MediaBox']['llx'], 
            $this->pagedim[$this->page]['MediaBox']['lly'], 
            $this->pagedim[$this->page]['MediaBox']['urx'], 
            $this->pagedim[$this->page]['MediaBox']['ury'], true, $this->k, 
            $this->pagedim);
    }
    if (! isset($this->pagedim[$this->page]['BleedBox'])) {
        // the region to which the contents of the page shall be clipped when
        // output in a production environment
        $this->pagedim = TCPDF_STATIC::setPageBoxes($this->page, 'BleedBox', 
            $this->pagedim[$this->page]['CropBox']['llx'], 
            $this->pagedim[$this->page]['CropBox']['lly'], 
            $this->pagedim[$this->page]['CropBox']['urx'], 
            $this->pagedim[$this->page]['CropBox']['ury'], true, $this->k, 
            $this->pagedim);
    }
    if (! isset($this->pagedim[$this->page]['TrimBox'])) {
        // the intended dimensions of the finished page after trimming
        $this->pagedim = TCPDF_STATIC::setPageBoxes($this->page, 'TrimBox', 
            $this->pagedim[$this->page]['CropBox']['llx'], 
            $this->pagedim[$this->page]['CropBox']['lly'], 
            $this->pagedim[$this->page]['CropBox']['urx'], 
            $this->pagedim[$this->page]['CropBox']['ury'], true, $this->k, 
    ...
    if (! isset($this->pagedim[$this->page]['ArtBox'])) {
        // the page's meaningful content (including potential white space)
        $this->pagedim = TCPDF_STATIC::setPageBoxes($this->page, 'ArtBox', 
            $this->pagedim[$this->page]['CropBox']['llx'], 
            $this->pagedim[$this->page]['CropBox']['lly'], 
            $this->pagedim[$this->page]['CropBox']['urx'], 
            $this->pagedim[$this->page]['CropBox']['ury'], true, $this->k, 
    ...
    if (in_array($orientation, $valid_orientations) and
         ($orientation != $default_orientation)) {
    ...
    if ((abs($this->pagedim[$this->page]['MediaBox']['urx'] - $this->hPt) <
         $this->feps) and (abs(
            $this->pagedim[$this->page]['MediaBox']['ury'] - $this->wPt) <
         $this->feps)) {
        // swap X and Y coordinates (change page orientation)
        $this->pagedim = TCPDF_STATIC::swapPageBoxCoordinates($this->page, 
            $this->pagedim);
    }
...
/**
 * Set regular expression to detect withespaces or word separators. The pattern
 * delimiter must be the forward-slash character "/". Some example patterns are:
 * <pre> Non-Unicode or missing PCRE unicode support: "/[^\S\xa0]/" Unicode and
 * PCRE unicode support: "/(?!\xa0)[\s\p{Z}]/u" Unicode and PCRE unicode support
 * in Chinese mode: "/(?!\xa0)[\s\p{Z}\p{Lo}]/u" if PCRE unicode support is
 * turned ON ("\P" is the negate class of "\p"): \s : any whitespace character
 * \p{Z} : any separator \p{Lo} : Unicode letter or ideograph that does not have
 * lowercase and uppercase variants. Is used to chunk chinese words. \xa0 :
 * Unicode Character 'NO-BREAK SPACE' (U+00A0) </pre>
 *
 ...
 *
 * @param $mode (mixed) can be false, 'L' for LTR or 'R' for RTL @public
 ...
 * @param $padding (boolean) If true add cell padding @public
 */
...
/**
 * Reset the last cell height. @public
 *
 ...
 *
 * @return last cell height @public
...
/**
 * Returns an array of page dimensions: <ul><li>$this->pagedim[$this->page]['w']
 * = page width in points</li><li>$this->pagedim[$this->page]['h'] = height in
 * points</li><li>$this->pagedim[$this->page]['wk'] = page width in user
 * units</li><li>$this->pagedim[$this->page]['hk'] = page height in user
 * units</li><li>$this->pagedim[$this->page]['tm'] = top
 * margin</li><li>$this->pagedim[$this->page]['bm'] = bottom
 * margin</li><li>$this->pagedim[$this->page]['lm'] = left
 * margin</li><li>$this->pagedim[$this->page]['rm'] = right
 * margin</li><li>$this->pagedim[$this->page]['pb'] = auto page
 * break</li><li>$this->pagedim[$this->page]['or'] = page
 * orientation</li><li>$this->pagedim[$this->page]['olm'] = original left
 * margin</li><li>$this->pagedim[$this->page]['orm'] = original right
 * margin</li><li>$this->pagedim[$this->page]['Rotate'] = The number of degrees
 * by which the page shall be rotated clockwise when displayed or printed. The
 * value shall be a multiple of 90.</li><li>$this->pagedim[$this->page]['PZ'] =
 * The page's preferred zoom (magnification)
 * factor.</li><li>$this->pagedim[$this->page]['trans'] : the style and duration
 * of the visual transition to use when moving from another page to the given
 * page during a presentation<ul><li>$this->pagedim[$this->page]['trans']['Dur']
 * = The page's display duration (also called its advance timing): the maximum
 * length of time, in seconds, that the page shall be displayed during
 * presentations before the viewer application shall automatically advance to
 * the next page.</li><li>$this->pagedim[$this->page]['trans']['S'] = transition
 * style : Split, Blinds, Box, Wipe, Dissolve, Glitter, R, Fly, Push, Cover,
 * Uncover, Fade</li><li>$this->pagedim[$this->page]['trans']['D'] = The
 * duration of the transition effect, in
 * seconds.</li><li>$this->pagedim[$this->page]['trans']['Dm'] = (Split and
 * Blinds transition styles only) The dimension in which the specified
 * transition effect shall occur: H = Horizontal, V = Vertical. Default value:
 * H.</li><li>$this->pagedim[$this->page]['trans']['M'] = (Split, Box and Fly
 * transition styles only) The direction of motion for the specified transition
 * effect: I = Inward from the edges of the page, O = Outward from the center of
 * the pageDefault value: I.</li><li>$this->pagedim[$this->page]['trans']['Di']
 * = (Wipe, Glitter, Fly, Cover, Uncover and Push transition styles only) The
 * direction in which the specified transition effect shall moves, expressed in
 * degrees counterclockwise starting from a left-to-right direction. If the
 * value is a number, it shall be one of: 0 = Left to right, 90 = Bottom to top
 * (Wipe only), 180 = Right to left (Wipe only), 270 = Top to bottom, 315 =
 * Top-left to bottom-right (Glitter only). If the value is a name, it shall be
 * None, which is relevant only for the Fly transition when the value of SS is
 * not 1.0. Default value: 0.</li><li>$this->pagedim[$this->page]['trans']['SS']
 * = (Fly transition style only) The starting or ending scale at which the
 * changes shall be drawn. If M specifies an inward transition, the scale of the
 * changes drawn shall progress from SS to 1.0 over the course of the
 * transition. If M specifies an outward transition, the scale of the changes
 * drawn shall progress from 1.0 to SS over the course of the transition.
 * Default: 1.0. </li><li>$this->pagedim[$this->page]['trans']['B'] = (Fly
 * transition style only) If true, the area that shall be flown in is
 * rectangular and opaque. Default:
 * false.</li></ul></li><li>$this->pagedim[$this->page]['MediaBox'] : the
 * boundaries of the physical medium on which the page shall be displayed or
 * printed<ul><li>$this->pagedim[$this->page]['MediaBox']['llx'] = lower-left x
 * coordinate in points</li><li>$this->pagedim[$this->page]['MediaBox']['lly'] =
 * lower-left y coordinate in
 * points</li><li>$this->pagedim[$this->page]['MediaBox']['urx'] = upper-right x
 * coordinate in points</li><li>$this->pagedim[$this->page]['MediaBox']['ury'] =
 * upper-right y coordinate in
 * points</li></ul></li><li>$this->pagedim[$this->page]['CropBox'] : the visible
 * region of default user
 * space<ul><li>$this->pagedim[$this->page]['CropBox']['llx'] = lower-left x
 * coordinate in points</li><li>$this->pagedim[$this->page]['CropBox']['lly'] =
 * lower-left y coordinate in
 * points</li><li>$this->pagedim[$this->page]['CropBox']['urx'] = upper-right x
 * coordinate in points</li><li>$this->pagedim[$this->page]['CropBox']['ury'] =
 * upper-right y coordinate in
 * points</li></ul></li><li>$this->pagedim[$this->page]['BleedBox'] : the region
 * to which the contents of the page shall be clipped when output in a
 * production environment<ul><li>$this->pagedim[$this->page]['BleedBox']['llx']
 * = lower-left x coordinate in
 * points</li><li>$this->pagedim[$this->page]['BleedBox']['lly'] = lower-left y
 * coordinate in points</li><li>$this->pagedim[$this->page]['BleedBox']['urx'] =
 * upper-right x coordinate in
 * points</li><li>$this->pagedim[$this->page]['BleedBox']['ury'] = upper-right y
 * coordinate in points</li></ul></li><li>$this->pagedim[$this->page]['TrimBox']
 * : the intended dimensions of the finished page after
 * trimming<ul><li>$this->pagedim[$this->page]['TrimBox']['llx'] = lower-left x
 * coordinate in points</li><li>$this->pagedim[$this->page]['TrimBox']['lly'] =
 * lower-left y coordinate in
 * points</li><li>$this->pagedim[$this->page]['TrimBox']['urx'] = upper-right x
 * coordinate in points</li><li>$this->pagedim[$this->page]['TrimBox']['ury'] =
 * upper-right y coordinate in
 * points</li></ul></li><li>$this->pagedim[$this->page]['ArtBox'] : the extent
 * of the page's meaningful
 * content<ul><li>$this->pagedim[$this->page]['ArtBox']['llx'] = lower-left x
 * coordinate in points</li><li>$this->pagedim[$this->page]['ArtBox']['lly'] =
 * lower-left y coordinate in
 * points</li><li>$this->pagedim[$this->page]['ArtBox']['urx'] = upper-right x
 * coordinate in points</li><li>$this->pagedim[$this->page]['ArtBox']['ury'] =
 ...
 * margin.
 *
 * @param $margin (float) The margin. @public
 * @since 1.4
 ...
 *
 * @param $pad (float) internal padding. @public
 * @since 2.1.000 (2008-01-09)
 ...
 * @param $bottom (float) bottom padding @public
 * @since 5.9.000 (2010-10-03)
 ...
 *
 * @return array of padding values @public
 * @since 5.9.000 (2010-10-03)
 ...
 * @param $bottom (float) bottom margin @public
 * @since 5.9.000 (2010-10-03)
 * @see getCellMargins()
 */
 ...
 *
 * @return array of margin values @public
 * @since 5.9.000 (2010-10-03)
 * @see setCellMargins()
 */
 ...
 *
 * @param $brd (mixed) Indicates if borders must be drawn around the cell. The
 *            value can be a number:<ul><li>0: no border (default)</li><li>1:
 *            frame</li></ul> or a string containing some or all of the
 *            following characters (in any order):<ul><li>L: left</li><li>T:
 *            top</li><li>R: right</li><li>B: bottom</li></ul> or an array of
 *            line styles for each border group - for example: array('LTRB' =>
 *            array('width' => 2, 'cap' => 'butt', 'join' => 'miter', 'dash' =>
 *            0, 'color' => array(0, 0, 0)))
 * @return array of adjustments @public
 * @since 5.9.000 (2010-10-03)
 */
protected function adjustCellPadding($brd = 0) {
    ...
    if (is_string($brd)) {
        ...
        $brd = $newbrd;
    } elseif (($brd === 1) or ($brd === true) or
         (is_numeric($brd) and (intval($brd) > 0))) {
        $brd = array(
            'LRTB' => true);
    }
    if (! is_array($brd)) {
    ...
    foreach ($brd as $border => $style) {
        ...
        // correct internal cell padding if required to avoid overlap between
        // text and lines
        if ((strpos($border, 'T') !== false) and
             ($this->cell_padding['T'] < $adj)) {
            $this->cell_padding['T'] = $adj;
        }
        if ((strpos($border, 'R') !== false) and
             ($this->cell_padding['R'] < $adj)) {
            $this->cell_padding['R'] = $adj;
        }
        if ((strpos($border, 'B') !== false) and
             ($this->cell_padding['B'] < $adj)) {
            $this->cell_padding['B'] = $adj;
        }
        if ((strpos($border, 'L') !== false) and
 ...
 * @param $margin (float) Distance from the bottom of the page. @public
 * @since 1.0
 ...
 *
 * @return boolean auto-page-break mode @public
 * @since 5.9.088
 */
 ...
 *            values or a number indicating the zooming factor to use.
 *            <ul><li>fullpage: displays the entire page on screen
 *            </li><li>fullwidth: uses maximum width of window</li><li>real:
 *            uses real size (equivalent to 100% zoom)</li><li>default: uses
 *            viewer default mode</li></ul>
 * @param $layout (string) The page layout. Possible values
 *            are:<ul><li>SinglePage Display one page at a
 *            time</li><li>OneColumn Display the pages in one
 *            column</li><li>TwoColumnLeft Display the pages in two columns,
 *            with odd-numbered pages on the left</li><li>TwoColumnRight Display
 *            the pages in two columns, with odd-numbered pages on the
 *            right</li><li>TwoPageLeft (PDF 1.5) Display the pages two at a
 *            time, with odd-numbered pages on the left</li><li>TwoPageRight
 ...
 *            displayed when opened:<ul><li>UseNone Neither document outline nor
 *            thumbnail images visible</li><li>UseOutlines Document outline
 *            visible</li><li>UseThumbs Thumbnail images
 *            visible</li><li>FullScreen Full-screen mode, with no menu bar,
 *            window controls, or any other window visible</li><li>UseOC (PDF
 *            1.5) Optional content group panel visible</li><li>UseAttachments
 *            (PDF 1.6) Attachments panel visible</li></ul> @public
 * @since 1.2
 */
public function SetDisplayMode($zoom, $layout = 'SinglePage', $mode = 'UseNone') {
    if (($zoom == 'fullpage') or ($zoom == 'fullwidth') or ($zoom == 'real') or
         ($zoom == 'default') or (! is_string($zoom))) {
        $this->ZoomMode = $zoom;
    } else {
 ...
 * of about 2 for the resulting document. Compression is on by default. Note:
 * the Zlib extension is required for this feature. If not present, compression
 * will be turned off.
 *
 ...
 * whole document.
 *
 * @param $mode (boolean) If true force sRGB output intent. @public
 * @since 5.9.121 (2011-09-28)
 */
 ...
 * @since 5.9.027 (2010-12-01) @public
 */
 ...
 *
 * @param $title (string) The title. @public
 * @since 1.2
 ...
 *
 * @param $subject (string) The subject. @public
 * @since 1.2
 ...
 *
 * @param $author (string) The name of the author. @public
 * @since 1.2
 ...
 * ..'.
 *
 * @param $keywords (string) The list of keywords. @public
 * @since 1.2
 ...
 *
 * @param $creator (string) The name of the creator. @public
 * @since 1.2
 ...
 *
 * @param $msg (string) The error message @public
 * @since 1.0
 */
public function Error($msg) {
    // unset all class variables
    $this->_destroy(true);
    if (defined('K_TCPDF_THROW_EXCEPTION_ERROR') and
...
/**
 * This method begins the generation of the PDF document. It is not necessary to
 * call it explicitly because AddPage() does it automatically. Note: no page is
 * created by this method @public
 *
 * @since 1.0
 * @see AddPage(), Close()
 */
 ...
 * no page, AddPage() is called to prevent from getting an invalid document.
 * @public
 *
 * @since 1.0
 * @see Open(), Output()
    ...
    if (($pnum > 0) and ($pnum <= $this->numpages)) {
        ...
        if ($resetmargins) {
            ...
            if ($this->pagedim[$this->page]['olm'] !=
                ...
                $deltam = $this->pagedim[$this->page]['olm'] -
 ...
 *
 * @return int number of pages @public
 * @since 2.1.000 (2008-01-07)
 ...
 *            the string values specified at getPageSizeFromFormat() or an array
 *            of parameters specified at setPageFormat().
 * @param $keepmargins (boolean) if true overwrites the default page margins
 *            with the current margins @public
 ...
 * and top margins (or top-right if in RTL mode), and Header() is called to
 * display the header (if enabled). The origin of the coordinate system is at
 * the top-left corner (or top-right for RTL) and increasing ordinates go
 * downwards.
 *
 * @param $orientation (string) page orientation. Possible values are (case
 *            insensitive):<ul><li>P or PORTRAIT (default)</li><li>L or
 ...
 *            page will be used to display Table Of Content). @public
 * @since 1.0
 ...
 *            page used to display Table Of Content). @public
 * @since 4.2.010 (2008-11-14)
 * @see AddPage(), startPage(), addTOCPage(), endTOCPage()
 */
public function endPage($tocpage = false) {
// check if page is already closed
if (($this->page == 0) or ($this->numpages > $this->page) or
...
/**
 * Starts a new page to the document. The page must be closed using the
 * endPage() function. The origin of the coordinate system is at the top-left
 * corner and increasing ordinates go downwards.
 *
 * @param $orientation (string) page orientation. Possible values are (case
 *            insensitive):<ul><li>P or PORTRAIT (default)</li><li>L or
 *            LANDSCAPE</li></ul>
 ...
 *      getPageSizeFromFormat(), setPageFormat() @public
 */
 ...
 * position marked by this method. This function must be called after calling
 * Image() function for a background image. Background images must be always
 * inserted before calling Multicell() or WriteHTMLCell() or WriteHTML()
 * functions. @public
 *
...
/**
 * Set start-writing mark on selected page. Borders and fills are always created
 * after content and inserted on the position marked by this method.
 *
 * @param $page (int) page number (default is the current page) @protected
 * @since 4.6.021 (2009-07-20)
 */
 ...
 * @param $lc (array) RGB array color for line. @public
 */
public function setHeaderData($ln = '', $lw = 0, $ht = '', $hs = '', $tc = array(0,0,0), 
$lc = array(0,0,0)) {
$this->header_logo = $ln;
...
/**
 * Returns header data: <ul><li>$ret['logo'] = logo
 * image</li><li>$ret['logo_width'] = width of the image logo in user
 * units</li><li>$ret['title'] = header title</li><li>$ret['string'] = header
 * description string</li></ul>
 *
 * @return array() @public
 * @since 4.0.012 (2008-07-24)
 */
 ...
 *
 * @param $hm (int) distance in user units @public
 */
 ...
 *
 * @return float
 * @since 4.0.012 (2008-07-24) @public
 */
 ...
 *
 * @param $fm (int) distance in user units @public
 */
...
/**
 * Reset the xobject template used by Header() method. @public
 */
...
/**
 * Set a flag to automatically reset the xobject template used by Header()
 * method at each page.
 *
 * @param $val (boolean) set to true to reset Header xobject template at each
 *            page, false otherwise. @public
 */
 ...
 * AddPage() and could be overwritten in your own inherited class. @public
 */
...
if ($this->header_xobjid === false) {
    ...
    if (($headerdata['logo']) and ($headerdata['logo'] != K_BLANK_IMAGE)) {
        $imgtype = TCPDF_IMAGES::getImageFileType(
            K_PATH_IMAGES . $headerdata['logo']);
        if (($imgtype == 'eps') or ($imgtype == 'ai')) {
            $this->ImageEps(K_PATH_IMAGES . $headerdata['logo'], '', '', 
                $headerdata['logo_width']);
        } elseif ($imgtype == 'svg') {
            $this->ImageSVG(K_PATH_IMAGES . $headerdata['logo'], '', '', 
                $headerdata['logo_width']);
        } else {
            $this->Image(K_PATH_IMAGES . $headerdata['logo'], '', '', 
                $headerdata['logo_width']);
        }
    ...
    $this->Cell(($this->w - $this->original_lMargin - $this->original_rMargin), 
        0, '', 'T', 0, 'C');
    $this->endTemplate();
}
...
$x = 0;
$dx = 0;
if (! $this->header_xobj_autoreset and $this->booklet and
     (($this->page % 2) == 0)) {
...
/**
 * This method is used to render the page header. @protected
 *
 * @since 4.0.012 (2008-07-24)
 */
...
$this->SetFont($this->header_font[0], $this->header_font[1], 
    $this->header_font[2]);
$this->Header();
// restore position
if ($this->rtl) {
...
/**
 * This method is used to render the page footer. @protected
 *
 * @since 4.0.012 (2008-07-24)
 */
...
if ($this->print_footer) {
    ...
    $this->SetFont($this->footer_font[0], $this->footer_font[1], 
        $this->footer_font[2]);
    $this->Footer();
    // restore position
    if ($this->rtl) {
...
$this->footerlen[$this->page] = $this->pagelen[$this->page] -
     $this->footerpos[$this->page] + 1;
$this->InFooter = false;
}
 ...
 *
 * @return true if we are not in page header nor in page footer, false
 *         otherwise. @protected
 ...
 *
 * @return (array) Spot colors array. @public
...
/**
 * Defines a new spot color. It can be expressed in RGB components or gray
 * scale. The method can be called before the first page is created and the
 ...
 *
 * @param $type (string) Type of object affected by this color: ('draw', 'fill',
 *            'text').
 ...
 * @return (string) PDF color command. @public
...
/**
 * Set the color array for the specified type ('draw', 'fill', 'text'). It can
 * be expressed in RGB, CMYK or GRAY SCALE components. The method can be called
 ...
 * @return (string) The PDF command or empty string. @public
 ...
 * borders). It can be expressed in RGB, CMYK or GRAY SCALE components. The
 ...
 * @param $ret (boolean) If true do not send the PDF command.
 * @return string the PDF command @public
 * @since 3.1.000 (2008-06-11)
 * @see SetDrawColor()
 */
 ...
 * backgrounds). It can be expressed in RGB, CMYK or GRAY SCALE components. The
 * method can be called before the first page is created and the value is
 * retained from page to page.
 *
 * @param $color (array) Array of colors (1, 3 or 4 values).
 * @param $ret (boolean) If true do not send the PDF command. @public
...
/**
 * Defines the color used for text. It can be expressed in RGB components or
 * gray scale. The method can be called before the first page is created and the
 * value is retained from page to page.
 *
 * @param $color (array) Array of colors (1, 3 or 4 values).
 * @param $ret (boolean) If true do not send the PDF command. @public
 ...
 * @since 5.9.125 (2011-10-03)
 */
public function setColor($type, $col1 = 0, $col2 = -1, $col3 = -1, $col4 = -1, 
$ret = false, $name = '') {
// set default values
if (! is_numeric($col1)) {
    $col1 = 0;
...
if (($col2 == - 1) and ($col3 == - 1) and ($col4 == - 1)) {
    ...
    $intcolor = array(
        ...
        'G' => $col2, 
        'B' => $col3);
    $pdfcolor = sprintf('%F %F %F ', ($col1 / 255), ($col2 / 255), 
        ($col3 / 255));
    $suffix = 'rg';
} else {
    ...
    if (empty($name)) {
        ...
        $intcolor = array(
            ...
            'Y' => $col3, 
            'K' => $col4);
        $pdfcolor = sprintf('%F %F %F %F ', ($col1 / 100), ($col2 / 100), 
            ($col3 / 100), ($col4 / 100));
        $suffix = 'k';
    } else {
        // SPOT COLOR
...
/**
 * Defines the color used for all drawing operations (lines, rectangles and cell
 * borders). It can be expressed in RGB components or gray scale. The method can
 ...
 * @param $ret (boolean) If true do not send the command.
 * @param $name (string) Spot color name (if any).
 * @return (string) Empty string. @public
 * @since 1.3
 ...
 *            AddFont() or one of the standard families. It is also possible to
 *            pass an empty string, in that case, the current family is
 *            retained.
 * @param $fontstyle (string) Font style. Possible values are (case
 *            insensitive):<ul><li>empty string: regular</li><li>B:
 *            bold</li><li>I: italic</li><li>U: underline</li><li>D:
 *            line-through</li><li>O: overline</li></ul> or any combination. The
...
return $this->GetArrStringWidth(
    TCPDF_FONTS::utf8Bidi(
        TCPDF_FONTS::UTF8StringToArray($s, $this->isunicode, $this->CurrentFont), 
        $s, $this->tmprtl, $this->isunicode, $this->CurrentFont), $fontname, 
 ...
 * @param $fontstyle (string) Font style. Possible values are (case
 *            insensitive):<ul><li>empty string: regular</li><li>B:
 *            bold</li><li>I: italic</li><li>U: underline</li><li>D: line
 *            through</li><li>O: overline</li></ul> or any combination. The
 *            default value is regular.
 * @param $fontsize (float) Font size in points. The default value is the
 *            current size.
 * @param $getarray (boolean) if true returns an array of characters widths, if
 ...
 */
public function GetArrStringWidth($sa, $fontname = '', $fontstyle = '', 
$fontsize = 0, $getarray = false) {
 ...
 * @return int number of characters @public
...
/**
 * Fill the list of available fonts ($this->fontlist). @protected
 *
 * @since 4.0.013 (2008-07-28)
 */
...
/**
 * Imports a TrueType, Type1, core, or CID0 font and makes it available. It is
 * necessary to generate a font definition file first (read
 * /fonts/utils/README.TXT). The definition file (and the font file itself when
 * embedding) must be present either in the current directory or in the one
 * indicated by K_PATH_FONTS if the constant is defined. If it could not be
 * found, the error "Could not include font definition file" is generated.
 *
 * @param $family (string) Font family. The name can be chosen arbitrarily. If
 *            it is a standard family name, it will override the corresponding
 *            font.
 * @param $style (string) Font style. Possible values are (case
 *            insensitive):<ul><li>empty string: regular (default)</li><li>B:
 *            bold</li><li>I: italic</li><li>BI or IB: bold italic</li></ul>
 ...
 *            the information related to the used characters); if false embedd
 *            full font; if 'default' uses the default value set using
 *            setFontSubsetting(). This option is valid only for TrueTypeUnicode
 *            fonts. If you want to enable users to change the document, set
 *            this parameter to false. If you subset the font, the person who
 *            receives your PDF would need to have your same font in order to
 *            make changes to your PDF. The file size of the PDF would also be
 *            smaller because you are embedding only part of a font. @public
 * @since 1.5
...
$font_style = $style . ($this->underline ? 'U' : '') .
     ($this->linethrough ? 'D' : '') . ($this->overline ? 'O' : '');
$fontdata = array(
    'fontkey' => $fontkey, 
    'family' => $family, 
    'style' => $font_style);
...
// create artificial font style variations if missing (only works with
// non-embedded fonts)
...
if (! TCPDF_STATIC::empty_string($file)) {
    if (! isset($this->FontFiles[$file])) {
        if ((strcasecmp($type, 'TrueType') == 0) or
             (strcasecmp($type, 'TrueTypeUnicode') == 0)) {
        ...
        $this->FontFiles[$file]['subset'] = ($this->FontFiles[$file]['subset'] and
             $subset);
...
/**
 * Sets the font used to print character strings. The font can be either a
 * standard one or a font added via the AddFont() method. Standard fonts use
 * Windows encoding cp1252 (Western Europe). The method can be called before the
 * first page is created and the font is retained from page to page. If you just
 * wish to change the current font size, it is simpler to call SetFontSize().
 * Note: for the standard fonts, the font metric files must be accessible. There
 * are three possibilities for this:<ul><li>They are in the current directory
 ...
 *            AddFont() or one of the standard Type1 families (case
 *            insensitive):<ul><li>times (Times-Roman)</li><li>timesb
 *            (Times-Bold)</li><li>timesi (Times-Italic)</li><li>timesbi
 *            (Times-BoldItalic)</li><li>helvetica
 *            (Helvetica)</li><li>helveticab (Helvetica-Bold)</li><li>helveticai
 *            (Helvetica-Oblique)</li><li>helveticabi
 *            (Helvetica-BoldOblique)</li><li>courier (Courier)</li><li>courierb
 *            (Courier-Bold)</li><li>courieri
 *            (Courier-Oblique)</li><li>courierbi
 *            (Courier-BoldOblique)</li><li>symbol (Symbol)</li><li>zapfdingbats
 *            (ZapfDingbats)</li></ul> It is also possible to pass an empty
 *            string. In that case, the current family is retained.
 * @param $style (string) Font style. Possible values are (case
 *            insensitive):<ul><li>empty string: regular</li><li>B:
 *            bold</li><li>I: italic</li><li>U: underline</li><li>D: line
 *            through</li><li>O: overline</li></ul> or any combination. The
 *            default value is regular. Bold and italic styles do not apply to
 *            Symbol and ZapfDingbats basic fonts or other fonts when not
 *            defined.
 ...
 *            receives your PDF would need to have your same font in order to
 *            make changes to your PDF. The file size of the PDF would also be
 *            smaller because you are embedding only part of a font.
 ...
 */
public function SetFont($family, $style = '', $size = null, $fontfile = '', 
$subset = 'default', $out = true) {
...
if (isset($this->CurrentFont['fontkey']) and
     isset($this->CurrentFont['subsetchars'])) {
 ...
 * @param $out (boolean) if true output the font size command, otherwise only
 *            set the font properties. @public
 * @since 1.0
 * @see SetFont()
 */
...
if (isset($this->CurrentFont['desc']['Ascent']) and
     ($this->CurrentFont['desc']['Ascent'] > 0)) {
    $font_ascent = ($this->CurrentFont['desc']['Ascent'] * $size / 1000);
}
if (isset($this->CurrentFont['desc']['Descent']) and
     ($this->CurrentFont['desc']['Descent'] <= 0)) {
...
if ($out and ($this->page > 0) and (isset($this->CurrentFont['i'])) and
     ($this->state == 2)) {
    $this->_out(
        sprintf('BT /F%d %F Tf ET', $this->CurrentFont['i'], $this->FontSizePt));
}
}
...
if (isset($this->CurrentFont['desc']['FontBBox'])) {
    $tmpbbox = explode(' ', 
        substr($this->CurrentFont['desc']['FontBBox'], 1, - 1));
    $fbbox = array_map(
        array(
            $this, 
    ...
    if (isset($this->CurrentFont['desc']['MaxWidth'])) {
        $maxw = $this->getAbsFontMeasure(
            intval($this->CurrentFont['desc']['MaxWidth']));
    } else {
        $maxw = 0;
 ...
 * @return int font descent @public
 * @author Nicola Asuni
 ...
 * @param $style (string) Font style.
 * @return (boolean) true if the char is defined, false otherwise. @public
 * @since 5.9.153 (2012-03-28)
 */
public function isCharDefined($char, $font = '', $style = '') {
if (is_string($char)) {
    // get character code
    $char = TCPDF_FONTS::UTF8StringToArray($char, $this->isunicode, 
        $this->CurrentFont);
    $char = $char[0];
}
...
/**
 * Replace missing font characters on selected font with specified
 * substitutions.
 *
 ...
 *            the character to check (integer value) and the value is a single
 *            intege value or an array of possible substitutes.
 * @return (string) Processed text. @public
 * @since 5.9.153 (2012-03-28)
 */
...
$fontdata = $this->AddFont($font, $style);
$fontinfo = $this->getFontBuffer($fontdata['fontkey']);
$uniarr = TCPDF_FONTS::UTF8StringToArray($text, $this->isunicode, 
    $this->CurrentFont);
...
return TCPDF_FONTS::UniArrSubString(
    TCPDF_FONTS::UTF8ArrayToUniArray($uniarr, $this->isunicode));
}

/**
 * Defines the default monospaced font.
 *
 * @param $font (string) Font name. @public
 * @since 4.5.025
 */
 ...
 * clickable area which directs to another place within the document.<br /> The
 * identifier can then be passed to Cell(), Write(), Image() or Link(). The
 * destination is defined with SetLink(). @public
 *
 * @since 1.5
 ...
 *            (default value). If you prefix a page number with the * character,
 *            then this page will not be changed when adding/deleting/moving
 *            pages. @public
 * @since 1.5
 * @see AddLink()
 */
 ...
 * @param $spaces (int) number of spaces on the text to link @public
 * @since 1.5
...
/**
 * Puts a markup annotation on a rectangular area of the page. !!!!THE
 * ANNOTATION SUPPORT IS NOT YET FULLY IMPLEMENTED !!!!
 *
 * @param $x (float) Abscissa of the upper-left corner of the rectangle
 * @param $y (float) Ordinate of the upper-left corner of the rectangle
 * @param $w (float) Width of the rectangle
 ...
 */
public function Annotation($x, $y, $w, $h, $text, 
$opt = array('Subtype'=>'Text'), $spaces = 0) {
if ($this->inxobj) {
...
if (! $this->pdfa_mode) {
    if ((($opt['Subtype'] == 'FileAttachment') or ($opt['Subtype'] == 'Sound')) and
         (! TCPDF_STATIC::empty_string($opt['FS'])) and
         (@file_exists($opt['FS']) or TCPDF_STATIC::isValidURL($opt['FS'])) and
...
if (isset($opt['mk']['ri']) and @file_exists($opt['mk']['ri'])) {
    $this->Image($opt['mk']['ri'], '', '', 0, 0, '', '', '', false, 300, '', 
        false, false, 0, false, true);
}
if (isset($opt['mk']['ix']) and @file_exists($opt['mk']['ix'])) {
    $this->Image($opt['mk']['ix'], '', '', 0, 0, '', '', '', false, 300, '', 
        false, false, 0, false, true);
}
}
 ...
 *
 * @since 4.4.000 (2008-12-07) @protected
 * @see Annotation()
 */
...
foreach ($this->embeddedfiles as $filename => $filedata) {
    ...
    if ($data !== FALSE) {
        ...
        if ($rawsize > 0) {
            ...
            $out .= '<</Type /Filespec /F ' .
                 $this->_datastring($filename, $filedata['f']) . ' /EF <</F ' .
                 $filedata['n'] . ' 0 R>> >>';
            $out .= "\n" . 'endobj';
            $this->_out($out);
            ...
            $out .= '<< /Type /EmbeddedFile' . $filter . ' /Length ' .
                 strlen($stream) . ' /Params <</Size ' . $rawsize . '>> >>';
            $out .= ' stream' . "\n" . $stream . "\n" . 'endstream';
            $out .= "\n" . 'endobj';
            $this->_out($out);
        }
...
/**
 * Prints a text cell at the specified position. This method allows to place a
 * string precisely on the page.
 *
 ...
 *            StartTransform() before this function and StopTransform() to stop
 *            the clipping tranformation).
 * @param $ffill (boolean) if true fills the text
 * @param $border (mixed) Indicates if borders must be drawn around the cell.
 *            The value can be a number:<ul><li>0: no border
 *            (default)</li><li>1: frame</li></ul> or a string containing some
 *            or all of the following characters (in any order):<ul><li>L:
 *            left</li><li>T: top</li><li>R: right</li><li>B: bottom</li></ul>
 *            or an array of line styles for each border group - for example:
 *            array('LTRB' => array('width' => 2, 'cap' => 'butt', 'join' =>
 ...
 *            below</li></ul>Putting 1 is equivalent to putting 0 and calling
 *            Ln() just after. Default value: 0.
 * @param $align (string) Allows to center or align the text. Possible values
 *            are:<ul><li>L or empty string: left align (default
 *            value)</li><li>C: center</li><li>R: right align</li><li>J:
 *            justify</li></ul>
 ...
 *            horizontal scaling only if text is larger than cell
 *            width</li><li>2 = forced horizontal scaling to fit cell
 *            width</li><li>3 = character spacing only if text is larger than
 *            cell width</li><li>4 = forced character spacing to fit cell
 *            width</li></ul> General font stretching and scaling values will be
 ...
 *            value. Possible values are:<ul><li>T : cell top</li><li>A : font
 *            top</li><li>L : font baseline</li><li>D : font bottom</li><li>B :
 *            cell bottom</li></ul>
 * @param $valign (string) text vertical alignment inside the cell. Possible
 *            values are:<ul><li>T : top</li><li>C : center</li><li>B :
 *            bottom</li></ul>
 * @param $rtloff (boolean) if true uses the page top-left corner as origin of
 *            axis for $x and $y initial position. @public
 * @since 1.0
 * @see Cell(), Write(), MultiCell(), WriteHTML(), WriteHTMLCell()
 */
public function Text($x, $y, $txt, $fstroke = false, $fclip = false, $ffill = true, 
$border = 0, $ln = 0, $align = '', $fill = false, $link = '', $stretch = 0, 
$ignore_min_height = false, $calign = 'T', $valign = 'M', $rtloff = false) {
$textrendermode = $this->textrendermode;
$textstrokewidth = $this->textstrokewidth;
$this->setTextRenderingMode($fstroke, $ffill, $fclip);
$this->SetXY($x, $y, $rtloff);
$this->Cell(0, 0, $txt, $border, $ln, $align, $fill, $link, $stretch, 
 ...
 * returns a value according to the mode selected by SetAutoPageBreak().<br />
 ...
 * @param $addpage (boolean) if true add a page, otherwise only return the
 *            true/false state
 * @return boolean true in case of page break, false otherwise.
 * @since 3.2.000 (2008-07-01) @protected
 */
...
if ((($y + $h) > $this->PageBreakTrigger) and ($this->inPageBody()) and
    ...
    if ($addpage) {
        ...
        if ($this->rtl) {
            if ($this->pagedim[$this->page]['orm'] !=
                ...
                $this->x = $x - ($this->pagedim[$this->page]['orm'] -
                 $this->pagedim[$oldpage]['orm']);
        } else {
            $this->x = $x;
        }
        ...
        if ($this->pagedim[$this->page]['olm'] != $this->pagedim[$oldpage]['olm']) {
            $this->x = $x + ($this->pagedim[$this->page]['olm'] -
                 $this->pagedim[$oldpage]['olm']);
        } else {
            $this->x = $x;
        }
 ...
 * put a link on the text.<br /> If automatic page breaking is enabled and the
 ...
 *            value.
 * @param $calign (string) cell vertical alignment relative to the specified Y
 *            value. Possible values are:<ul><li>T : cell top</li><li>C :
 *            center</li><li>B : cell bottom</li><li>A : font top</li><li>L :
 *            font baseline</li><li>D : font bottom</li></ul>
 * @param $valign (string) text vertical alignment inside the cell. Possible
 *            values are:<ul><li>T : top</li><li>C : center</li><li>B :
 *            bottom</li></ul> @public
 * @since 1.0
 * @see SetFont(), SetDrawColor(), SetFillColor(), SetTextColor(),
 *      SetLineWidth(), AddLink(), Ln(), MultiCell(), Write(),
 *      SetAutoPageBreak()
 */
public function Cell($w, $h = 0, $txt = '', $border = 0, $ln = 0, $align = '', 
$fill = false, $link = '', $stretch = 0, $ignore_min_height = false, $calign = 'T', 
$valign = 'M') {
...
if ($this->state == 2) {
    $this->_out(
        $this->getCellCode($w, $h, $txt, $border, $ln, $align, $fill, $link, 
            $stretch, true, $calign, $valign));
}
// restore data
$this->x = $x;
$this->y = $y;
...
/**
 * Returns the PDF string code to print a cell (rectangular area) with optional
 * borders, background color and character string. The upper-left corner of the
 * cell corresponds to the current position. The text can be aligned or
 * centered. After the call, the current position moves to the right or to the
 * next line. It is possible to put a link on the text.<br /> If automatic page
 * breaking is enabled and the cell goes beyond the limit, a page break is done
 * before outputting.
 *
 * @param $w (float) Cell width. If 0, the cell extends up to the right margin.
 * @param $h (float) Cell height. Default value: 0.
 ...
 *            font baseline</li><li>D : font bottom</li></ul>
 * @param $valign (string) text vertical alignment inside the cell. Possible
 *            values are:<ul><li>T : top</li><li>M : middle</li><li>B :
 *            bottom</li></ul>
 * @return string containing cell code @protected
 * @since 1.0
 * @see Cell()
 */
protected function getCellCode($w, $h = 0, $txt = '', $border = 0, $ln = 0, 
$align = '', $fill = false, $link = '', $stretch = 0, $ignore_min_height = false, $calign = 'T', 
$valign = 'M') {
...
case 'A':
    {
        ...
        switch ($valign) {
            ...
            case 'B':
                {
                    // bottom
                    $y -= ($h - $this->cell_padding['B'] - $this->FontAscent -
                         $this->FontDescent);
                    break;
                }
            default:
...
case 'B':
    {
        // bottom
        $yt = $y + $h - $this->cell_padding['B'] - $this->FontAscent -
             $this->FontDescent;
        break;
    }
default:
...
$s .= sprintf('%F %F %F %F re %s ', $xk, (($this->h - $y) * $k), ($w * $k), 
    (- $h * $k), $op);
}
// draw borders
...
$txt2 = $txt;
if ($this->isunicode) {
    if (($this->CurrentFont['type'] == 'core') or
         ($this->CurrentFont['type'] == 'TrueType') or
         ($this->CurrentFont['type'] == 'Type1')) {
        $txt2 = TCPDF_FONTS::UTF8ToLatin1($txt2, $this->isunicode, 
            $this->CurrentFont);
    } else {
        $unicode = TCPDF_FONTS::UTF8StringToArray($txt, $this->isunicode, 
            $this->CurrentFont); // array
                                 // of
                                 // UTF-8
                                 // unicode
                                 // values
        $unicode = TCPDF_FONTS::utf8Bidi($unicode, '', $this->tmprtl, 
            $this->isunicode, $this->CurrentFont);
        ...
        if (defined('K_THAI_TOPCHARS') and (K_THAI_TOPCHARS == true)) {
            ...
            for ($i = 0; $i < $numchars; $i ++) {
                if (($unicode[$i] >= 0x0e00) && ($unicode[$i] <= 0x0e5b)) {
                    ...
                    if (in_array($ch0, $tonemark)) {
                        if ($chn == 0x0e33) {
                            ...
                            if (in_array($ch1, $longtail)) {
                                ...
                                $output[] = $this->replaceChar($ch0, 
                                    (0xf713 + $ch0 - 0x0e48));
                            } else {
                                // tonemark at upper right (normal position)
                                $output[] = $ch0;
                            }
                        } elseif (in_array($ch1, $longtail) or (in_array($ch2, 
                            $longtail) and in_array($ch1, $lowvowel))) {
                    ...
                    } elseif (($ch0 == 0x0e33) and (in_array($ch1, $longtail) or (in_array(
                        $ch2, $longtail) and in_array($ch1, $tonemark)))) {
                        // add lower left nikhahit and sara aa
                        if ($this->isCharDefined(0xf711) and
                             $this->isCharDefined(0x0e32)) {
                            $output[] = 0xf711;
                    ...
                    } elseif (in_array($ch1, $lowtail) and
                         in_array($ch0, $lowvowel)) {
                        // lower vowel
                        $output[] = $this->replaceChar($ch0, 
                            (0xf718 + $ch0 - 0x0e38));
            ...
            $this->setFontSubBuffer($this->CurrentFont['fontkey'], 
                'subsetchars', $this->CurrentFont['subsetchars']);
...
if ($stretch > 0) {
    ...
    if ($width <= 0) {
        ...
        $ratio = (($w - $this->cell_padding['L'] - $this->cell_padding['R']) /
             $width);
    }
    ...
    if (($ratio < 1) or (($ratio > 1) and (($stretch % 2) == 0))) {
        ...
        if ($stretch > 2) {
            ...
            $this->font_spacing += ($w - $this->cell_padding['L'] -
                 $this->cell_padding['R'] - $width) / (max(
                    ($this->GetNumChars($txt) - 1), 1) *
...
// rendering mode
$s .= sprintf('BT %d Tr %F w ET ', $this->textrendermode, 
    ($this->textstrokewidth * $this->k));
...
if (($align == 'J') and ($ns > 0)) {
    if ($this->isUnicodeFont()) {
        ...
        $spacewidth = - 1000 *
             ($w - $width - $this->cell_padding['L'] - $this->cell_padding['R']) /
             ($ns ? $ns : 1) / ($this->FontSize ? $this->FontSize : 1);
        if ($this->font_stretching != 100) {
            // word spacing is affected by stretching
            $spacewidth /= ($this->font_stretching / 100);
        }
        // set word position to be used with TJ operator
        $txt2 = str_replace(chr(0) . chr(32), 
            ') ' . sprintf('%F', $spacewidth) . ' (', $txt2);
        $unicode_justification = true;
    } else {
        // get string width
        $width = $txwidth;
        // new space width
        $spacewidth = (($w - $width - $this->cell_padding['L'] -
             $this->cell_padding['R']) / ($ns ? $ns : 1)) * $this->k;
        if ($this->font_stretching != 100) {
...
$xdk = $xdx * $k;
// print text
$s .= sprintf('BT %F %F Td [(%s)] TJ ET', $xdk, (($this->h - $basefonty) * $k), 
    $txt2);
if (isset($uniblock)) {
    // print overlapping characters as separate string
    $xshift = 0; // horizontal shift
    $ty = (($this->h - $basefonty + (0.2 * $this->FontSize)) * $k);
    $spw = (($w - $txwidth - $this->cell_padding['L'] - $this->cell_padding['R']) /
         ($ns ? $ns : 1));
    foreach ($uniblock as $uk => $uniarr) {
        if (($uk % 2) == 0) {
            ...
            $xshift += $this->GetArrStringWidth($uniarr); // + shift
                                                          // justification
        } else {
            // character to print
            $topchr = TCPDF_FONTS::arrUTF8ToUTF16BE($uniarr, false);
            $topchr = TCPDF_STATIC::_escape($topchr);
            $s .= sprintf(' BT %F %F Td [(%s)] TJ ET', ($xdk + ($xshift * $k)), 
                $ty, $topchr);
        }
    }
}
...
if ($link) {
    $this->Link($xdx, $yt, $width, ($this->FontAscent + $this->FontDescent), 
        $link, $ns);
}
}
// output cell
...
$gstyles = '' . $this->linestyleWidth . ' ' . $this->linestyleCap . ' ' .
 $this->linestyleJoin . ' ' . $this->linestyleDash . ' ' . $this->DrawColor . ' ' .
 $this->FillColor . "\n";
$rs = $gstyles . $rs;
$this->cell_padding = $prev_cell_padding;
$this->cell_margin = $prev_cell_margin;
 ...
 * @return int the replaced char or the old char in case the new char i not
 *         defined @protected
 ...
 *            array('width' => 2, 'cap' => 'butt', 'join' => 'miter', 'dash' =>
 *            0, 'color' => array(0, 0, 0)))
 * @return string containing cell border code @protected
 * @see SetLineStyle()
...
if (is_array($style) and ! empty($style)) {
    // apply border style
    $prev_style = $this->linestyleWidth . ' ' . $this->linestyleCap . ' ' .
         $this->linestyleJoin . ' ' . $this->linestyleDash . ' ' .
         $this->DrawColor . ' ';
...
if (strlen($border) == 4) {
    ...
    if ((strpos($border, 'L') !== false) and (strpos($border, 'T') !== false)) { // LT
        ...
        $s .= sprintf('%F %F l ', $xR, $yR);
        $s .= 'S ';
    } elseif ((strpos($border, 'T') !== false) and
         (strpos($border, 'R') !== false)) { // TR
        $s .= sprintf('%F %F m ', $xT, $yT);
        $s .= sprintf('%F %F l ', $xR, $yR);
        $s .= sprintf('%F %F l ', $xB, $yB);
        $s .= 'S ';
    } elseif ((strpos($border, 'R') !== false) and
         (strpos($border, 'B') !== false)) { // RB
        $s .= sprintf('%F %F m ', $xR, $yR);
        $s .= sprintf('%F %F l ', $xB, $yB);
        $s .= sprintf('%F %F l ', $xL, $yL);
        $s .= 'S ';
    } elseif ((strpos($border, 'B') !== false) and
         (strpos($border, 'L') !== false)) { // BL
        $s .= sprintf('%F %F m ', $xB, $yB);
        $s .= sprintf('%F %F l ', $xL, $yL);
        $s .= sprintf('%F %F l ', $xT, $yT);
        $s .= 'S ';
    } elseif ((strpos($border, 'L') !== false) and
         (strpos($border, 'R') !== false)) { // LR
        $s .= sprintf('%F %F m ', $xL, $yL);
        $s .= sprintf('%F %F l ', $xT, $yT);
        $s .= 'S ';
        $s .= sprintf('%F %F m ', $xR, $yR);
...
if (is_array($style) and ! empty($style)) {
    ...
    $s .= "\n" . $this->linestyleWidth . ' ' . $this->linestyleCap . ' ' .
         $this->linestyleJoin . ' ' . $this->linestyleDash . ' ' .
         $this->DrawColor . "\n";
}
}
 ...
 *
 * @param $w (float) Width of cells. If 0, they extend up to the right margin of
 *            the page.
 ...
 *            'miter', 'dash' => 0, 'color' => array(0, 0, 0)))
 * @param $align (string) Allows to center or align the text. Possible values
 *            are:<ul><li>L or empty string: left align</li><li>C:
 *            center</li><li>R: right align</li><li>J: justification (default
 *            value when $ishtml=false)</li></ul>
 * @param $fill (boolean) Indicates if the cell background must be painted
 *            (true) or transparent (false).
 * @param $ln (int) Indicates where the current position should go after the
 *            call. Possible values are:<ul><li>0: to the right</li><li>1: to
 *            the beginning of the next line [DEFAULT]</li><li>2:
 *            below</li></ul>
 ...
 *            content (default = false). Never set this parameter to true, use
 *            instead writeHTMLCell() or writeHTML() methods.
 ...
 *            remaining space to the bottom of the page, or 0 for disable this
 *            feature. This feature works only when $ishtml=false.
 * @param $valign (string) Vertical alignment of text (requires $maxh = $h > 0).
 *            Possible values are:<ul><li>T: TOP</li><li>M: middle</li><li>B:
 *            bottom</li></ul>. This feature works only when $ishtml=false and
 *            the cell must fit in a single page.
 * @param $fitcell (boolean) if true attempt to fit all the text within the cell
 *            by reducing the font size (do not work in HTML mode). $maxh must
 *            be greater than 0 and wqual to $h.
 * @return int Return the number of cells or 1 for html mode. @public
 * @since 1.3
 * @see SetFont(), SetDrawColor(), SetFillColor(), SetTextColor(),
...
$resth = 0;
if (($h > 0) and $this->inPageBody() and
 (($y + $h + $mc_margin['T'] + $mc_margin['B']) > $this->PageBreakTrigger)) {
...
if ($fitcell) {
    // ajust height values
    $tobottom = ($this->h - $this->y - $this->bMargin - $this->cell_padding['T'] -
         $this->cell_padding['B']);
...
if ($maxh > 0) {
    ...
    if ($fitcell and ($text_height > $maxh) and ($this->FontSizePt > 1)) {
        // try to reduce font size to fit text on cell (use a quick search
        // algorithm)
        $fmin = 1;
        $fmax = $this->FontSizePt;
        $diff_epsilon = (1 / $this->k); // one point (min resolution)
        $maxit = (2 * min(100, max(10, intval($fmax)))); // max number of
                                                         // iterations
        while ($maxit >= 0) {
            $fmid = (($fmax + $fmin) / 2);
            $this->SetFontSize($fmid, false);
            $this->resetLastH();
            $text_height = $this->getStringHeight($w, $txt, $reseth, 
                $autopadding, $mc_padding, $border);
...
// get border modes
$border_start = TCPDF_STATIC::getBorderMode($border, $position = 'start', 
$this->opencell);
$border_end = TCPDF_STATIC::getBorderMode($border, $position = 'end', 
$this->opencell);
$border_middle = TCPDF_STATIC::getBorderMode($border, $position = 'middle', 
$this->opencell);
...
if ($page > $startpage) {
    if (($this->rtl) and
         ($this->pagedim[$page]['orm'] != $this->pagedim[$startpage]['orm'])) {
        $this->x -= ($this->pagedim[$page]['orm'] -
         $this->pagedim[$startpage]['orm']);
} elseif ((! $this->rtl) and
     ($this->pagedim[$page]['olm'] != $this->pagedim[$startpage]['olm'])) {
...
for ($column = $startcolumn; $column <= $endcolumn; ++ $column) { // for each
    ...
    $ccode .= $this->getCellCode($w, $h, '', $cborder, 1, '', $fill, '', 0, 
        true) . "\n";
} // end for each column
} elseif ($page == $startpage) { // first page
for ($column = $startcolumn; $column < $this->num_columns; ++ $column) { // for
                                                                         // each
                                                                         // column
    $this->selectColumn($column);
    if ($this->rtl) {
 ...
 * @param $cellpadding (float) Internal cell padding, if empty uses default cell
 *            padding.
 * @param $border (mixed) Indicates if borders must be drawn around the cell.
 *            The value can be a number:<ul><li>0: no border
 *            (default)</li><li>1: frame</li></ul> or a string containing some
 ...
 * @author Alexander Escalona Fern\E1ndez, Nicola Asuni @public
 * @since 4.5.011
 */
public function getNumLines($txt, $w = 0, $reseth = false, $autopadding = true, 
...
$lines = 1;
$sum = 0;
$chars = TCPDF_FONTS::utf8Bidi(
TCPDF_FONTS::UTF8StringToArray($txt, $this->isunicode, $this->CurrentFont), $txt, 
...
if (($c != 160) and (($c == 173) or
 preg_match($this->re_spaces, TCPDF_FONTS::unichr($c, $this->isunicode)) or (($c ==
 45) and ($i > 0) and ($i < ($length - 1)) and @preg_match(
    '/[\p{L}]/' . $this->re_space['m'], 
    TCPDF_FONTS::unichr($chars[($i - 1)], $this->isunicode)) and @preg_match(
    '/[\p{L}]/' . $this->re_space['m'], 
 ...
 * string using the Multicell() method. Generally, if you want to know the exact
 * height for a block of content you can use the following alternative
 * technique: @pre // store current object $pdf->startTransaction(); // store
 * starting values $start_y = $pdf->GetY(); $start_page = $pdf->getPage(); //
 * call your printing functions with your parameters // - - - - - - - - - - - -
 * - - - - - - - - - - - - - - - - - $pdf->MultiCell($w=0, $h=0, $txt,
 * $border=1, $align='L', $fill=false, $ln=1, $x='', $y='', $reseth=true,
 * $stretch=0, $ishtml=false, $autopadding=true, $maxh=0); // - - - - - - - - -
 * - - - - - - - - - - - - - - - - - - - - // get the new Y $end_y =
 * $pdf->GetY(); $end_page = $pdf->getPage(); // calculate height $height = 0;
 * if ($end_page == $start_page) { $height = $end_y - $start_y; } else { for
 * ($page=$start_page; $page <= $end_page; ++$page) { $this->setPage($page); if
 * ($page == $start_page) { // first page $height = $this->h - $start_y -
 * $this->bMargin; } elseif ($page == $end_page) { // last page $height = $end_y
 * - $this->tMargin; } else { $height = $this->h - $this->tMargin -
 * $this->bMargin; } } } // restore previous object $pdf =
 ...
 * @return float Return the minimal height needed for multicell method for
 *         printing the $txt param.
 * @author Nicola Asuni, Alexander Escalona Fern\E1ndez @public
 */
public function getStringHeight($w, $txt, $reseth = false, $autopadding = true, 
$cellpadding = '', $border = 0) {
// adjust internal padding
$prev_cell_padding = $this->cell_padding;
$prev_lasth = $this->lasth;
...
$this->adjustCellPadding($border);
$lines = $this->getNumLines($txt, $w, $reseth, $autopadding, $cellpadding, 
$border);
 ...
 *            width</li></ul> General font stretching and scaling values will be
 *            preserved when possible.
 * @param $firstline (boolean) if true prints only the first line and return the
 *            remaining string.
 * @param $firstblock (boolean) if true the string is the starting of a line.
 * @param $maxh (float) maximum height. It should be >= $h and less then
 *            remaining space to the bottom of the page, or 0 for disable this
 *            feature.
 * @param $wadj (float) first line width will be reduced by this amount (used in
 *            HTML mode).
 ...
 *         $firstline = true. @public
 * @since 1.5
 */
public function Write($h, $txt, $link = '', $fill = false, $align = '', $ln = false, 
$stretch = 0, $firstline = false, $firstblock = false, $maxh = 0, $wadj = 0, $margin = '') {
// check page for no-write regions and adapt page margins if necessary
list ($this->x, $this->y) = $this->checkPageRegions($h, $this->x, $this->y);
if (strlen($txt) == 0) {
// fix empty text
...
if ($arabic or ($this->tmprtl == 'R') or
 preg_match(TCPDF_FONT_DATA::$uni_RE_PATTERN_RTL, $s)) {
$rtlmode = true;
} else {
$rtlmode = false;
}
...
$chars = TCPDF_FONTS::UTF8StringToArray($s, $this->isunicode, 
$this->CurrentFont);
...
if ($firstline) {
    ...
    if ($rtlmode) {
        $tmparr = TCPDF_FONTS::utf8Bidi($tmparr, $tmpstr, $this->tmprtl, 
            $this->isunicode, $this->CurrentFont);
    }
...
$shy = false;
// account for margin changes
if ((($this->y + $this->lasth) > $this->PageBreakTrigger) and
     ($this->inPageBody())) {
    $this->AcceptPageBreak();
    if ($this->rtl) {
        $this->x -= $margin['R'];
...
// \p{Z} or \p{Separator}: any kind of Unicode whitespace or invisible
// separator.
// \p{Lo} or \p{Other_Letter}: a Unicode letter or ideograph that does not have
// lowercase and uppercase variants.
// \p{Lo} is needed because Chinese characters are packed next to each other
// without spaces in between.
if (($c != 160) and (($c == 173) or
     preg_match($this->re_spaces, TCPDF_FONTS::unichr($c, $this->isunicode)) or (($c ==
     45) and ($i < ($nb - 1)) and @preg_match(
        '/[\p{L}]/' . $this->re_space['m'], 
        TCPDF_FONTS::unichr($pc, $this->isunicode)) and @preg_match(
        '/[\p{L}]/' . $this->re_space['m'], 
        TCPDF_FONTS::unichr($chars[($i + 1)], $this->isunicode))))) {
...
if ($this->isUnicodeFont() and ($arabic)) {
    // with bidirectional algorithm some chars may be changed affecting the line
    // length
    // *** very slow ***
    $l = $this->GetArrStringWidth(
        TCPDF_FONTS::utf8Bidi(array_slice($chars, $j, ($i - $j)), '', 
            $this->tmprtl, $this->isunicode, $this->CurrentFont));
} else {
    $l += $this->GetCharWidth($c);
}
if (($l > $wmax) or
     (($c == 173) and (($l + $tmp_shy_replacement_width) >= $wmax))) {
    ...
    if ($sep == - 1) {
        ...
        if (($this->rtl and ($this->x <= ($this->w - $this->rMargin -
             $this->cell_padding['R'] - $margin['R'] - $chrwidth))) or ((! $this->rtl) and ($this->x >= ($this->lMargin +
             $this->cell_padding['L'] + $margin['L'] + $chrwidth)))) {
            ...
            if ($firstline) {
                ...
                $tmparr = array_slice($chars, $j, ($i - $j));
                if ($rtlmode) {
                    $tmparr = TCPDF_FONTS::utf8Bidi($tmparr, $tmpstr, 
                        $this->tmprtl, $this->isunicode, $this->CurrentFont);
                }
                $linew = $this->GetArrStringWidth($tmparr);
                unset($tmparr);
        ...
        $nextstr = TCPDF_STATIC::pregSplit('/' . $this->re_space['p'] . '/', 
            $this->re_space['m'], $this->stringTrim($strrest));
        if (isset($nextstr[0]) and ($this->GetStringWidth($nextstr[0]) > $pw)) {
            ...
            $tmpstr = TCPDF_FONTS::UniArrSubString($uchars, $j, 
                ($sep + $endspace));
            if ($firstline) {
                $startx = $this->x;
            ...
            $this->Cell($w, $h, $shy_char_left . $tmpstr . $shy_char_right, 0, 
                1, $align, $fill, $link, $stretch);
            unset($tmpstr);
            if ($firstline) {
                if ($chars[$sep] == 45) {
                    $endspace += 1;
                ...
                $this->cell_padding = $tmpcellpadding;
                return (TCPDF_FONTS::UniArrSubString($uchars, 
                    ($sep + $endspace)));
            }
            $i = $sep;
            $sep = - 1;
 ...
 *
 * @return int Return the remaining width @protected
 */
 ...
 * @param $fitonpage (boolean) if true the block is resized to not exceed page
 *            dimensions.
 * @return array($w, $h, $x, $y) @protected
...
// resize the block to be horizontally contained on a single page or single
// column
if ($fitonpage) {
...
// resize the block to be contained on the remaining available page or column
// space
if ($fitonpage) {
$ratio_wh = ($w / $h);
...
/**
 * Puts an image in the page. The upper-left corner must be given. The
 * dimensions can be specified in different ways:<ul> <li>explicit width and
 * height (expressed in user unit)</li> <li>one explicit dimension, the other
 * being calculated automatically in order to keep the original proportions</li>
 ...
 * supported by GD: GD, GD2, GD2PART, GIF, JPEG, PNG, BMP, XBM, XPM; The format
 * can be specified explicitly or inferred from the file extension.<br /> It is
 * possible to put a link on the image.<br /> Remark: if an image is used
 * several times, only one copy will be embedded in the file.<br />
 *
 * @param $file (string) Name of the file containing the image or a '@'
 *            character followed by the image data string. To link an image
 *            without embedding it on the document, set an asterisk character
 ...
 *            JPEG and PNG (whitout GD library) and all images supported by GD:
 *            GD, GD2, GD2PART, GIF, JPEG, PNG, BMP, XBM, XPM;. If not
 ...
 *            insertion relative to image height. The value can be:<ul><li>T:
 *            top-right for LTR or top-left for RTL</li><li>M: middle-right for
 *            LTR or middle-left for RTL</li><li>B: bottom-right for LTR or
 *            bottom-left for RTL</li><li>N: next line</li></ul>
 * @param $resize (mixed) If true resize (reduce) the image to fit $w and $h
 *            (requires GD or ImageMagick library); if false do not resize; if 2
 *            force resize in all cases (upscaling and downscaling).
 ...
 *            line. Possible values are:<ul><li>L : left align</li><li>C :
 *            center</li><li>R : right align</li><li>'' : empty string : left
 *            for LTR or right for RTL</li></ul>
 ...
 *            fit within the ($w, $h) box. $fitbox can be true or a 2 characters
 *            string indicating the image alignment inside the box. The first
 *            character indicate the horizontal alignment (L = left, C = center,
 *            R = right) the second character indicate the vertical algnment (T
 *            = top, M = middle, B = bottom).
 ...
 * @param $altimgs (array) Array of alternate images IDs. Each alternative image
 *            must be an array with two values: an integer representing the
 *            image ID (the value returned by the Image method) and a boolean
 *            value to indicate if the image is the default for printing.
 * @return image information @public
 * @since 1.1
 */
public function Image($file, $x = '', $y = '', $w = 0, $h = 0, $type = '', $link = '', 
$align = '', $resize = false, $dpi = 300, $palign = '', $ismask = false, $imgmask = false, $border = 0, 
$fitbox = false, $hidden = false, $fitonpage = false, $alt = false, $altimgs = array()) {
if ($this->state != 2) {
return;
}
if (strcmp($x, '') === 0) {
...
$pw = $this->getHTMLUnitToUnits($w, 0, $this->pdfunit, true) * $this->imgscale *
     $this->k;
$ph = $this->getHTMLUnitToUnits($h, 0, $this->pdfunit, true) * $this->imgscale *
     $this->k;
$imsize = array(
    $pw, 
    $ph);
...
if ((($oldsize < $newsize) and ($resize)) or
     (($oldsize < $pixsize) and (! $resize))) {
    $newimage = true;
}
}
} elseif (($ismask === false) and ($imgmask === false) and
 (strpos($file, '__tcpdf_' . $this->file_id . '_imgmask_') === FALSE)) {
// create temp image file (without alpha channel)
$tempfile_plain = K_PATH_CACHE . '__tcpdf_' . $this->file_id . '_imgmask_plain_' .
 $filehash;
...
$newimage = false;
// embed mask image
$imgmask = $this->Image($tempfile_alpha, $x, $y, $w, $h, 'PNG', '', '', $resize, 
    $dpi, '', true, false);
// embed image, masked with previously embedded mask
return $this->Image($tempfile_plain, $x, $y, $w, $h, $type, $link, $align, 
    $resize, $dpi, $palign, false, $imgmask);
}
}
}
if ($newimage) {
...
$info = false;
if ((method_exists('TCPDF_IMAGES', $mtd)) and
 (! ($resize and (function_exists($gdfunction) or extension_loaded('imagick'))))) {
// TCPDF image functions
$info = TCPDF_IMAGES::$mtd($file);
if (($ismask === false) and ($imgmask === false) and
 (strpos($file, '__tcpdf_' . $this->file_id . '_imgmask_') === FALSE) and
 (($info === 'pngalpha') or (isset($info['trns']) and ! empty($info['trns'])))) {
return $this->ImagePngAlpha($file, $x, $y, $pixw, $pixh, $w, $h, 'PNG', $link, 
    $align, $resize, $dpi, $palign, $filehash);
}
}
...
if ($img !== false) {
    ...
    if (($type == 'gif') or ($type == 'png')) {
        $info = TCPDF_IMAGES::_toPNG($img, 
            TCPDF_STATIC::getObjFilename('img', $this->file_id));
    } else {
    ...
    if ($svgimg !== FALSE) {
        ...
        if (preg_match('/<svg([^\>]*)>/si', $svgimg, $regs)) {
            ...
            if (preg_match('/[\s]+width[\s]*=[\s]*"([^"]*)"/si', $svgtag, $tmp)) {
                $ow = $this->getHTMLUnitToUnits($tmp[1], 1, $this->svgunit, 
                    false);
                $owu = sprintf('%F', ($ow * $dpi / 72)) . $this->pdfunit;
                $svgtag = preg_replace('/[\s]+width[\s]*=[\s]*"[^"]*"/si', 
                    ' width="' . $owu . '"', $svgtag, 1);
            } else {
                $ow = $w;
            }
            ...
            if (preg_match('/[\s]+height[\s]*=[\s]*"([^"]*)"/si', $svgtag, $tmp)) {
                $oh = $this->getHTMLUnitToUnits($tmp[1], 1, $this->svgunit, 
                    false);
                $ohu = sprintf('%F', ($oh * $dpi / 72)) . $this->pdfunit;
                $svgtag = preg_replace('/[\s]+height[\s]*=[\s]*"[^"]*"/si', 
                    ' height="' . $ohu . '"', $svgtag, 1);
            } else {
                $oh = $h;
            }
            ...
            $svgimg = preg_replace('/<svg([^\>]*)>/si', '<svg' . $svgtag . '>', 
                $svgimg, 1);
        }
...
$this->_out(
sprintf('q %F 0 0 %F %F %F cm /I%u Do Q', ($w * $this->k), ($h * $this->k), 
$xkimg, (($this->h - ($y + $h)) * $this->k), $info['i']));
}
if (! empty($border)) {
$bx = $this->x;
$by = $this->y;
...
/**
 * Extract info from a PNG image with alpha channel using the Imagick or GD
 * library.
 *
 ...
 *            LTR or middle-left for RTL</li><li>B: bottom-right for LTR or
 *            bottom-left for RTL</li><li>N: next line</li></ul>
 * @param $resize (boolean) If true resize (reduce) the image to fit $w and $h
 *            (requires GD library).
 * @param $dpi (int) dot-per-inch resolution used on resize
 * @param $palign (string) Allows to center or align the image on the current
 *            line. Possible values are:<ul><li>L : left align</li><li>C :
 ...
 * @see Image()
 */
protected function ImagePngAlpha($file, $x, $y, $wpx, $hpx, $w, $h, $type, $link, 
$align, $resize, $dpi, $palign, $filehash = '') {
// create temp images
if (empty($filehash)) {
$filehash = md5($file);
...
if (method_exists($img, 'setImageAlphaChannel') and
 defined('Imagick::ALPHACHANNEL_EXTRACT')) {
$img->setImageAlphaChannel(Imagick::ALPHACHANNEL_EXTRACT);
} else {
$img->separateImageChannel(8); // 8 = (imagick::CHANNEL_ALPHA |
...
$imga->separateImageChannel(39); // 39 = (imagick::CHANNEL_ALL &
...
$dpi, '', true, false);
// embed image, masked with previously embedded mask
$this->Image($tempfile_plain, $x, $y, $w, $h, $type, $link, $align, $resize, 
$dpi, $palign, false, $imgmask);
}
 ...
 * @param $c (int) alpha color @protected
 * @since 4.3.007 (2008-12-04)
 */
...
// correct gamma
$this->gdgammacache['#' . $c] = (pow(($this->gdgammacache['#' . $c] / 255), 2.2) *
 255);
 ...
 *            padding to the X coordinate @public
 * @since 1.0
 * @see Cell()
 */
public function Ln($h = '', $cell = false) {
if (($this->num_columns > 1) and
 ($this->y == $this->columns[$this->current_column]['y']) and
 isset($this->columns[$this->current_column]['x']) and
 ($this->x == $this->columns[$this->current_column]['x'])) {
...
/**
 * Returns the relative X value of current position. The value is relative to
 * the left border for LTR languages and to the right border for RTL languages.
 *
 * @return float @public
 * @since 1.2
 * @see SetX(), GetY(), SetY()
 ...
 * negative, it is relative to the right of the page (or left if language is
 * RTL).
 *
 ...
 *
 * @param $x (float) The value of the abscissa in user units. @public
 * @since 5.9.186 (2012-09-13)
 ...
 *
 * @param $y (float) (float) The value of the ordinate in user units. @public
 * @since 5.9.186 (2012-09-13)
 * @see setAbsX(), setAbsY(), SetAbsXY()
 */
...
/**
 * Send the document to a given destination: string, local file or browser. In
 * the last case, the plug-in may be used (if present) or a download ("Save as"
 * dialog box) may be forced.<br /> The method first calls Close() if necessary
 * to terminate the document.
 *
 * @param $name (string) The name of the file when saved. Note that special
 *            characters are removed and blanks characters are replaced with the
 *            underscore character.
 * @param $dest (string) Destination where to send the document. It can take one
 *            of the following values:<ul><li>I: send the file inline to the
 *            browser (default). The plug-in is used if available. The name
 *            given by name is used when one selects the "Save as" option on the
 *            link generating the PDF.</li><li>D: send to the browser and force
 *            a file download with the name given by name.</li><li>F: save to a
 *            local server file with the name given by name.</li><li>S: return
 *            the document as a string (name is ignored).</li><li>FI: equivalent
 *            to F + I option</li><li>FD: equivalent to F + D option</li><li>E:
 *            return the document as base64 mime multi-part email attachment
 *            (RFC 2045)</li></ul>
...
array(
    ...
    $this->signature_data['password']), array(), PKCS7_BINARY | PKCS7_DETACHED);
} else {
openssl_pkcs7_sign($tempdoc, $tempsign, $this->signature_data['signcert'], 
array(
    $this->signature_data['privkey'], 
...
if ((! $preserve_objcopy or ($val != 'objcopy')) and ($val != 'file_id') and
 isset($this->$val)) {
unset($this->$val);
}
}
 ...
 * @return array of page number aliases @protected
 */
...
if ($this->isunicode) {
$alias['u'][] = TCPDF_STATIC::_escape(
TCPDF_FONTS::UTF8ToLatin1($u, $this->isunicode, $this->CurrentFont));
$alias['u'][] = TCPDF_STATIC::_escape(
TCPDF_FONTS::utf8StrRev($u, false, $this->tmprtl, $this->isunicode, 
$this->CurrentFont));
$alias['a'][] = TCPDF_STATIC::_escape(
TCPDF_FONTS::UTF8ToLatin1($a, $this->isunicode, $this->CurrentFont));
$alias['a'][] = TCPDF_STATIC::_escape(
TCPDF_FONTS::utf8StrRev($a, false, $this->tmprtl, $this->isunicode, 
$this->CurrentFont));
}
...
/**
 * Replace right shift page number aliases with spaces to correct right
 * alignment. This works perfectly only when using monospaced fonts.
 *
 * @param $page (string) Page content.
 * @param $aliases (array) Array of page aliases.
 * @param $diff (int) initial difference to add.
 * @return replaced page content. @protected
 */
...
if ($type == 'u') {
    ...
    $shift = TCPDF_FONTS::UTF8ToUTF16BE($shift, false, $this->isunicode, 
        $this->CurrentFont);
} else {
 ...
 *
 * @param $boxes (array) Array of page boxes to set on document: ('MediaBox',
 *            'CropBox', 'BleedBox', 'TrimBox', 'ArtBox'). @protected
 */
...
/**
 * Output pages (and replace page number aliases). @protected
 */
...
$ptpa = TCPDF_STATIC::formatPageNumber(
($this->starting_page_number + $num_pages - 1));
$ptpu = TCPDF_FONTS::UTF8ToUTF16BE($ptpa, false, $this->isunicode, 
$this->CurrentFont);
...
$pnpu = TCPDF_FONTS::UTF8ToUTF16BE($pnpa, false, $this->isunicode, 
$this->CurrentFont);
...
$ptgu = TCPDF_FONTS::UTF8ToUTF16BE($ptga, false, $this->isunicode, 
    $this->CurrentFont);
$ptg_num_chars = $this->GetNumChars($ptga);
}
++ $pagegroupnum;
$pnga = TCPDF_STATIC::formatPageNumber($pagegroupnum);
$pngu = TCPDF_FONTS::UTF8ToUTF16BE($pnga, false, $this->isunicode, 
$this->CurrentFont);
...
7, 
$pnalias[3]['a']);
list ($temppage, $gdiff) = TCPDF_STATIC::replacePageNumAliases($temppage, 
$replace, $gdiff);
}
// replace page numbers
$replace = array();
...
7, 
$pnalias[1]['a']);
list ($temppage, $pdiff) = TCPDF_STATIC::replacePageNumAliases($temppage, 
$replace, $pdiff);
// replace right shift alias
$temppage = $this->replaceRightShiftPageNumAliases($temppage, $pnalias[4], 
max($pdiff, $gdiff));
// replace EPS marker
...
$out .= ' /Type /Page';
$out .= ' /Parent 1 0 R';
if (empty($this->signature_data['approval']) or
 ($this->signature_data['approval'] != 'A')) {
$out .= ' /LastModified ' .
 $this->_datestring(0, $this->doc_modification_timestamp);
}
$out .= ' /Resources 2 0 R';
foreach ($this->page_boxes as $box) {
$out .= ' /' . $box;
$out .= sprintf(' [%F %F %F %F]', $this->pagedim[$n][$box]['llx'], 
$this->pagedim[$n][$box]['lly'], $this->pagedim[$n][$box]['urx'], 
$this->pagedim[$n][$box]['ury']);
}
if (isset($this->pagedim[$n]['BoxColorInfo']) and
 ! empty($this->pagedim[$n]['BoxColorInfo'])) {
$out .= ' /BoxColorInfo <<';
foreach ($this->page_boxes as $box) {
...
if (isset($this->pagedim[$n]['BoxColorInfo'][$box]['C'])) {
    ...
    $out .= ' /C [';
    $out .= sprintf(' %F %F %F', ($color[0] / 255), ($color[1] / 255), 
        ($color[2] / 255));
    $out .= ' ]';
}
...
if ($this->sign and ($n == $this->signature_appearance['page']) and
 isset($this->signature_data['cert_type'])) {
...
/**
 * Output annotations objects for all pages. !!! THIS METHOD IS NOT YET
 * COMPLETED !!! See section 12.5 of PDF 32000_2008 reference. @protected
 *
 * @author Nicola Asuni
 * @since 4.0.018 (2008-08-06)
 */
...
if (isset($this->radiobutton_groups[$n][$pl['txt']]) and
 is_array($this->radiobutton_groups[$n][$pl['txt']])) {
...
if (isset($pl['opt']['tu']) and is_string($pl['opt']['tu'])) {
    $annots .= ' /TU ' .
         $this->_datastring($pl['opt']['tu'], $radio_button_obj_id);
}
$annots .= ' /FT /Btn';
$annots .= ' /Kids [';
$defval = '';
...
$annots .= ' >>';
$this->_out(
    $this->_getobj($radio_button_obj_id) . "\n" . $annots . "\n" . 'endobj');
...
$annots .= ' /NM ' .
 $this->_datastring(sprintf('%04u-%04u', $n, $key), $annot_obj_id);
$annots .= ' /M ' .
 $this->_datestring($annot_obj_id, $this->doc_modification_timestamp);
if (isset($pl['opt']['f'])) {
$fval = 0;
    ...
    foreach ($pl['opt']['ap'] as $apmode => $apdef) {
        ...
        if (is_array($apdef)) {
            ...
            foreach ($apdef as $apstate => $stream) {
                // reference to XObject that define the appearance for this
                // mode-state
...
if (isset($pl['opt']['be']['i']) and ($pl['opt']['be']['i'] >= 0) and
     ($pl['opt']['be']['i'] <= 2)) {
    $annots .= ' /I ' . sprintf(' %F', $pl['opt']['be']['i']);
}
$annots .= '>>';
}
if (isset($pl['opt']['c']) and (is_array($pl['opt']['c'])) and
 ! empty($pl['opt']['c'])) {
...
$annots .= ' /CreationDate ' .
     $this->_datestring($annot_obj_id, $this->doc_creation_timestamp);
// $annots .= ' /IRT ';
...
case 'text':
    {
        if (isset($pl['opt']['open'])) {
            $annots .= ' /Open ' .
                 (strtolower($pl['opt']['open']) == 'true' ? 'true' : 'false');
        }
        $iconsapp = array(
            'Comment', 
            'Help', 
            ...
            'Note', 
            'Paragraph');
        if (isset($pl['opt']['name']) and in_array($pl['opt']['name'], 
            $iconsapp)) {
        ...
        $statemodels = array(
            'Marked', 
            'Review');
        if (isset($pl['opt']['statemodel']) and
             in_array($pl['opt']['statemodel'], $statemodels)) {
        ...
        if (isset($pl['opt']['state']) and in_array($pl['opt']['state'], 
            $states)) {
...
case 'link':
    {
        if (is_string($pl['txt'])) {
            if ($pl['txt'][0] == '#') {
                ...
                $annots .= ' /Dest /' .
                     TCPDF_STATIC::encodeNameObject(substr($pl['txt'], 1));
            } elseif ($pl['txt'][0] == '%') {
                // embedded PDF file
                $filename = basename(substr($pl['txt'], 1));
                $annots .= ' /A << /S /GoToE /D [0 /Fit] /NewWindow true /T << /R /C /P ' .
                     ($n - 1) . ' /A ' . $this->embeddedfiles[$filename]['a'] .
                     ' >> >>';
            } elseif ($pl['txt'][0] == '*') {
                ...
                $annots .= ' /A << /S /JavaScript /JS ' .
                     $this->_textstring($jsa, $annot_obj_id) . '>>';
            } else {
                $parsedUrl = parse_url($pl['txt']);
                if (empty($parsedUrl['scheme']) and
                    ...
                    $annots .= ' /A <</S /GoToR /D ' . $dest . ' /F ' . $this->_datastring(
                        $this->unhtmlentities($parsedUrl['path']), $annot_obj_id) .
                         ' /NewWindow true>>';
                } else {
                    // external URI link
                    $annots .= ' /A <</S /URI /URI ' . $this->_datastring(
                        $this->unhtmlentities($pl['txt']), $annot_obj_id) . '>>';
                }
            }
            ...
            if (isset($this->page_obj_id[($l['p'])])) {
                $annots .= sprintf(' /Dest [%u 0 R /XYZ 0 %F null]', 
                    $this->page_obj_id[($l['p'])], 
                    ($this->pagedim[$l['p']]['h'] - ($l['y'] * $this->k)));
            }
        }
        $hmodes = array(
            'N', 
...
case 'freetext':
    {
        ...
        if (isset($pl['opt']['q']) and ($pl['opt']['q'] >= 0) and
             ($pl['opt']['q'] <= 2)) {
            $annots .= ' /Q ' . intval($pl['opt']['q']);
        }
        if (isset($pl['opt']['rc'])) {
            $annots .= ' /RC ' .
                 $this->_textstring($pl['opt']['rc'], $annot_obj_id);
        }
        if (isset($pl['opt']['ds'])) {
            $annots .= ' /DS ' .
                 $this->_textstring($pl['opt']['ds'], $annot_obj_id);
        }
...
case 'fileattachment':
    {
        ...
        if (isset($this->embeddedfiles[$filename]['f'])) {
            ...
            $iconsapp = array(
                ...
                'PushPin', 
                'Tag');
            if (isset($pl['opt']['name']) and
                 in_array($pl['opt']['name'], $iconsapp)) {
                $annots .= ' /Name /' . $pl['opt']['name'];
            } else {
                $annots .= ' /Name /PushPin';
            }
            // index (zero-based) of the annotation in the Annots array of this
            // page
...
case 'widget':
    {
        ...
        if (isset($pl['opt']['mk']) and (is_array($pl['opt']['mk'])) and
             ! empty($pl['opt']['mk'])) {
            $annots .= ' /MK <<';
            if (isset($pl['opt']['mk']['r'])) {
                $annots .= ' /R ' . $pl['opt']['mk']['r'];
            }
            if (isset($pl['opt']['mk']['bc']) and
                 (is_array($pl['opt']['mk']['bc']))) {
                $annots .= ' /BC ' .
                 TCPDF_COLORS::getColorStringFromArray($pl['opt']['mk']['bc']);
        }
        if (isset($pl['opt']['mk']['bg']) and (is_array($pl['opt']['mk']['bg']))) {
            $annots .= ' /BG ' .
                 TCPDF_COLORS::getColorStringFromArray($pl['opt']['mk']['bg']);
        }
        ...
        if (isset($pl['opt']['mk']['if']) and (is_array($pl['opt']['mk']['if'])) and
            ...
            $if_sw = array(
                ...
                'S', 
                'N');
            if (isset($pl['opt']['mk']['if']['sw']) and
                 in_array($pl['opt']['mk']['if']['sw'], $if_sw)) {
                $annots .= ' /SW /' . $pl['opt']['mk']['if']['sw'];
            }
            $if_s = array(
                'A', 
                'P');
            if (isset($pl['opt']['mk']['if']['s']) and
                 in_array($pl['opt']['mk']['if']['s'], $if_s)) {
                $annots .= ' /S /' . $pl['opt']['mk']['if']['s'];
            }
            if (isset($pl['opt']['mk']['if']['a']) and
                 (is_array($pl['opt']['mk']['if']['a'])) and
                 ! empty($pl['opt']['mk']['if']['a'])) {
                $annots .= sprintf(' /A [%F %F]', 
                    $pl['opt']['mk']['if']['a'][0], 
                    $pl['opt']['mk']['if']['a'][1]);
            }
            if (isset($pl['opt']['mk']['if']['fb']) and
                 ($pl['opt']['mk']['if']['fb'])) {
                $annots .= ' /FB true';
            }
            $annots .= '>>';
    ...
    if (isset($this->radiobutton_groups[$n][$pl['txt']])) {
        // set parent
        $annots .= ' /Parent ' . $this->radiobutton_groups[$n][$pl['txt']] .
             ' 0 R';
    }
    if (isset($pl['opt']['t']) and is_string($pl['opt']['t'])) {
    ...
    if (isset($pl['opt']['opt']) and (is_array($pl['opt']['opt'])) and
        ...
        foreach ($pl['opt']['opt'] as $copt) {
            if (is_array($copt)) {
                $annots .= ' [' . $this->_textstring($copt[0], $annot_obj_id) .
    ...
    if (isset($pl['opt']['i']) and (is_array($pl['opt']['i'])) and
         ! empty($pl['opt']['i'])) {
        $annots .= ' /I [';
 ...
 * @return int object ID @protected
 * @since 4.8.001 (2009-09-09)
 */
...
} elseif ($info['subset'] and
 ((! $compressed) or ($compressed and function_exists('gzcompress')))) {
if ($compressed) {
// uncompress font
 ...
 *
 * @param $font (array) font data @protected
 * @author Nicola Asuni
...
$stream = $this->_getrawstream($stream);
$this->_out(
'<<' . $filter . '/Length ' . strlen($stream) . '>> stream' . "\n" . $stream .
 "\n" . 'endstream' . "\n" . 'endobj');
// CIDFontType2
...
$cidinfo .= ' /Ordering ' .
 $this->_datastring($font['cidinfo']['Ordering'], $oid);
...
$this->_out($out);
// Font descriptor
// A font descriptor describing the CIDFont default metrics other than its glyph
// widths
$this->_newobj();
...
if (substr($fontfile, - 2) == '.z') { // check file extension
                                      // Decompresses data encoded using the
                                      // public-domain
...
/**
 * Output CID-0 fonts. A Type 0 CIDFont contains glyph descriptions based on the
...
if ((! $this->pdfa_mode) and isset($info['altimgs']) and
 ! empty($info['altimgs'])) {
$altoid = $this->_newobj();
$out = '[';
...
$out .= ' /ColorSpace [/Indexed /DeviceRGB ' . ((strlen($info['pal']) / 3) - 1) .
 ' ' . ($this->n + 1) . ' 0 R]';
} else {
// Device Colour Space
...
$this->_out(
'<</N ' . $info['ch'] . ' /Alternate /' . $info['cs'] . ' ' . $filter .
 '/Length ' . strlen($icc) . '>> stream' . "\n" . $icc . "\n" . 'endstream' .
 "\n" . 'endobj');
} elseif ($info['cs'] == 'Indexed') {
// colour palette
$this->_newobj();
...
$this->_out(
'<<' . $filter . '/Length ' . strlen($pal) . '>> stream' . "\n" . $pal . "\n" .
 'endstream' . "\n" . 'endobj');
}
}
}
 ...
 *
 * @author Nicola Asuni
 * @since 5.8.017 (2010-08-24) @protected
...
$out .= sprintf(' /BBox [%F %F %F %F]', ($data['x'] * $this->k), 
(- $data['y'] * $this->k), (($data['w'] + $data['x']) * $this->k), 
...
/**
 * Output Spot Colors Resources. @protected
 *
 * @since 4.0.024 (2008-09-12)
 */
...
$out .= ' ' . sprintf('/C1 [%F %F %F %F] ', ($color['C'] / 100), 
($color['M'] / 100), ($color['Y'] / 100), ($color['K'] / 100));
 ...
 *
 * @return string XObjects dictionary @protected
 * @since 5.8.014 (2010-08-23)
 */
...
/**
 * Output Resources Dictionary. @protected
 */
...
/**
 * Adds some Metadata information (Document Information Dictionary) (see Chapter
 * 14.3.3 Document Information Dictionary of PDF32000_2008.pdf Reference)
 *
 * @return int object id @protected
 */
...
// default producer
$out .= ' /Producer ' .
 $this->_textstring(TCPDF_STATIC::getTCPDFProducer(), $oid);
// The date and time the document was created, in human-readable form
$out .= ' /CreationDate ' . $this->_datestring(0, $this->doc_creation_timestamp);
// The date and time the document was most recently modified, in human-readable
// form
 ...
 * end of "x:xmpmeta" tag. IMPORTANT: This data is added as-is without controls,
 * so you have to validate your data before using this method!
 *
 * @param $xmp (string) Custom XMP data.
 * @since 5.9.128 (2011-10-06) @public
 */
 ...
 * @since 5.9.121 (2011-09-28) @protected
 */
...
$this->encrypted = false;
// set XMP data
$xmp = '<?xpacket begin="' . TCPDF_FONTS::unichr(0xfeff, $this->isunicode) .
...
$xmp .= "\t\t\t\t\t" . '<rdf:li xml:lang="x-default">' .
 TCPDF_STATIC::_escapeXML($this->title) . '</rdf:li>' . "\n";
$xmp .= "\t\t\t\t" . '</rdf:Alt>' . "\n";
$xmp .= "\t\t\t" . '</dc:title>' . "\n";
$xmp .= "\t\t\t" . '<dc:creator>' . "\n";
$xmp .= "\t\t\t\t" . '<rdf:Seq>' . "\n";
$xmp .= "\t\t\t\t\t" . '<rdf:li>' . TCPDF_STATIC::_escapeXML($this->author) .
 '</rdf:li>' . "\n";
$xmp .= "\t\t\t\t" . '</rdf:Seq>' . "\n";
$xmp .= "\t\t\t" . '</dc:creator>' . "\n";
$xmp .= "\t\t\t" . '<dc:description>' . "\n";
$xmp .= "\t\t\t\t" . '<rdf:Alt>' . "\n";
$xmp .= "\t\t\t\t\t" . '<rdf:li xml:lang="x-default">' .
 TCPDF_STATIC::_escapeXML($this->subject) . '</rdf:li>' . "\n";
$xmp .= "\t\t\t\t" . '</rdf:Alt>' . "\n";
$xmp .= "\t\t\t" . '</dc:description>' . "\n";
$xmp .= "\t\t\t" . '<dc:subject>' . "\n";
$xmp .= "\t\t\t\t" . '<rdf:Bag>' . "\n";
$xmp .= "\t\t\t\t\t" . '<rdf:li>' . TCPDF_STATIC::_escapeXML($this->keywords) .
 '</rdf:li>' . "\n";
$xmp .= "\t\t\t\t" . '</rdf:Bag>' . "\n";
$xmp .= "\t\t\t" . '</dc:subject>' . "\n";
$xmp .= "\t\t" . '</rdf:Description>' . "\n";
...
$doccreationdate = substr($dcdate, 0, 4) . '-' . substr($dcdate, 4, 2) . '-' .
 substr($dcdate, 6, 2);
$doccreationdate .= 'T' . substr($dcdate, 8, 2) . ':' . substr($dcdate, 10, 2) .
 ':' . substr($dcdate, 12, 2);
...
$docmoddate = substr($dmdate, 0, 4) . '-' . substr($dmdate, 4, 2) . '-' .
 substr($dmdate, 6, 2);
$docmoddate .= 'T' . substr($dmdate, 8, 2) . ':' . substr($dmdate, 10, 2) . ':' .
 substr($dmdate, 12, 2);
...
$xmp .= "\t\t\t" . '<xmp:MetadataDate>' . $doccreationdate .
 '</xmp:MetadataDate>' . "\n";
$xmp .= "\t\t" . '</rdf:Description>' . "\n";
$xmp .= "\t\t" .
 '<rdf:Description rdf:about="" xmlns:pdf="http://ns.adobe.com/pdf/1.3/">' . "\n";
$xmp .= "\t\t\t" . '<pdf:Keywords>' . TCPDF_STATIC::_escapeXML($this->keywords) .
 '</pdf:Keywords>' . "\n";
$xmp .= "\t\t\t" . '<pdf:Producer>' .
 TCPDF_STATIC::_escapeXML(TCPDF_STATIC::getTCPDFProducer()) . '</pdf:Producer>' .
 "\n";
$xmp .= "\t\t" . '</rdf:Description>' . "\n";
$xmp .= "\t\t" .
 '<rdf:Description rdf:about="" xmlns:xmpMM="http://ns.adobe.com/xap/1.0/mm/">' .
 "\n";
$uuid = 'uuid:' . substr($this->file_id, 0, 8) . '-' .
 substr($this->file_id, 8, 4) . '-' . substr($this->file_id, 12, 4) . '-' .
 substr($this->file_id, 16, 4) . '-' . substr($this->file_id, 20, 12);
...
$icc = $this->_getrawstream($icc);
$this->_out(
'<</N 3 ' . $filter . '/Length ' . strlen($icc) . '>> stream' . "\n" . $icc .
 "\n" . 'endstream' . "\n" . 'endobj');
}
// start catalog
$oid = $this->_newobj();
...
if (isset($this->LayoutMode) and
 (! TCPDF_STATIC::empty_string($this->LayoutMode))) {
...
$out .= sprintf(
' /OpenAction [' . $this->page_obj_id[1] . ' 0 R /XYZ null null %F]', 
($this->ZoomMode / 100));
}
// $out .= ' /AA <<>>';
// $out .= ' /URI <<>>';
...
$out .= ' /OutputConditionIdentifier ' .
 $this->_textstring('sRGB IEC61966-2.1', $oid);
...
// AcroForm
if (! empty($this->form_obj_id) or
 ($this->sign and isset($this->signature_data['cert_type'])) or
...
$out .= ' /Fields [' . $objrefs . ']';
// It's better to turn off this value and set the appearance stream for each
// annotation (/AP) to avoid conflicts with signature fields.
if (empty($this->signature_data['approval']) or
 ($this->signature_data['approval'] != 'A')) {
...
$out .= ' >>';
// signatures
if ($this->sign and isset($this->signature_data['cert_type']) and (empty(
$this->signature_data['approval']) or ($this->signature_data['approval'] != 'A'))) {
if ($this->signature_data['cert_type'] > 0) {
 ...
 * @author Nicola asuni
 * @since 3.1.000 (2008-06-09) @protected
 */
...
/**
 * Output PDF File Header (7.5.2). @protected
 */
...
/**
 * Output end of document (EOF). @protected
 */
...
$out .= ' /Subtype /Widget';
$out .= ' /Rect [' . $esa['rect'] . ']';
$out .= ' /P ' . $this->page_obj_id[($esa['page'])] . ' 0 R'; // link to
                                                              // signature
                                                              // appearance page
$out .= ' /F 4';
$out .= ' /FT /Sig';
...
$out .= ' /P ' . $this->page_obj_id[($this->signature_appearance['page'])] .
 ' 0 R'; // link
        // to
        // signature
        // appearance
...
$out .= ' /FT /Sig';
$out .= ' /T ' .
 $this->_textstring($this->signature_appearance['name'], $this->sig_obj_id);
$out .= ' /Ff 0';
 ...
 * @param $format (mixed) The format used for pages. It can be either: one of
 *            the string values specified at getPageSizeFromFormat() or an array
 *            of parameters specified at setPageFormat(). @protected
 * @see getPageSizeFromFormat(), setPageFormat()
 */
 ...
 *
 * @return int object number @protected
 */
 ...
 * @return string the starting object string @protected
 ...
 * @param $txt (string) text to underline @protected
 */
 ...
 * @param $x (int) X coordinate
 * @param $y (int) Y coordinate
 * @param $w (int) width to underline @protected
 * @since 4.8.008 (2009-09-29)
 */
protected function _dounderlinew($x, $y, $w) {
$linew = - $this->CurrentFont['ut'] / 1000 * $this->FontSizePt;
return sprintf('%F %F %F %F re f', $x * $this->k, 
((($this->h - $y) * $this->k) + $linew), $w * $this->k, $linew);
}
 ...
 * @param $x (int) X coordinate
 * @param $y (int) Y coordinate
 * @param $txt (string) text to linethrough @protected
 */
 ...
 * @param $x (int) X coordinate
 * @param $y (int) Y coordinate
 * @param $w (int) line length (width) @protected
 * @since 4.9.008 (2009-09-29)
 */
protected function _dolinethroughw($x, $y, $w) {
$linew = - $this->CurrentFont['ut'] / 1000 * $this->FontSizePt;
return sprintf('%F %F %F %F re f', $x * $this->k, 
((($this->h - $y) * $this->k) + $linew + ($this->FontSizePt / 3)), $w * $this->k, 
$linew);
}
 ...
 * @param $x (int) X coordinate
 * @param $y (int) Y coordinate
 * @param $txt (string) text to overline @protected
 ...
 * @param $x (int) X coordinate
 * @param $y (int) Y coordinate
 * @param $w (int) width to overline @protected
 * @since 4.9.015 (2010-04-19)
 */
protected function _dooverlinew($x, $y, $w) {
$linew = - $this->CurrentFont['ut'] / 1000 * $this->FontSizePt;
return sprintf('%F %F %F %F re f', $x * $this->k, 
(($this->h - $y + $this->FontAscent) * $this->k) - $linew, $w * $this->k, $linew);
}
 ...
 * @return string escaped string. @protected
 */
 ...
 *
 * @return (int) Creation timestamp in seconds. @public
 * @since 5.9.152 (2012-03-23)
 */
 ...
 *
 * @return (int) Modfication timestamp in seconds. @public
 * @since 5.9.152 (2012-03-23)
 */
 ...
 * @return string escaped date string. @protected
 ...
 * @param $n (int) object reference for encryption mode @protected
 * @author Nicola Asuni
 ...
 *
 * @param $s (string) string to output. @protected
 */
...
} elseif ((! $this->InFooter) and isset($this->footerlen[$this->page]) and
 ...
 *
 * @param $px (int) pixels
 * @return float value in user's unit @public
 ...
 * @return string converted text string @public
 */
...
/**
 * Compute encryption key depending on object number where the encrypted data is
 * stored. This is used for all strings and streams without crypt filter
 * specifier.
 *
 * @param $n (int) object number
 * @return int object key @protected
 * @author Nicola Asuni
 * @since 2.0.000 (2008-01-02)
 */
...
$objkey = substr(TCPDF_STATIC::_md5_16($objkey), 0, 
(($this->encryptdata['Length'] / 8) + 5));
 ...
 * @return encrypted string @protected
 * @author Nicola Asuni
 * @since 5.0.005 (2010-05-11)
 */
...
case 1:
{ // RC4-128
$s = TCPDF_STATIC::_RC4($this->_objectkey($n), $s, $this->last_enc_key, 
$this->last_enc_key_c);
break;
}
case 2:
...
/**
 * Put encryption on PDF document. @protected
 *
 * @author Nicola Asuni
 * @since 2.0.000 (2008-01-02)
 */
...
if (isset($this->encryptdata['SubFilter']) and
 ! empty($this->encryptdata['SubFilter'])) {
$out .= ' /SubFilter /' . $this->encryptdata['SubFilter'];
}
if (! isset($this->encryptdata['V']) or empty($this->encryptdata['V'])) {
$this->encryptdata['V'] = 1;
}
// V is a code specifying the algorithm to be used in encrypting and decrypting
// the document
$out .= ' /V ' . $this->encryptdata['V'];
if (isset($this->encryptdata['Length']) and ! empty(
$this->encryptdata['Length'])) {
// The length of the encryption key, in bits. The value shall be a multiple of
// 8, in the range 40 to 256
...
// A dictionary whose keys shall be crypt filter names and whose values shall be
// the corresponding crypt filter dictionaries.
if (isset($this->encryptdata['CF']) and ! empty($this->encryptdata['CF'])) {
$out .= ' /CF <<';
$out .= ' /' . $this->encryptdata['StmF'] . ' <<';
$out .= ' /Type /CryptFilter';
if (isset($this->encryptdata['CF']['CFM']) and
 ! empty($this->encryptdata['CF']['CFM'])) {
// The method used
...
if (isset($this->encryptdata['CF']['AuthEvent']) and
 ! empty($this->encryptdata['CF']['AuthEvent'])) {
// The event to be used to trigger the authorization that is required to access
// encryption keys used by this filter.
$out .= ' /AuthEvent /' . $this->encryptdata['CF']['AuthEvent'];
} else {
$out .= ' /AuthEvent /DocOpen';
}
if (isset($this->encryptdata['CF']['Length']) and
 ! empty($this->encryptdata['CF']['Length'])) {
...
// The name of the crypt filter that shall be used when encrypting embedded file
// streams that do not have their own crypt filter specifier.
...
if (isset($this->encryptdata['EncryptMetadata']) and
 ...
 *
 * @return string U value @protected
 * @since 2.0.000 (2008-01-02)
 * @author Nicola Asuni
 */
protected function _Uvalue() {
if ($this->encryptdata['mode'] == 0) { // RC4-40
return TCPDF_STATIC::_RC4($this->encryptdata['key'], TCPDF_STATIC::$enc_padding, 
$this->last_enc_key, $this->last_enc_key_c);
} elseif ($this->encryptdata['mode'] < 3) { // RC4-128, AES-128
$tmp = TCPDF_STATIC::_md5_16(
TCPDF_STATIC::$enc_padding . $this->encryptdata['fileid']);
$enc = TCPDF_STATIC::_RC4($this->encryptdata['key'], $tmp, $this->last_enc_key, 
$this->last_enc_key_c);
$len = strlen($tmp);
for ($i = 1; $i <= 19; ++ $i) {
$ek = '';
...
return hash('sha256', 
$this->encryptdata['user_password'] . $this->encryptdata['UVS'], true) .
 ...
 *
 * @return string UE value @protected
 * @since 5.9.006 (2010-10-19)
 * @author Nicola Asuni
 */
protected function _UEvalue() {
$hashkey = hash('sha256', 
$this->encryptdata['user_password'] . $this->encryptdata['UKS'], true);
$iv = str_repeat("\x00", 
mcrypt_get_iv_size(MCRYPT_RIJNDAEL_128, MCRYPT_MODE_CBC));
return mcrypt_encrypt(MCRYPT_RIJNDAEL_128, $hashkey, $this->encryptdata['key'], 
MCRYPT_MODE_CBC, $iv);
}
 ...
 *
 * @return string O value @protected
 * @since 2.0.000 (2008-01-02)
 * @author Nicola Asuni
 */
...
$enc = TCPDF_STATIC::_RC4($owner_key, $this->encryptdata['user_password'], 
$this->last_enc_key, $this->last_enc_key_c);
if ($this->encryptdata['mode'] > 0) {
...
return hash('sha256', 
$this->encryptdata['owner_password'] . $this->encryptdata['OVS'] .
 $this->encryptdata['U'], true) . $this->encryptdata['OVS'] .
 ...
 *
 * @return string OE value @protected
 * @since 5.9.006 (2010-10-19)
 * @author Nicola Asuni
 */
protected function _OEvalue() {
$hashkey = hash('sha256', 
$this->encryptdata['owner_password'] . $this->encryptdata['OKS'] .
 $this->encryptdata['U'], true);
$iv = str_repeat("\x00", 
mcrypt_get_iv_size(MCRYPT_RIJNDAEL_128, MCRYPT_MODE_CBC));
return mcrypt_encrypt(MCRYPT_RIJNDAEL_128, $hashkey, $this->encryptdata['key'], 
MCRYPT_MODE_CBC, $iv);
 ...
 * @return string password @protected
 * @since 5.9.006 (2010-10-19)
 * @author Nicola Asuni
 */
protected function _fixAES256Password($password) {
$psw = ''; // password to be returned
$psw_array = TCPDF_FONTS::utf8Bidi(
TCPDF_FONTS::UTF8StringToArray($password, $this->isunicode, $this->CurrentFont), 
$password, $this->rtl, $this->isunicode, $this->CurrentFont);
...
hash('sha256', TCPDF_STATIC::getRandomSeed(), true), 0, $keybytelen);
// truncate passwords
$this->encryptdata['user_password'] = $this->_fixAES256Password(
$this->encryptdata['user_password']);
$this->encryptdata['owner_password'] = $this->_fixAES256Password(
...
$perms = TCPDF_STATIC::getEncPermissionsString($this->encryptdata['protection']); // bytes
                                                                                  // 0-3
$perms .= chr(255) . chr(255) . chr(255) . chr(255); // bytes 4-7
if (isset($this->encryptdata['CF']['EncryptMetadata']) and
 (! $this->encryptdata['CF']['EncryptMetadata'])) { // byte
                                                   // 8
$perms .= 'F';
} else {
$perms .= 'T';
...
$this->encryptdata['perms'] = mcrypt_encrypt(MCRYPT_RIJNDAEL_128, 
$this->encryptdata['key'], $perms, MCRYPT_MODE_ECB, $iv);
} else { // RC4-40, RC4-128, AES-128
         // Pad passwords
$this->encryptdata['user_password'] = substr(
$this->encryptdata['user_password'] . TCPDF_STATIC::$enc_padding, 0, 32);
$this->encryptdata['owner_password'] = substr(
$this->encryptdata['owner_password'] . TCPDF_STATIC::$enc_padding, 0, 32);
// Compute O value
$this->encryptdata['O'] = $this->_Ovalue();
// get default permissions (reverse byte order)
$permissions = TCPDF_STATIC::getEncPermissionsString(
$this->encryptdata['protection']);
// Compute encryption key
$tmp = TCPDF_STATIC::_md5_16(
$this->encryptdata['user_password'] . $this->encryptdata['O'] . $permissions .
...
if (isset($pubkey['p'])) {
$pkprotection = TCPDF_STATIC::getUserPermissionCode($pubkey['p'], 
$this->encryptdata['mode']);
} else {
...
// The bytes of each item in the Recipients array of PKCS#7 objects in the order
...
if ($this->encryptdata['mode'] == 3) { // AES-256
$this->encryptdata['key'] = substr(
hash('sha256', $seed . $recipient_bytes, true), 0, $keybytelen);
} else { // RC4-40, RC4-128, AES-128
$this->encryptdata['key'] = substr(sha1($seed . $recipient_bytes, true), 0, 
$keybytelen);
}
}
}
...
/**
 * Set document protection Remark: the protection against modification is for
 * people who have the full Acrobat product. If you don't set any password, the
 * document will open as usual. If you set a user password, the PDF viewer will
 * ask for it before displaying the document. The master password, if different
 * from the user one, can be used to get full access. Note: protecting a
 * document requires to encrypt it, which increases the processing time a lot.
 * This can cause a PHP time-out in some cases, especially if the document
 * contains images or fonts.
 *
 * @param $permissions (Array) the set of permissions (specify the ones you want
 *            to block):<ul><li>print : Print the document;</li><li>modify :
 *            Modify the contents of the document by operations other than those
 *            controlled by 'fill-forms', 'extract' and 'assemble';</li><li>copy
 *            : Copy or otherwise extract text and graphics from the
 *            document;</li><li>annot-forms : Add or modify text annotations,
 *            fill in interactive form fields, and, if 'modify' is also set,
 *            create or modify interactive form fields (including signature
 *            fields);</li><li>fill-forms : Fill in existing interactive form
 *            fields (including signature fields), even if 'annot-forms' is not
 *            specified;</li><li>extract : Extract text and graphics (in support
 *            of accessibility to users with disabilities or for other
 *            purposes);</li><li>assemble : Assemble the document (insert,
 *            rotate, or delete pages and create bookmarks or thumbnail images),
 *            even if 'modify' is not set;</li><li>print-high : Print the
 *            document to a representation from which a faithful digital copy of
 *            the PDF content could be generated. When this is not set, printing
 *            is limited to a low-level representation of the appearance,
 *            possibly of degraded quality.</li><li>owner : (inverted logic -
 *            only for public-key) when set permits change of encryption and
 *            enables all other permissions.</li></ul>
 ...
 *            certificates ('c') and permissions ('p'). For example:
 *            array(array('c' => 'file://../examples/data/cert/tcpdf.crt', 'p'
 *            => array('print'))) @public
 * @since 2.0.000 (2008-01-02)
 * @author Nicola Asuni
 */
public function SetProtection(
$permissions = array('print', 'modify', 'copy', 'annot-forms', 'fill-forms', 'extract', 'assemble', 'print-high'), $user_pass = '', $owner_pass = null, $mode = 0, $pubkeys = null) {
if ($this->pdfa_mode) {
// encryption is not allowed in PDF/A mode
return;
}
$this->encryptdata['protection'] = TCPDF_STATIC::getUserPermissionCode(
$permissions, $mode);
...
// Set Public-Key filter (available are: Entrust.PPKEF, Adobe.PPKLite,
// Adobe.PubSec)
...
// the Hash extension requires no external libraries and is enabled by default
// as of PHP 5.1.2.
$this->Error(
...
$this->encrypted = true;
$this->encryptdata['fileid'] = TCPDF_STATIC::convertHexStringToString(
$this->file_id);
...
/**
 * Starts a 2D tranformation saving current graphic state. This function must be
 * called before scaling, mirroring, translation, rotation and skewing. Use
 * StartTransform() before, and StopTransform() after the transformations to
 * restore the normal behavior. @public
 *
 * @since 2.1.000 (2008-01-07)
...
if ($this->inxobj) {
// we are inside an XObject template
$this->xobjects[$this->xobjid]['transfmrk'][] = strlen(
...
/**
 * Stops a 2D tranformation restoring previous graphic state. This function must
 * be called after scaling, mirroring, translation, rotation and skewing. Use
 * StartTransform() before, and StopTransform() after the transformations to
 * restore the normal behavior. @public
 *
 * @since 2.1.000 (2008-01-07)
 ...
 *
 * @param $x (int) abscissa of the point. Default is current x position @public
 * @since 2.1.000 (2008-01-07)
 * @see StartTransform(), StopTransform()
 */
 ...
 * Verical Mirroring.
 *
 * @param $y (int) ordinate of the point. Default is current y position @public
 * @since 2.1.000 (2008-01-07)
 * @see StartTransform(), StopTransform()
 */
 ...
 *
 * @param $t_x (int) movement to the right (or left for RTL) @public
 * @since 2.1.000 (2008-01-07)
 * @see StartTransform(), StopTransform()
 */
 ...
 *
 * @param $t_y (int) movement to the bottom @public
 * @since 2.1.000 (2008-01-07)
 * @see StartTransform(), StopTransform()
 */
 ...
 * Skew vertically.
 *
 * @param $angle_y (float) angle in degrees between -90 (skew to the bottom) and
 *            90 (skew to the top)
 * @param $x (int) abscissa of the skewing center. default is current x position
 * @param $y (int) ordinate of the skewing center. default is current y position
 *            @public
...
if (($angle_x <= - 90) or ($angle_x >= 90) or ($angle_y <= - 90) or
 ($angle_y >= 90)) {
 ...
 *
 * @param $tm (array) transformation matrix @protected
 * @since 2.1.000 (2008-01-07)
 * @see StartTransform(), StopTransform()
 */
...
$this->_out(
sprintf('%F %F %F %F %F %F cm', $tm[0], $tm[1], $tm[2], $tm[3], $tm[4], $tm[5]));
...
$this->xobjects[$this->xobjid]['transfmrk'][$key] = strlen(
$this->xobjects[$this->xobjid]['outdata']);
}
 ...
 * page to page.
 *
 * @param $width (float) The width. @public
 * @since 1.0
 ...
 * Set line style.
 *
 * @param $style (array) Line style. Array with keys among the following: <ul>
 *            <li>width (float): Width of the line in user units.</li> <li>cap
 *            (string): Type of cap to put on the line. Possible values are:
 *            butt, round, square. The difference between "square" and "butt" is
 *            that "square" projects a flat end past the end of the line.</li>
 *            <li>join (string): Type of join. Possible values are: miter,
 *            round, bevel.</li> <li>dash (mixed): Dash pattern. Is 0 (without
 *            dash) or string with series of length values, which are the
 *            lengths of the on and off dashes. For example: "2" represents 2
 *            on, 2 off, 2 on, 2 off, ...; "2,1" is 2 on, 1 off, 2 on, 1 off,
 *            ...</li> <li>phase (integer): Modifier on the dash pattern which
 *            is used to shift the point at which the pattern starts.</li>
 *            <li>color (array): Draw color. Format: array(GREY) or array(R,G,B)
 *            or array(C,M,Y,K) or array(C,M,Y,K,SpotColorName).</li> </ul>
 * @param $ret (boolean) if true do not send the command.
 * @return string the PDF command @public
 ...
 * @param $y (float) Ordinate of point. @protected
 * @since 2.1.000 (2008-01-08)
 */
 ...
 * @param $y (float) Ordinate of end point. @protected
 * @since 2.1.000 (2008-01-08)
 */
 ...
 * corner (x, y) and dimensions widthand height in user space.
 *
 * @param $x (float) Abscissa of upper-left corner.
 * @param $y (float) Ordinate of upper-left corner.
 * @param $w (float) Width.
 * @param $h (float) Height.
 * @param $op (string) options @protected
 * @since 2.1.000 (2008-01-08)
 */
protected function _outRect($x, $y, $w, $h, $op) {
if ($this->state == 2) {
$this->_out(
sprintf('%F %F %F %F re %s', ($x * $this->k), (($this->h - $y) * $this->k), 
($w * $this->k), (- $h * $this->k), $op));
}
}

/**
 * Append a cubic Bezier curve to the current path. The curve shall extend from
 * the current point to the point (x3, y3), using (x1, y1) and (x2, y2) as the
 * Bezier control points. The new current point shall be (x3, y3).
 *
 ...
 * @param $y3 (float) Ordinate of end point. @protected
 * @since 2.1.000 (2008-01-08)
 */
protected function _outCurve($x1, $y1, $x2, $y2, $x3, $y3) {
if ($this->state == 2) {
$this->_out(
sprintf('%F %F %F %F %F %F c', ($x1 * $this->k), (($this->h - $y1) * $this->k), 
($x2 * $this->k), (($this->h - $y2) * $this->k), ($x3 * $this->k), 
(($this->h - $y3) * $this->k)));
}
}
...
/**
 * Append a cubic Bezier curve to the current path. The curve shall extend from
 * the current point to the point (x3, y3), using the current point and (x2, y2)
 * as the Bezier control points. The new current point shall be (x3, y3).
 *
 * @param $x2 (float) Abscissa of control point 2.
 * @param $y2 (float) Ordinate of control point 2.
 * @param $x3 (float) Abscissa of end point.
...
if ($this->state == 2) {
$this->_out(
sprintf('%F %F %F %F v', ($x2 * $this->k), (($this->h - $y2) * $this->k), 
...
/**
 * Append a cubic Bezier curve to the current path. The curve shall extend from
 * the current point to the point (x3, y3), using (x1, y1) and (x3, y3) as the
 * Bezier control points. The new current point shall be (x3, y3).
 *
 * @param $x1 (float) Abscissa of control point 1.
 * @param $y1 (float) Ordinate of control point 1.
...
if ($this->state == 2) {
$this->_out(
sprintf('%F %F %F %F y', ($x1 * $this->k), (($this->h - $y1) * $this->k), 
($x3 * $this->k), (($this->h - $y3) * $this->k)));
}
}
 ...
 *            value: default line style (empty array). @public
 * @since 1.0
 ...
 * @param $border_style (array) Border style of rectangle. Array with keys among
 *            the following: <ul> <li>all: Line style of all borders. Array like
 *            for SetLineStyle().</li> <li>L, T, R, B or combinations: Line
 *            style of left, top, right or bottom border. Array like for
 *            SetLineStyle().</li> </ul> If a key is not present or is null, the
 *            correspondent border is not drawn. Default value: default line
 *            style (empty array).
 * @param $fill_color (array) Fill color. Format: array(GREY) or array(R,G,B) or
 *            array(C,M,Y,K) or array(C,M,Y,K,SpotColorName). Default value:
 *            default color (empty array). @public
 * @since 1.0
 * @see SetLineStyle()
 */
public function Rect($x, $y, $w, $h, $style = '', $border_style = array(), 
$fill_color = array()) {
if ($this->state != 2) {
return;
}
...
/**
 * Draws a Bezier curve. The Bezier curve is a tangent to the line between the
 ...
 * @since 2.1.000 (2008-01-08)
 */
public function Curve($x0, $y0, $x1, $y1, $x2, $y2, $x3, $y3, $style = '', 
...
/**
 * Draws a poly-Bezier curve. Each Bezier curve segment is a tangent to the line
 ...
 */
public function Polycurve($x0, $y0, $segments, $style = '', $line_style = array(), 
$fill_color = array()) {
if ($this->state != 2) {
return;
}
 ...
 * @param $fill_color (array) Fill color. Format: array(GREY) or array(R,G,B) or
 *            array(C,M,Y,K) or array(C,M,Y,K,SpotColorName). Default value:
 *            default color (empty array).
 * @param $nc (integer) Number of curves used to draw a 90 degrees portion of
 *            ellipse.
 * @author Nicola Asuni @public
 * @since 2.1.000 (2008-01-08)
 */
public function Ellipse($x0, $y0, $rx, $ry = '', $angle = 0, $astart = 0, 
$afinish = 360, $style = '', $line_style = array(), $fill_color = array(), $nc = 2) {
if ($this->state != 2) {
return;
}
...
$this->_outellipticalarc($x0, $y0, $rx, $ry, $angle, $astart, $afinish, false, 
$nc, true, true, false);
$this->_out($op);
}

/**
 * Append an elliptical arc to the current path. An ellipse is formed from n
 * Bezier curves.
 *
 ...
 * @param $ry (float) Vertical radius (if ry = 0 then is a circle, see
 *            Circle()). Default value: 0.
 * @param $xang: (float) Angle between the X-axis and the major axis of the
 *            ellipse. Default value: 0.
 * @param $angs: (float) Angle start of draw line. Default value: 0.
 * @param $angf: (float) Angle finish of draw line. Default value: 360.
 * @param $pie (boolean) if true do not mark the border point (used to draw pie
 *            sectors).
 * @param $nc (integer) Number of curves used to draw a 90 degrees portion of
 *            ellipse.
 * @param $startpoint (boolean) if true output a starting point.
 * @param $ccw (boolean) if true draws in counter-clockwise.
 * @param $svg (boolean) if true the angles are in svg mode (already
 *            calculated).
 * @return array bounding box coordinates (x min, y min, x max, y max)
 * @author Nicola Asuni @protected
 * @since 4.9.019 (2010-04-26)
 */
protected function _outellipticalarc($xc, $yc, $rx, $ry, $xang = 0, $angs = 0, 
$angf = 360, $pie = false, $nc = 2, $startpoint = true, $ccw = true, $svg = false) {
if (($rx <= 0) or ($ry < 0)) {
return;
}
$k = $this->k;
 ...
 * @since 2.1.000 (2008-01-08)
 */
public function Circle($x0, $y0, $r, $angstr = 0, $angend = 360, $style = '', 
$line_style = array(), $fill_color = array(), $nc = 2) {
$this->Ellipse($x0, $y0, $r, $r, 0, $angstr, $angend, $style, $line_style, 
$fill_color, $nc);
}
 ...
 *            following: <ul> <li>all: Line style of all lines. Array like for
 *            SetLineStyle().</li> <li>0 to ($np - 1): Line style of each line.
 *            Array like for SetLineStyle().</li> </ul> If a key is not present
 *            or is null, not draws the line. Default value is default line
 *            style (empty array).
 * @param $fill_color (array) Fill color. Format: array(GREY) or array(R,G,B) or
 *            array(C,M,Y,K) or array(C,M,Y,K,SpotColorName). Default value:
 *            default color (empty array).
 * @since 4.8.003 (2009-09-15) @public
 */
 ...
 *            array(C,M,Y,K) or array(C,M,Y,K,SpotColorName). Default value:
 *            default color (empty array).
 * @param $closed (boolean) if true the polygon is closes, otherwise will remain
 *            open @public
 * @since 2.1.000 (2008-01-08)
 */
 ...
 * @param $style (string) Style of rendering. See the getPathPaintOperator()
 *            function for more information.
 * @param $line_style (array) Line style of polygon sides. Array with keys among
 *            the following: <ul> <li>all: Line style of all sides. Array like
 *            for SetLineStyle().</li> <li>0 to ($ns - 1): Line style of each
 *            side. Array like for SetLineStyle().</li> </ul> If a key is not
 *            present or is null, not draws the side. Default value is default
 *            line style (empty array).
 * @param $fill_color (array) Fill color. Format: array(red, green, blue).
 *            Default value: default color (empty array).
 * @param $circle_style (string) Style of rendering of inscribed circle (if
 *            draws). Possible values are: <ul> <li>D or empty string: Draw
 *            (default).</li> <li>F: Fill.</li> <li>DF or FD: Draw and
 *            fill.</li> <li>CNZ: Clipping mode (using the even-odd rule to
 *            determine which regions lie inside the clipping path).</li>
 *            <li>CEO: Clipping mode (using the nonzero winding number rule to
 *            determine which regions lie inside the clipping path).</li> </ul>
 * @param $circle_outLine_style (array) Line style of inscribed circle (if
 *            draws). Array like for SetLineStyle(). Default value: default line
 *            style (empty array).
 * @param $circle_fill_color (array) Fill color of inscribed circle (if draws).
 *            Format: array(red, green, blue). Default value: default color
 *            (empty array). @public
 * @since 2.1.000 (2008-01-08)
 */
public function RegularPolygon($x0, $y0, $r, $ns, $angle = 0, 
$draw_circle = false, $style = '', $line_style = array(), $fill_color = array(), $circle_style = '', 
 ...
 *            polygon).
 * @param $angle: (float) Angle oriented (anti-clockwise). Default value: 0.
 * @param $draw_circle: (boolean) Draw inscribed circle or not. Default value is
 *            false.
 * @param $style (string) Style of rendering. See the getPathPaintOperator()
 *            function for more information.
 * @param $line_style (array) Line style of polygon sides. Array with keys among
 *            the following: <ul> <li>all: Line style of all sides. Array like
 *            for SetLineStyle().</li> <li>0 to (n - 1): Line style of each
 *            side. Array like for SetLineStyle().</li> </ul> If a key is not
 *            present or is null, not draws the side. Default value is default
 *            line style (empty array).
 * @param $fill_color (array) Fill color. Format: array(red, green, blue).
 ...
 * @since 2.1.000 (2008-01-08)
 */
public function StarPolygon($x0, $y0, $r, $nv, $ng, $angle = 0, 
$draw_circle = false, $style = '', $line_style = array(), $fill_color = array(), $circle_style = '', 
$circle_outLine_style = array(), $circle_fill_color = array()) {
if ($nv < 2) {
$nv = 2;
 ...
 *            (not rounded i-corner) or 1 (rounded i-corner) in i-position.
 *            Positions are, in order and begin to 0: top right, bottom right,
 *            bottom left and top left. Default value: all rounded corner
 *            ("1111").
 * @param $style (string) Style of rendering. See the getPathPaintOperator()
 *            function for more information.
...
$this->RoundedRectXY($x, $y, $w, $h, $r, $r, $round_corner, $style, 
 ...
 */
public function RoundedRectXY($x, $y, $w, $h, $rx, $ry, $round_corner = '1111', 
$style = '', $border_style = array(), $fill_color = array()) {
if ($this->state != 2) {
return;
}
...
$this->_outLine($xc, $y);
if ($round_corner[0]) {
$this->_outCurve($xc + ($rx * $MyArc), $yc - $ry, $xc + $rx, 
$yc - ($ry * $MyArc), $xc + $rx, $yc);
} else {
$this->_outLine($x + $w, $y);
}
$xc = $x + $w - $rx;
...
if ($round_corner[1]) {
$this->_outCurve($xc + $rx, $yc + ($ry * $MyArc), $xc + ($rx * $MyArc), 
$yc + $ry, $xc, $yc + $ry);
} else {
 ...
 *            arrowhead, but no fill, 2 = closed and filled arrowhead, 3 =
 *            filled arrowhead)
 ...
 */
public function Arrow($x0, $y0, $x1, $y1, $head_style = 0, $arm_size = 5, 
$arm_angle = 15) {
...
$y1, 
$x2R, 
$y2R), $mode, $style, array());
}

// END GRAPHIC FUNCTIONS SECTION -----------------------

/**
 * Add a Named Destination. NOTE: destination names are unique, so only last
 * entry will be saved.
 *
 * @param $name (string) Destination name.
 * @param $y (float) Y position in user units of the destiantion on the selected
 *            page (default = -1 = current position; 0 = page start;).
 * @param $page (int|string) Target page number (leave empty for current page).
 *            If you prefix a page number with the * character, then this page
 *            will not be changed when adding/deleting/moving pages.
 * @param $x (float) X position in user units of the destiantion on the selected
 ...
 *
 * @return (array) Named Destination array. @public
 * @author Nicola Asuni
 * @since 5.9.097 (2011-06-23)
 */
...
/**
 * Insert Named Destinations. @protected
 *
...
$out .= ' /' . $name . ' ' . sprintf('[%u 0 R /XYZ %F %F null]', 
$this->page_obj_id[($o['p'])], ($o['x'] * $this->k), 
 ...
 *            character followed by the destination name), or embedded file (*
 *            character followed by the file name). @public
 */
public function setBookmark($txt, $level = 0, $y = -1, $page = '', $style = '', 
$color = array(0,0,0), $x = -1, $link = '') {
 ...
 * @since 2.1.002 (2008-02-12)
 */
public function Bookmark($txt, $level = 0, $y = -1, $page = '', $style = '', 
$color = array(0,0,0), $x = -1, $link = '') {
if ($level < 0) {
$level = 0;
}
...
/**
 * Sort bookmarks for page and key. @protected
 *
...
array_multisort($outline_p, SORT_NUMERIC, SORT_ASC, $outline_k, SORT_NUMERIC, 
SORT_ASC, $this->outlines);
}

/**
 * Create a bookmark PDF string. @protected
 *
...
$out .= ' /A <</S /GoToE /D [0 /Fit] /NewWindow true /T << /R /C /P ' .
 ($o['p'] - 1) . ' /A ' . $this->embeddedfiles[$filename]['a'] . ' >> >>';
} elseif ($o['u'][0] == '*') {
// embedded generic file
$filename = basename(substr($o['u'], 1));
$jsa = 'var D=event.target.doc;var MyData=D.dataObjects;for (var i in MyData) if (MyData[i].path=="' .
 $filename . '") D.exportDataObject( { cName : MyData[i].name, nLaunch : 2});';
$out .= ' /A <</S /JavaScript /JS ' . $this->_textstring($jsa, $oid) . '>>';
} else {
// external URI link
$out .= ' /A <</S /URI /URI ' .
 $this->_datastring($this->unhtmlentities($o['u']), $oid) . '>>';
}
} elseif (isset($this->links[$o['u']])) {
// internal link ID
$l = $this->links[$o['u']];
if (isset($this->page_obj_id[($l['p'])])) {
$out .= sprintf(' /Dest [%u 0 R /XYZ 0 %F null]', $this->page_obj_id[($l['p'])], 
($this->pagedim[$l['p']]['h'] - ($l['y'] * $this->k)));
}
}
} elseif (isset($this->page_obj_id[($o['p'])])) {
// link to a page
$out .= ' ' . sprintf('/Dest [%u 0 R /XYZ %F %F null]', 
$this->page_obj_id[($o['p'])], ($o['x'] * $this->k), 
($this->pagedim[$o['p']]['h'] - ($o['y'] * $this->k)));
}
// set font style
...
$out .= sprintf(' /C [%F %F %F]', ($color[0] / 255), ($color[1] / 255), 
($color[2] / 255));
} else {
// black
$out .= ' /C [0.0 0.0 0.0]';
...
$this->_out(
'<< /Type /Outlines /First ' . $n . ' 0 R /Last ' . ($n + $lru[0]) . ' 0 R >>' .
 "\n" . 'endobj');
}
 ...
 * Adds a javascript
 *
 * @param $script (string) Javascript code @public
 * @author Johannes G\FCntert, Nicola Asuni
 * @since 2.1.002 (2008-02-12)
 */
 ...
 *            document
 * @return int internal object ID @public
 * @author Nicola Asuni
 * @since 4.8.000 (2009-09-07)
 */
...
/**
 * Create a javascript PDF string. @protected
 *
 * @author Johannes G\FCntert, Nicola Asuni
 * @since 2.1.002 (2008-02-12)
 */
...
// the following two lines are used to avoid form fields duplication after
// saving
// The addField method only works when releasing user rights (UR3)
$jsa = sprintf("ftcpdfdocsaved=this.addField('%s','%s',%d,[%F,%F,%F,%F]);", 
...
"f" . $name . "=this.addField('%s','%s',%u,[%F,%F,%F,%F]);", $name, $type, 
 ...
 *         described on official Javascript for Acrobat API reference. @public
 * @author Nicola Asuni
 * @since 4.8.000 (2009-09-06)
 */
 ...
 * @param $x (float) Abscissa of the upper-left corner of the rectangle
 * @param $y (float) Ordinate of the upper-left corner of the rectangle
 * @param $js (boolean) if true put the field using JavaScript (requires Acrobat
 *            Writer to be rendered). @public
 * @author Nicola Asuni
 * @since 4.8.000 (2009-09-07)
 */
public function TextField($name, $w, $h, $prop = array(), $opt = array(), $x = '', $y = '', 
$js = false) {
if ($x === '') {
$x = $this->x;
}
...
// get annotation data
$popt = TCPDF_STATIC::getAnnotOptFromJSProp($prop, $this->spot_colors, 
$this->rtl);
// set default appearance stream
$this->annotation_fonts[$this->CurrentFont['fontkey']] = $this->CurrentFont['i'];
$fontstyle = sprintf('/F%d %F Tf %s', $this->CurrentFont['i'], 
...
$this->MultiCell($w, $h, $text, 0, $align, false, 0, 0, 0, true, 0, false, true, 
0, 'T', false);
$this->endTemplate();
-- $this->n;
 ...
 * @since 4.8.000 (2009-09-07)
 */
public function RadioButton($name, $w, $prop = array(), $opt = array(), $onvalue = 'On', 
$checked = false, $x = '', $y = '', $js = false) {
if ($x === '') {
$x = $this->x;
}
if ($y === '') {
...
$fontstyle = sprintf('/F%d %F Tf %s', $tmpfont['i'], $this->FontSizePt, 
$this->TextColor);
$popt['da'] = $fontstyle;
// build appearance stream
$popt['ap'] = array();
...
$popt['ap']['n'][$onvalue] = sprintf(
'q %s BT /F%d %F Tf %F %F Td (' . chr(108) . ') Tj ET Q', $this->TextColor, 
$tmpfont['i'], $this->FontSizePt, $fx, $fy);
$popt['ap']['n']['Off'] = sprintf(
'q %s BT /F%d %F Tf %F %F Td (' . chr(109) . ') Tj ET Q', $this->TextColor, 
$tmpfont['i'], $this->FontSizePt, $fx, $fy);
if (! isset($popt['mk'])) {
$popt['mk'] = array();
}
...
$tmpid = $this->startTemplate($w, $h, false);
$this->MultiCell($w, $h, $text, 0, '', false, 0, 0, 0, true, 0, false, true, 0, 
'T', false);
$this->endTemplate();
-- $this->n;
$popt['ap']['n'] .= $this->xobjects[$tmpid]['outdata'];
 ...
 * @since 4.8.000 (2009-09-07)
 */
public function CheckBox($name, $w, $checked = false, $prop = array(), $opt = array(), 
$onvalue = 'Yes', $x = '', $y = '', $js = false) {
if ($x === '') {
$x = $this->x;
}
if ($y === '') {
...
$fy = (($w - ((($tmpfont['desc']['Ascent'] - $tmpfont['desc']['Descent']) *
 $this->FontSizePt / 1000) / $this->k)) * $this->k);
$popt['ap']['n']['Yes'] = sprintf(
'q %s BT /F%d %F Tf %F %F Td (' . chr(110) . ') Tj ET Q', $this->TextColor, 
$tmpfont['i'], $this->FontSizePt, $fx, $fy);
$popt['ap']['n']['Off'] = sprintf(
'q %s BT /F%d %F Tf %F %F Td (' . chr(111) . ') Tj ET Q', $this->TextColor, 
$tmpfont['i'], $this->FontSizePt, $fx, $fy);
// merge options
$opt = array_merge($popt, $opt);
// set remaining annotation data
 ...
 *            to specify a javascript action. Use an array to specify a form
 *            action options as on section 12.7.5 of PDF32000_2008.
 * @param $prop (array) javascript field properties. Possible values are
 *            described on official Javascript for Acrobat API reference.
 * @param $opt (array) annotation parameters. Possible values are described on
 *            official PDF32000_2008 reference.
...
$this->javascript .= 'f' . $name . ".buttonSetCaption('" . addslashes($caption) .
 "');\n";
$this->javascript .= 'f' . $name . ".setAction('MouseUp','" . addslashes(
$action) . "');\n";
...
/**
 * Add certification signature (DocMDP or UR3) You can set only one signature
 * type @protected
 *
 * @author Nicola Asuni
...
$out .= ' >>'; // close TransformParams
               // optional digest data (values must be calculated and replaced
               // later)
               // $out .= ' /Data ********** 0 R';
...
if (isset($this->signature_data['info']['Name']) and
 ! TCPDF_STATIC::empty_string($this->signature_data['info']['Name'])) {
$out .= ' /Name ' .
 $this->_textstring($this->signature_data['info']['Name'], $sigobjid);
}
if (isset($this->signature_data['info']['Location']) and
 ! TCPDF_STATIC::empty_string($this->signature_data['info']['Location'])) {
$out .= ' /Location ' .
 $this->_textstring($this->signature_data['info']['Location'], $sigobjid);
}
if (isset($this->signature_data['info']['Reason']) and
 ! TCPDF_STATIC::empty_string($this->signature_data['info']['Reason'])) {
$out .= ' /Reason ' .
 $this->_textstring($this->signature_data['info']['Reason'], $sigobjid);
}
if (isset($this->signature_data['info']['ContactInfo']) and
 ! TCPDF_STATIC::empty_string($this->signature_data['info']['ContactInfo'])) {
$out .= ' /ContactInfo ' .
 $this->_textstring($this->signature_data['info']['ContactInfo'], $sigobjid);
}
$out .= ' /M ' . $this->_datestring($sigobjid, 
$this->doc_modification_timestamp);
$out .= ' >>';
$out .= "\n" . 'endobj';
$this->_out($out);
}
...
/**
 * Set User's Rights for PDF Reader WARNING: This is experimental and currently
 * do not work. Check the PDF Reference 8.7.1 Transform Methods, Table 8.105
 ...
 *            rights for the document. The only defined value is "/FullSave",
 *            which permits a user to save the document along with modified form
 *            and/or annotation data.
 ...
 *            /Create/Delete/Modify/Copy/Import/Export, which permit the user to
 *            perform the named operation on annotations.
 ...
 *            usage rights for the document. The only defined value is /Modify,
 *            which permits a user to apply a digital signature to an existing
 ...
 *            /Create/Delete/Modify/Import, which permit the user to perform the
 *            named operation on named embedded files Names specifying
 *            additional embedded-files-related usage rights for the document.
 * @param $formex (string) Names specifying additional form-field-related usage
 *            rights. The only valid name is BarcodePlaintext, which permits
 *            text form field data to be encoded as a plaintext two-dimensional
 *            barcode. @public
 * @author Nicola Asuni
 * @since 2.9.000 (2008-03-26)
 */
public function setUserRights($enable = true, $document = '/FullSave', 
$annots = '/Create/Delete/Modify/Copy/Import/Export', 
$form = '/Add/Delete/FillIn/Import/Export/SubmitStandalone/SpawnTemplate', $signature = '/Modify', $ef = '/Create/Delete/Modify/Import', $formex = '') {
...
/**
 * Enable document signature (requires the OpenSSL Library). The digital
 * signature improve document authenticity and integrity and allows o enable
 * extra features on Acrobat Reader. To create self-signed signature: openssl
 * req -x509 -nodes -days 365000 -newkey rsa:1024 -keyout tcpdf.crt -out
 * tcpdf.crt To export crt to p12: openssl pkcs12 -export -in tcpdf.crt -out
 * tcpdf.p12 To convert pfx certificate to pem: openssl pkcs12 -in tcpdf.pfx
 * -out tcpdf.crt -nodes
 *
 * @param $signing_cert (mixed) signing certificate (string or filename prefixed
 *            with 'file://')
 ...
 *            of extra certificates to include in the signature which can for
 ...
 *            Valid values shall be: 1 = No changes to the document shall be
 *            permitted; any change to the document shall invalidate the
 *            signature; 2 = Permitted changes shall be filling in forms,
 *            instantiating page templates, and signing; other changes shall
 *            invalidate the signature; 3 = Permitted changes shall be the same
 ...
 * @since 4.6.005 (2009-04-24)
 */
public function setSignature($signing_cert = '', $private_key = '', 
$private_key_password = '', $extracerts = '', $cert_type = 2, $info = array(), 
$approval = '') {
 ...
 * @param $name (string) Name of the signature. @public
 * @author Nicola Asuni
 * @since 5.3.011 (2010-06-17)
 */
public function setSignatureAppearance($x = 0, $y = 0, $w = 0, $h = 0, $page = -1, 
$name = '') {
$this->signature_appearance = $this->getSignatureAppearanceArray($x, $y, $w, $h, 
$page, $name);
}
 ...
 * @since 5.9.101 (2011-07-06)
 */
public function addEmptySignatureAppearance($x = 0, $y = 0, $w = 0, $h = 0, 
$page = -1, $name = '') {
++ $this->n;
$this->empty_signature_appearance[] = array(
'objid' => $this->n) +
...
/**
 * Get the array that defines the signature appearance (page and rectangle
 * coordinates).
 *
 * @param $x (float) Abscissa of the upper-left corner.
 * @param $y (float) Ordinate of the upper-left corner.
 ...
 * @return (array) Array defining page and rectangle coordinates of signature
 *         appearance. @protected
 * @author Nicola Asuni
 * @since 5.9.101 (2011-07-06)
 */
protected function getSignatureAppearanceArray($x = 0, $y = 0, $w = 0, $h = 0, 
$page = -1, $name = '') {
$sigapp = array();
...
/**
 * Enable document timestamping (requires the OpenSSL Library). The trusted
 * timestamping improve document security that means that no one should be able
 * to change the document once it has been recorded. Use with digital signature
 * only!
 *
 * @param $tsa_host (string) Time Stamping Authority (TSA) server (prefixed with
 *            'https://')
 * @param $tsa_username (string) Specifies the username for TSA authorization
 *            (optional) OR specifies the TSA authorization PEM file (see:
 *            example_66.php, optional)
 ...
 *            authorization (optional for cURL) @public
 * @author Richard Stockinger
 * @since 6.0.090 (2014-06-16)
 */
public function setTimeStamp($tsa_host = '', $tsa_username = '', $tsa_password = '', 
$tsa_cert = '') {
$this->tsa_data = array();
 ...
 * @return (string) Timestamped digital signature @protected
 * @author Richard Stockinger
 * @since 6.0.090 (2014-06-16)
 */
 ...
 *
 * @param $page (int) starting group page (leave empty for next page). @public
 * @since 3.0.000 (2008-03-27)
 */
 ...
 * @since 5.9.093 (2011-06-16) @public
 */
...
/**
 * Returns the string alias used right align page numbers. If the current font
 * is unicode type, the returned string wil contain an additional open curly
 * brace.
 *
 * @return string
 * @since 5.9.099 (2011-06-27) @public
 */
public function getAliasRightShift() {
// calculate aproximatively the ratio between widths of aliases and
// replacements.
$ref = '{' . TCPDF_STATIC::$alias_right_shift . '}{' .
 TCPDF_STATIC::$alias_tot_pages . '}{' . TCPDF_STATIC::$alias_num_page . '}';
...
/**
 * Returns the string alias used for the total number of pages. If the current
 * font is unicode type, the returned string is surrounded by additional curly
 * braces. This alias will be replaced by the total number of pages in the
 * document.
 *
 * @return string
 * @since 4.0.018 (2008-08-08) @public
 */
...
/**
 * Returns the string alias used for the page number. If the current font is
 * unicode type, the returned string is surrounded by additional curly braces.
 * This alias will be replaced by the page number.
 *
 * @return string
 * @since 4.5.000 (2009-01-02) @public
 */
...
/**
 * Return the alias for the total number of pages in the current page group. If
 * the current font is unicode type, the returned string is surrounded by
 * additional curly braces. This alias will be replaced by the total number of
 * pages in this group.
 *
 * @return alias of the current page group @public
 * @since 3.0.000 (2008-03-27)
 */
...
/**
 * Return the alias for the page number on the current page group. If the
 * current font is unicode type, the returned string is surrounded by additional
 * curly braces. This alias will be replaced by the page number (relative to the
 * belonging group).
 *
 * @return alias of the current page group @public
 * @since 4.5.000 (2009-01-02)
 ...
 *
 * @return current page in the group @public
 * @since 3.0.000 (2008-03-27)
 */
...
/**
 * Returns the current group page number formatted as a string. @public
 *
...
/**
 * Returns the current page number formatted as a string. @public
 *
...
$out = '<< /Type /OCG';
$out .= ' /Name ' .
 $this->_textstring($layer['name'], $this->pdflayers[$key]['objid']);
$out .= ' /Usage <<';
 ...
 * @param $lock (boolean) If true lock the layer @public
 * @since 5.9.102 (2011-07-13)
 */
...
/**
 * End the current PDF layer. @public
 *
 * @since 5.9.102 (2011-07-13)
 */
...
/**
 * Set the visibility of the successive elements. This can be useful, for
 * instance, to put a background image or color that will show on screen but
 * won't print.
 *
 ...
 * @return the number of extgstates @protected
 * @since 3.0.000 (2008-03-27)
 */
 ...
 * Add an extgstate
 *
 * @param $gs (array) extgstate @protected
 * @since 3.0.000 (2008-03-27)
 */
...
/**
 * Put extgstates for object transparency @protected
 *
 * @since 3.0.000 (2008-03-27)
 */
 ...
 * operations. (Check the "Entries in a Graphics State Parameter Dictionary" on
 * PDF 32000-1:2008).
 *
 * @param $stroking (boolean) If true apply overprint for stroking operations.
 * @param $nonstroking (boolean) If true apply overprint for painting operations
 *            other than stroking.
 * @param $mode (integer) Overprint mode: (0 = each source colour component
 *            value replaces the value previously painted for the corresponding
 *            device colorant; 1 = a tint value of 0.0 for a source colour
 *            component shall leave the corresponding component of the
 *            previously painted colour unchanged). @public
 * @since 5.9.152 (2012-03-23)
 */
...
/**
 * Get the overprint mode array (OP, op, OPM). (Check the "Entries in a Graphics
 * State Parameter Dictionary" on PDF 32000-1:2008).
 *
 * @return array. @public
 * @since 5.9.152 (2012-03-23)
 */
 ...
 *
 * @param $stroking (float) Alpha value for stroking operations: real value from
...
/**
 * Get the alpha mode array (CA, ca, BM, AIS). (Check the "Entries in a Graphics
 * State Parameter Dictionary" on PDF 32000-1:2008).
 *
 * @return array. @public
 * @since 5.9.152 (2012-03-23)
 ...
 *
 * @param $quality (int) JPEG quality, integer between 1 and 100 @public
 * @since 3.0.000 (2008-03-27)
 */
 ...
 *
 * @param $cols (int) number of columns @public
...
/**
 * return the height of cell repect font height. @public
 *
 * @since 4.0.012 (2008-07-24)
 */
 ...
 *
 * @param $version (string) PDF document version. @public
 * @since 3.1.000 (2008-06-09)
 */
 ...
 * be presented on the screen or in print. (see Section 8.1 of PDF reference,
 * "Viewer Preferences"). <ul><li>HideToolbar boolean (Optional) A flag
 * specifying whether to hide the viewer application's tool bars when the
 * document is active. Default value: false.</li><li>HideMenubar boolean
 * (Optional) A flag specifying whether to hide the viewer application's menu
 * bar when the document is active. Default value: false.</li><li>HideWindowUI
 * boolean (Optional) A flag specifying whether to hide user interface elements
 * in the document's window (such as scroll bars and navigation controls),
 * leaving only the document's contents displayed. Default value:
 * false.</li><li>FitWindow boolean (Optional) A flag specifying whether to
 * resize the document's window to fit the size of the first displayed page.
 * Default value: false.</li><li>CenterWindow boolean (Optional) A flag
 * specifying whether to position the document's window in the center of the
 * screen. Default value: false.</li><li>DisplayDocTitle boolean (Optional; PDF
 * 1.4) A flag specifying whether the window's title bar should display the
 * document title taken from the Title entry of the document information
 * dictionary (see Section 10.2.1, "Document Information Dictionary"). If false,
 * the title bar should instead display the name of the PDF file containing the
 * document. Default value: false.</li><li>NonFullScreenPageMode name (Optional)
 * The document's page mode, specifying how to display the document on exiting
 * full-screen mode:<ul><li>UseNone Neither document outline nor thumbnail
 * images visible</li><li>UseOutlines Document outline visible</li><li>UseThumbs
 * Thumbnail images visible</li><li>UseOC Optional content group panel
 * visible</li></ul>This entry is meaningful only if the value of the PageMode
 * entry in the catalog dictionary (see Section 3.6.1, "Document Catalog") is
 * FullScreen; it is ignored otherwise. Default value: UseNone.</li><li>ViewArea
 * name (Optional; PDF 1.4) The name of the page boundary representing the area
 * of a page to be displayed when viewing the document on the screen. Valid
 * values are (see Section 10.10.1, "Page
 * Boundaries").:<ul><li>MediaBox</li><li>CropBox
 * (default)</li><li>BleedBox</li><li>TrimBox</li><li>ArtBox</li></ul></li><li>ViewClip
 * name (Optional; PDF 1.4) The name of the page boundary to which the contents
 * of a page are to be clipped when viewing the document on the screen. Valid
 * values are (see Section 10.10.1, "Page
 * Boundaries").:<ul><li>MediaBox</li><li>CropBox
 * (default)</li><li>BleedBox</li><li>TrimBox</li><li>ArtBox</li></ul></li><li>PrintArea
 * name (Optional; PDF 1.4) The name of the page boundary representing the area
 * of a page to be rendered when printing the document. Valid values are (see
 ...
 * name (Optional; PDF 1.4) The name of the page boundary to which the contents
 * of a page are to be clipped when printing the document. Valid values are (see
 * Section 10.10.1, "Page Boundaries").:<ul><li>MediaBox</li><li>CropBox
 ...
 * scaling</li><li>AppDefault (default), which indicates that applications
 * should use the current print scaling</li></ul></li><li>Duplex name (Optional;
 * PDF 1.7) The paper handling option to use when printing the file from the
 * print dialog. The following values are valid:<ul><li>Simplex - Print
 * single-sided</li><li>DuplexFlipShortEdge - Duplex and flip on the short edge
 * of the sheet</li><li>DuplexFlipLongEdge - Duplex and flip on the long edge of
 * the sheet</li></ul>Default value: none</li><li>PickTrayByPDFSize boolean
 * (Optional; PDF 1.7) A flag specifying whether the PDF page size is used to
 * select the input paper tray. This setting influences only the preset values
 * used to populate the print dialog presented by a PDF viewer application. If
 * PickTrayByPDFSize is true, the check box in the print dialog associated with
 * input paper tray is checked. Note: This setting has no effect on Mac OS
 * systems, which do not provide the ability to pick the input tray by
 * size.</li><li>PrintPageRange array (Optional; PDF 1.7) The page numbers used
 * to initialize the print dialog box when the file is printed. The first page
 * of the PDF file is denoted by 1. Each pair consists of the first and last
 * pages in the sub-range. An odd number of integers causes this entry to be
 * ignored. Negative numbers cause the entire array to be ignored. Default
 * value: as defined by PDF viewer application</li><li>NumCopies integer
 * (Optional; PDF 1.7) The number of copies to be printed when the print dialog
 * is opened for this file. Supported values are the integers 2 through 5.
 * Values outside this range are ignored. Default value: as defined by PDF
 * viewer application, but typically 1</li></ul>
 *
 ...
 * @param $colors (string) colors to print separated by comma. Valid values are:
 *            A,W,R,G,B,C,M,Y,K,RGB,CMYK,ALL,ALLSPOT,<SPOT_COLOR_NAME>. Where: A
 *            = grayscale black, W = grayscale white, R = RGB red, G RGB green,
 *            B RGB blue, C = CMYK cyan, M = CMYK magenta, Y = CMYK yellow, K =
 *            CMYK key/black, RGB = RGB registration color, CMYK = CMYK
 *            registration color, ALL = Spot registration color, ALLSPOT = print
 *            all defined spot colors, <SPOT_COLOR_NAME> = name of the spot
 *            color to print.
 * @author Nicola Asuni
 * @since 4.9.000 (2010-03-26) @public
 */
public function colorRegistrationBar($x, $y, $w, $h, $transition = true, 
$vertical = false, $colors = 'A,R,G,B,C,M,Y,K') {
 ...
 *            comma: T = TOP, F = BOTTOM, L = LEFT, R = RIGHT, TL = A =
 *            TOP-LEFT, TR = B = TOP-RIGHT, BL = C = BOTTOM-LEFT, BR = D =
 *            BOTTOM-RIGHT.
 * @param $color (array) crop mark color (default spot registration color).
 * @author Nicola Asuni
 * @since 4.9.000 (2010-03-26) @public
 */
public function cropMark($x, $y, $w, $h, $type = 'T,R,B,L', 
 ...
 * @since 4.9.000 (2010-03-26) @public
 */
public function registrationMark($x, $y, $r, $double = false, 
$cola = array(100,100,100,100,'All'), $colb = array(0,0,0,0,'None')) {
$line_style = array(
 ...
 * @param $r (float) radius of the crop mark.
 * @author Nicola Asuni
 * @since 6.0.038 (2013-09-30) @public
 */
 ...
 *            gradient vector (see linear_gradient_coords.jpg). The default
 *            value is from left to right (x1=0, y1=0, x2=1, y2=0).
 * @author Andreas W\FCrmser, Nicola Asuni
 * @since 3.1.000 (2008-06-09) @public
 */
public function LinearGradient($x, $y, $w, $h, $col1 = array(), $col2 = array(), 
 ...
 *            is the starting point of the gradient with color1, (cx, cy) is the
 *            center of the circle with color2, and r is the radius of the
 *            circle (see radial_gradient_coords.jpg). (fx, fy) should be inside
 *            the circle, otherwise some areas will not be defined.
 * @author Andreas W\FCrmser, Nicola Asuni
 * @since 3.1.000 (2008-06-09) @public
 */
 ...
 *            .... float x12, float y12): 12 pairs of coordinates (normally from
 *            0 to 1) which specify the Bezier control points that define the
 *            patch. First pair is the lower left edge point, next is its right
 *            control point (control point 2). Then the other points are defined
 *            in the order: control point 1, edge point, control point 2 going
 *            counter-clockwise around the patch. Last (x12, y12) is the first
 *            edge point's left control point (control point 1).</li><li>for two
 *            or more patch meshes: array[number of patches]: arrays with the
 *            following keys for each patch: f: where to put that patch (0 =
 *            first patch, 1, 2, 3 = right, top and left of precedent patch - I
 *            didn't figure this out completely - just try and error ;-) points:
 *            12 pairs of coordinates of the Bezier control points as above for
 *            the first patch, 8 pairs of coordinates for the following patches,
 *            ignoring the coordinates already defined by the precedent patch (I
 *            also didn't figure out the order of these - also: try and see
 *            what's happening) colors: must be 4 colors for the first patch, 2
 *            colors for the following patches</li></ul>
 * @param $coords_min (array) minimum value used by the coordinates. If a
 *            coordinate's value is smaller than this it will be cut to
 *            coords_min. default: 0
 * @param $coords_max (array) maximum value used by the coordinates. If a
 *            coordinate's value is greater than this it will be cut to
 *            coords_max. default: 1
 * @param $antialias (boolean) A flag indicating whether to filter the shading
 *            function to prevent aliasing artifacts.
 * @author Andreas W\FCrmser, Nicola Asuni
 * @since 3.1.000 (2008-06-09) @public
 */
public function CoonsPatchMesh($x, $y, $w, $h, $col1 = array(), $col2 = array(), 
$col3 = array(), $col4 = array(), 
$coords = array(0.00,0.0,0.33,0.00,0.67,0.00,1.00,0.00,1.00,0.33,1.00,0.67,1.00,1.00,0.67,1.00,0.33,1.00,0.00,1.00,0.00,0.67,0.00,0.33), $coords_min = 0, $coords_max = 1, $antialias = false) {
if ($this->pdfa_mode or ($this->state != 2)) {
return;
}
$this->Clip($x, $y, $w, $h);
...
$this->gradients[$n]['stream'] .= chr($patch_array[$i]['f']); // start with the
                                                              // edge flag as 8
                                                              // bit
 ...
 *
 * @param $x (float) abscissa of the top left corner of the rectangle (or top
 *            right corner for RTL mode).
 * @param $y (float) ordinate of the top left corner of the rectangle.
 * @param $w (float) width of the rectangle.
 * @param $h (float) height of the rectangle.
 * @author Andreas W\FCrmser, Nicola Asuni
...
$s = 'q';
// set clipping area
$s .= sprintf(' %F %F %F %F re W n', $x * $this->k, ($this->h - $y) * $this->k, 
$w * $this->k, - $h * $this->k);
// set up transformation matrix for gradient
$s .= sprintf(' %F 0 0 %F %F %F cm', $w * $this->k, $h * $this->k, 
 ...
 *            shading; 3 Radial shading; 4 Free-form Gouraud-shaded triangle
 *            mesh; 5 Lattice-form Gouraud-shaded triangle mesh; 6 Coons patch
 *            mesh; 7 Tensor-product patch mesh). (Not all types are currently
 *            supported)
 * @param $coords (array) array of coordinates.
 * @param $stops (array) array gradient color components: color = array of GRAY,
 *            RGB or CMYK color components; offset = (0 to 1) represents a
 *            location along the gradient vector; exponent = exponent of the
 *            exponential interpolation function (default = 1).
 ...
 * @since 3.1.000 (2008-06-09) @public
 */
public function Gradient($type, $coords, $stops, $background = array(), 
$antialias = false) {
if ($this->pdfa_mode or ($this->state != 2)) {
return;
}
...
if (! empty($background)) {
$this->gradients[$n]['background'] = sprintf('%F %F %F %F', $bcolor[0] / 100, 
...
if (! empty($background)) {
$this->gradients[$n]['background'] = sprintf('%F %F %F', $bcolor[0] / 255, 
...
$offsetstep = (1 - $this->gradients[$n]['colors'][($key - 1)]['offset']) /
 ($num_stops - $key);
$this->gradients[$n]['colors'][$key]['offset'] = $this->gradients[$n]['colors'][($key -
 1)]['offset'] + $offsetstep;
}
}
...
if ($grad['type'] == 2) {
$out .= ' ' . sprintf('/Coords [%F %F %F %F]', $grad['coords'][0], 
...
$out .= ' ' . sprintf('/Coords [%F %F 0 %F %F %F]', $grad['coords'][0], 
...
$this->_out($out);
if ($grad['transparency']) {
$shading_transparency = preg_replace('/\/ColorSpace \/[^\s]+/si', 
'/ColorSpace /DeviceGray', $out);
$shading_transparency = preg_replace('/\/Function [0-9]+ /si', 
'/Function ' . $ft . ' ', $shading_transparency);
}
...
'n' => $oid);
$filter = '';
$stream = 'q /a0 gs /Pattern cs /p' . $idgs . ' scn 0 0 ' . $this->wPt . ' ' .
 $this->hPt . ' re f Q';
if ($this->compress) {
$filter = ' /Filter /FlateDecode';
$stream = gzcompress($stream);
...
$out .= ' /Pattern << /p' . $idgs . ' ' . $this->gradients[$idgs]['pattern'] .
 ' 0 R >>';
$out .= ' >>';
$out .= ' >> ';
$out .= ' stream' . "\n" . $stream . "\n" . 'endstream';
...
/**
 * Draw the sector of a circle. It can be used for instance to render pie
 * charts.
 *
...
/**
 * Draw the sector of an ellipse. It can be used for instance to render pie
 * charts.
 *
 * @param $xc (float) abscissa of the center.
 * @param $yc (float) ordinate of the center.
 ...
 * @since 3.1.000 (2008-06-09) @public
 */
public function PieSectorXY($xc, $yc, $rx, $ry, $a, $b, $style = 'FD', $cw = false, 
$o = 0, $nc = 2) {
if ($this->state != 2) {
return;
}
...
/**
 * Embed vector-based Adobe Illustrator (AI) or AI-compatible EPS files. NOTE:
 * EPS is not yet fully implemented, use the setRasterizeVectorImages() method
 * to enable/disable rasterization of vector images using ImageMagick library.
 * Only vector drawing is supported, not text or bitmap. Although the script was
 * successfully tested with various AI format versions, best results are
 * probably achieved with files that were exported in the AI3 format (tested
 ...
 *            box (true) or the complete canvas (false) at location (x,y).
 ...
 * @since 3.1.000 (2008-06-09) @public
 */
public function ImageEps($file, $x = '', $y = '', $w = 0, $h = 0, $link = '', 
$useBoundingBox = true, $align = '', $palign = '', $border = 0, $fitonpage = false, 
$fixoutvals = false) {
if ($this->state != 2) {
return;
}
...
return $this->Image($file, $x, $y, $w, $h, 'EPS', $link, $align, true, 300, 
$palign, false, false, $border, false, false, $fitonpage);
}
if ($x === '') {
$x = $this->x;
}
...
// translate
$this->_out(
sprintf('%F %F %F %F %F %F cm', 1, 0, 0, 1, $dx, 
$dy + ($this->hPt - (2 * $y * $k) - ($y2 - $y1))));
// scale
if (isset($scale_x)) {
$this->_out(
sprintf('%F %F %F %F %F %F cm', $scale_x, 0, 0, $scale_y, $x1 * (1 - $scale_x), 
$y2 * (1 - $scale_y)));
}
...
$g = array_pop($chunks);
$r = array_pop($chunks);
$this->_out('' . $r . ' ' . $g . ' ' . $b . ' ' . ($cmd == 'Xa' ? 'rg' : 'RG')); // substr($line,
                                                                                 // 0,
                                                                                 // -2).'rg'
                                                                                 // ->
                                                                                 // in
...
$this->AddSpotColor($color_name, ($col_c * 100), ($col_m * 100), ($col_y * 100), 
($col_k * 100));
$color_cmd = sprintf('/CS%d cs %F scn', $this->spot_colors[$color_name]['i'], 
(1 - $col_t));
$this->_out($color_cmd);
}
break;
 ...
 *
 * @param $bc (string) barcode @public
 */
 ...
 *            default value = 0.4mm)
 * @param $style (array) array of options:<ul> <li>boolean $style['border'] if
 *            true prints a border</li> <li>int $style['padding'] padding to
 *            leave around the barcode in user units (set to 'auto' for
 *            automatic padding)</li> <li>int $style['hpadding'] horizontal
 *            padding in user units (set to 'auto' for automatic padding)</li>
 *            <li>int $style['vpadding'] vertical padding in user units (set to
 *            'auto' for automatic padding)</li> <li>array $style['fgcolor']
 *            color array for bars and text</li> <li>mixed $style['bgcolor']
 *            color array for background (set to false for transparent)</li>
 *            <li>boolean $style['text'] if true prints text below the
 *            barcode</li> <li>string $style['label'] override default
 *            label</li> <li>string $style['font'] font name for
 *            text</li><li>int $style['fontsize'] font size for text</li>
 *            <li>int $style['stretchtext']: 0 = disabled; 1 = horizontal
 *            scaling only if necessary; 2 = forced horizontal scaling; 3 =
 *            character spacing only if necessary; 4 = forced character
 *            spacing.</li> <li>string $style['position'] horizontal position of
 *            the containing barcode cell on the page: L = left margin; C =
 *            center; R = right margin.</li> <li>string $style['align']
 *            horizontal position of the barcode on the containing rectangle: L
 *            = left; C = center; R = right.</li> <li>string $style['stretch']
 *            if true stretch the barcode to best fit the available width,
 *            otherwise uses $xres resolution for a single bar.</li> <li>string
 *            $style['fitwidth'] if true reduce the width to fit the barcode
 *            width + padding. When this option is enabled the 'stretch' option
 *            is automatically disabled.</li> <li>string $style['cellfitalign']
 *            this option works only when 'fitwidth' is true and 'position' is
 *            unset or empty. Set the horizontal position of the containing
 *            barcode cell inside the specified rectangle: L = left; C = center;
 *            R = right.</li></ul>
 * @param $align (string) Indicates the alignment of the pointer next to barcode
 *            insertion relative to barcode height. The value can be:<ul><li>T:
 *            top-right for LTR or top-left for RTL</li><li>M: middle-right for
 *            LTR or middle-left for RTL</li><li>B: bottom-right for LTR or
 *            bottom-left for RTL</li><li>N: next line</li></ul>
 * @author Nicola Asuni
...
if ((isset($style['padding']) and ($style['padding'] === 'auto')) or
 (isset($style['hpadding']) and ($style['hpadding'] === 'auto'))) {
$hpadding = 10 * $xres;
...
if ($style['bgcolor']) {
$this->Rect($xpos_rect, $y, $w, $h, $style['border'] ? 'DF' : 'F', '', 
$style['bgcolor']);
} elseif ($style['border']) {
...
$this->SetCellPadding(0);
$this->Cell($txtwidth, '', $label, 0, 0, 'C', false, '', $style['stretchtext'], 
false, 'T', 'T');
$this->cell_padding = $cellpadding;
}
 ...
 * @param $style (array) array of options:<ul> <li>boolean $style['border'] if
 *            true prints a border around the barcode</li> <li>int
 *            $style['padding'] padding to leave around the barcode in barcode
 *            units (set to 'auto' for automatic padding)</li> <li>int
 *            $style['hpadding'] horizontal padding in barcode units (set to
 *            'auto' for automatic padding)</li> <li>int $style['vpadding']
 *            vertical padding in barcode units (set to 'auto' for automatic
 *            padding)</li> <li>int $style['module_width'] width of a single
 *            module in points</li> <li>int $style['module_height'] height of a
 *            single module in points</li> <li>array $style['fgcolor'] color
 *            array for bars and text</li> <li>mixed $style['bgcolor'] color
 *            array for background or false for transparent</li> <li>string
 *            $style['position'] barcode position on the page: L = left margin;
 *            C = center; R = right margin; S =
 *            stretch</li><li>$style['module_width'] width of a single module in
 *            points</li> <li>$style['module_height'] height of a single module
 *            in points</li></ul>
 * @param $align (string) Indicates the alignment of the pointer next to barcode
 *            insertion relative to barcode height. The value can be:<ul><li>T:
 *            top-right for LTR or top-left for RTL</li><li>M: middle-right for
 ...
 * @author Nicola Asuni
 * @since 4.5.037 (2009-04-07) @public
 */
public function write2DBarcode($code, $type, $x = '', $y = '', $w = '', $h = '', 
$style = '', $align = '', $distort = false) {
if (TCPDF_STATIC::empty_string(trim($code))) {
return;
}
...
$arrcode = $barcodeobj->getBarcodeArray();
if (($arrcode === false) or empty($arrcode) or ! isset($arrcode['num_rows']) or
 ($arrcode['num_rows'] == 0) or ! isset($arrcode['num_cols']) or
 ($arrcode['num_cols'] == 0)) {
...
// print background color
if ($style['bgcolor']) {
$this->Rect($xpos, $y, $w, $h, $style['border'] ? 'DF' : 'F', '', 
$style['bgcolor']);
} elseif ($style['border']) {
...
/**
 * Returns an array containing current margins: <ul> <li>$ret['left'] = left
 * margin</li> <li>$ret['right'] = right margin</li> <li>$ret['top'] = top
 * margin</li> <li>$ret['bottom'] = bottom margin</li> <li>$ret['header'] =
 * header margin</li> <li>$ret['footer'] = footer margin</li> <li>$ret['cell'] =
 * cell padding array</li> <li>$ret['padding_left'] = cell left padding</li>
 * <li>$ret['padding_top'] = cell top padding</li> <li>$ret['padding_right'] =
 * cell right padding</li> <li>$ret['padding_bottom'] = cell bottom padding</li>
 * </ul>
 *
 * @return array containing all margins measures @public
 * @since 3.2.000 (2008-06-23)
 */
...
/**
 * Returns an array containing original margins: <ul> <li>$ret['left'] = left
 * margin</li> <li>$ret['right'] = right margin</li> </ul>
 *
 * @return array containing all margins measures @public
 * @since 4.0.012 (2008-07-24)
 */
 ...
 *
 * @return current font size @public
 * @since 3.2.000 (2008-06-23)
 */
 ...
 *
 * @return current font size in points unit @public
 * @since 3.2.000 (2008-06-23)
 */
 ...
 *
 * @return string current font family name @public
 ...
 *
 * @return string current font style @public
 * @since 4.3.008 (2008-12-05)
 */
 ...
 * @return int with in user units @protected
 * @since 5.7.000 (2010-08-02)
 */
 ...
 * @return array containing border properties @protected
 * @since 5.7.000 (2010-08-02)
 */
 ...
 * @return array of cell paddings @public
...
$cell_padding['T'] = $this->getHTMLUnitToUnits($cell_padding['T'], $width, 'px', 
false);
$cell_padding['R'] = $this->getHTMLUnitToUnits($cell_padding['R'], $width, 'px', 
false);
$cell_padding['B'] = $this->getHTMLUnitToUnits($cell_padding['B'], $width, 'px', 
false);
$cell_padding['L'] = $this->getHTMLUnitToUnits($cell_padding['L'], $width, 'px', 
false);
return $cell_padding;
}
 ...
 * @param $width (float) width of the containing element
 * @return array of cell margins @public
 * @since 5.9.000 (2010-10-04)
 */
...
$cell_margin['T'] = $this->getHTMLUnitToUnits(
str_replace('auto', '0', $cell_margin['T']), $width, 'px', false);
$cell_margin['R'] = $this->getHTMLUnitToUnits(
str_replace('auto', '0', $cell_margin['R']), $width, 'px', false);
$cell_margin['B'] = $this->getHTMLUnitToUnits(
str_replace('auto', '0', $cell_margin['B']), $width, 'px', false);
$cell_margin['L'] = $this->getHTMLUnitToUnits(
str_replace('auto', '0', $cell_margin['L']), $width, 'px', false);
return $cell_margin;
}
 ...
 * @param $width (float) width of the containing element
 * @return array of border spacings @public
...
$border_spacing['H'] = $this->getHTMLUnitToUnits($border_spacing['H'], $width, 
'px', false);
$border_spacing['V'] = $this->getHTMLUnitToUnits($border_spacing['V'], $width, 
'px', false);
 ...
 * @return float quantity to increases or decreases the space between characters
 *         in a text. @protected
 ...
 * @return float font stretching percentage @protected
 * @since 5.9.000 (2010-10-02)
 */
 ...
 * @return float value in points @public
 */
public function getHTMLFontUnits($val, $refsize = 12, $parent_size = 12, 
$defaultunit = 'pt') {
...
$css = array_merge($css, 
json_decode($this->unhtmlentities($matches[1][0]), true));
}
...
// tv)
if (empty($type) or
 (isset($type[1]) and (($type[1] == 'all') or ($type[1] == 'print')))) {
$type = array();
...
while (preg_match(
"'<xre([^\>]*)>(.*?)" . $this->re_space['p'] . "(.*?)</pre>'" .
 $this->re_space['m'], $html_b)) {
// preserve spaces on <pre> tag
$html_b = preg_replace(
"'<xre([^\>]*)>(.*?)" . $this->re_space['p'] . "(.*?)</pre>'" .
 $this->re_space['m'], "<xre\\1>\\2&nbsp;\\3</pre>", $html_b);
}
...
"\\2#!TaB!#\\4#!NwL!#", $html_b);
$html_b = preg_replace("'<option([^\>]*)>(.*?)</option>'si", "\\2#!NwL!#", 
$html_b);
}
...
$html = preg_replace(
'/' . $this->re_space['p'] . '+<\/(td|th|li|dt|dd)>/' . $this->re_space['m'], 
'</\\1>', $html);
...
'</\\1><', $html);
$html = preg_replace('/<\/(td|th)>/', '<marker style="font-size:0"/></\\1>', 
$html);
$html = preg_replace('/<\/table>([\s]*)<marker style="font-size:0"\/>/', 
'</table>', $html);
$html = preg_replace(
'/' . $this->re_space['p'] . '+<img/' . $this->re_space['m'], chr(32) . '<img', 
$html);
$html = preg_replace('/<img([^\>]*)>[\s]+([^\<])/xi', '<img\\1>&nbsp;\\2', 
$html);
$html = preg_replace('/<img([^\>]*)>/xi', 
'<img\\1><span><marker style="font-size:0"/></span>', $html);
$html = preg_replace('/<xre/', '<pre', $html); // restore pre tag
$html = preg_replace('/<textarea([^\>]*)>([^\<]*)<\/textarea>/xi', 
'<textarea\\1 value="\\2" />', $html);
$html = preg_replace('/<li([^\>]*)><\/li>/', '<li\\1>&nbsp;</li>', $html);
$html = preg_replace(
'/<li([^\>]*)>' . $this->re_space['p'] . '*<img/' . $this->re_space['m'], 
'<li\\1><font size="1">&nbsp;</font><img', $html);
$html = preg_replace('/<([^\>\/]*)>[\s]/', '<\\1>&nbsp;', $html); // preserve
                                                                  // some spaces
$html = preg_replace('/[\s]<\/([^\>]*)>/', '&nbsp;</\\1>', $html); // preserve
                                                                   // some
                                                                   // spaces
$html = preg_replace('/<su([bp])/', '<zws/><su\\1', $html); // fix sub/sup
                                                            // alignment
$html = preg_replace('/<\/su([bp])>/', '</su\\1><zws/>', $html); // fix sub/sup
                                                                 // alignment
$html = preg_replace('/' . $this->re_space['p'] . '+/' . $this->re_space['m'], 
chr(32), $html); // replace
                 // multiple
                 // spaces
                 // with
...
$html = preg_replace('/^<img/', '<span style="font-size:0"><br /></span> <img', 
$html, 1);
// pattern for generic tag
$tagpattern = '/(<[^>]+>)/';
// explodes the string
$a = preg_split($tagpattern, $html, - 1, 
...
// possible inheritable properties are: azimuth, border-collapse,
// border-spacing, caption-side, color, cursor, direction, empty-cells, font,
// font-family, font-stretch, font-size, font-size-adjust, font-style,
// font-variant, font-weight, letter-spacing, line-height, list-style,
// list-style-image, list-style-position, list-style-type, orphans, page,
// page-break-inside, quotes, speak, speak-header, text-align, text-indent,
// text-transform, volume, white-space, widows, word-spacing
$dom[$key]['tag'] = false;
$dom[$key]['block'] = false;
$dom[$key]['value'] = '';
$dom[$key]['parent'] = 0;
...
$key = $i;
// mark nested tables
$dom[($dom[$key]['parent'])]['content'] = str_replace('<table', 
'<table nested="true"', $dom[($dom[$key]['parent'])]['content']);
...
if (TCPDF_STATIC::empty_string(
$dom[($dom[($dom[$key]['parent'])]['parent'])]['thead'])) {
$dom[($dom[($dom[$key]['parent'])]['parent'])]['thead'] = $csstagarray .
 $a[$dom[($dom[($dom[$key]['parent'])]['parent'])]['elkey']];
}
...
if (($dom[$key]['value'] == 'table') and
 (! TCPDF_STATIC::empty_string($dom[($dom[$key]['parent'])]['thead']))) {
...
$dom[$key]['parent'] = end($level);
if ((substr($element, - 1, 1) == '/') or
 (in_array($dom[$key]['value'], $selfclosingtags))) {
// self-closing tag
$dom[$key]['self'] = true;
} else {
// opening tag
...
// get attributes
preg_match_all('/([^=\s]*)[\s]*=[\s]*"([^"]*)"/', $element, $attr_array, 
PREG_PATTERN_ORDER);
...
list ($dom[$key]['csssel'], $dom[$key]['cssdata']) = TCPDF_STATIC::getCSSdataArray(
$dom, $key, $css);
$dom[$key]['attribute']['style'] = TCPDF_STATIC::getTagStyleFromCSSarray(
$dom[$key]['cssdata']);
}
// split style attributes
if (isset($dom[$key]['attribute']['style']) and
 ! empty($dom[$key]['attribute']['style'])) {
// get style attributes
preg_match_all('/([^;:\s]*):([^;]*)/', $dom[$key]['attribute']['style'], 
$style_array, PREG_PATTERN_ORDER);
...
$dom[$key]['fontname'] = $this->getFontFamilyName(
$dom[$key]['style']['font-family']);
}
// list-style-type
if (isset($dom[$key]['style']['list-style-type'])) {
$dom[$key]['listtype'] = trim(
strtolower($dom[$key]['style']['list-style-type']));
...
$dom[$key]['text-indent'] = $this->getHTMLUnitToUnits(
$dom[$key]['style']['text-indent']);
...
$dom[$key]['font-stretch'] = $this->getCSSFontStretching(
$dom[$key]['style']['font-stretch'], $dom[$parentkey]['font-stretch']);
}
// letter-spacing
if (isset($dom[$key]['style']['letter-spacing'])) {
$dom[$key]['letter-spacing'] = $this->getCSSFontSpacing(
$dom[$key]['style']['letter-spacing'], $dom[$parentkey]['letter-spacing']);
}
...
$dom[$key]['line-height'] = (($dom[$key]['line-height'] -
...
if (isset($dom[$key]['style']['color']) and
 (! TCPDF_STATIC::empty_string($dom[$key]['style']['color']))) {
$dom[$key]['fgcolor'] = TCPDF_COLORS::convertHTMLColorToDec(
$dom[$key]['style']['color'], $this->spot_colors);
} elseif ($dom[$key]['value'] == 'a') {
$dom[$key]['fgcolor'] = $this->htmlLinkColorArray;
}
// background color
if (isset($dom[$key]['style']['background-color']) and
 (! TCPDF_STATIC::empty_string($dom[$key]['style']['background-color']))) {
$dom[$key]['bgcolor'] = TCPDF_COLORS::convertHTMLColorToDec(
$dom[$key]['style']['background-color'], $this->spot_colors);
}
// text-decoration
...
$dom[$key]['border']['L']['color'] = TCPDF_COLORS::convertHTMLColorToDec(
$brd_colors[3], $this->spot_colors);
}
if (isset($brd_colors[1])) {
$dom[$key]['border']['R']['color'] = TCPDF_COLORS::convertHTMLColorToDec(
$brd_colors[1], $this->spot_colors);
}
if (isset($brd_colors[0])) {
$dom[$key]['border']['T']['color'] = TCPDF_COLORS::convertHTMLColorToDec(
$brd_colors[0], $this->spot_colors);
}
if (isset($brd_colors[2])) {
$dom[$key]['border']['B']['color'] = TCPDF_COLORS::convertHTMLColorToDec(
$brd_colors[2], $this->spot_colors);
}
}
...
$dom[$key]['border'][$bsk]['color'] = TCPDF_COLORS::convertHTMLColorToDec(
$dom[$key]['style']['border-' . $bsv . '-color'], $this->spot_colors);
}
if (isset($dom[$key]['style']['border-' . $bsv . '-width'])) {
$dom[$key]['border'][$bsk]['width'] = $this->getCSSBorderWidth(
$dom[$key]['style']['border-' . $bsv . '-width']);
}
if (isset($dom[$key]['style']['border-' . $bsv . '-style'])) {
$dom[$key]['border'][$bsk]['dash'] = $this->getCSSBorderDashStyle(
...
$dom[$key]['padding'][$psk] = $this->getHTMLUnitToUnits(
$dom[$key]['style']['padding-' . $psv], 0, 'px', false);
}
}
...
$dom[$key]['margin'][$psk] = $this->getHTMLUnitToUnits(
str_replace('auto', '0', $dom[$key]['style']['margin-' . $psv]), 0, 'px', false);
}
}
...
$dom[$key]['hide'] = (trim(strtolower($dom[$key]['attribute']['display'])) ==
 'none');
}
if (isset($dom[$key]['attribute']['border']) and
 ($dom[$key]['attribute']['border'] != 0)) {
$borderstyle = $this->getCSSBorderStyle(
$dom[$key]['attribute']['border'] . ' solid black');
if (! empty($borderstyle)) {
$dom[$key]['border']['LTRB'] = $borderstyle;
}
}
...
if ((($dom[$key]['value'] == 'ul') or ($dom[$key]['value'] == 'ol') or
 ($dom[$key]['value'] == 'dl')) and (! isset($dom[$key]['align']) or TCPDF_STATIC::empty_string(
$dom[$key]['align']) or ($dom[$key]['align'] != 'J'))) {
if ($this->rtl) {
$dom[$key]['align'] = 'R';
} else {
$dom[$key]['align'] = 'L';
...
if (($dom[$key]['value'] == 'small') or ($dom[$key]['value'] == 'sup') or
 ($dom[$key]['value'] == 'sub')) {
if (! isset($dom[$key]['attribute']['size']) and
...
if (! isset($dom[$key]['style']['text-decoration']) and
 ($dom[$key]['value'] == 'a')) {
$dom[$key]['fontstyle'] = $this->htmlLinkFontStyle;
}
...
if (! empty($dom[$key]['value']) and ($dom[$key]['value'][0] == 'h') and
 (intval($dom[$key]['value']{1}) > 0) and (intval($dom[$key]['value']{1}) < 7)) {
...
if (isset($dom[$key]['attribute']['color']) and
 (! TCPDF_STATIC::empty_string($dom[$key]['attribute']['color']))) {
$dom[$key]['fgcolor'] = TCPDF_COLORS::convertHTMLColorToDec(
$dom[$key]['attribute']['color'], $this->spot_colors);
} elseif (! isset($dom[$key]['style']['color']) and ($dom[$key]['value'] == 'a')) {
$dom[$key]['fgcolor'] = $this->htmlLinkColorArray;
}
// set background color attribute
if (isset($dom[$key]['attribute']['bgcolor']) and
 (! TCPDF_STATIC::empty_string($dom[$key]['attribute']['bgcolor']))) {
$dom[$key]['bgcolor'] = TCPDF_COLORS::convertHTMLColorToDec(
$dom[$key]['attribute']['bgcolor'], $this->spot_colors);
}
// set stroke color attribute
if (isset($dom[$key]['attribute']['strokecolor']) and
 (! TCPDF_STATIC::empty_string($dom[$key]['attribute']['strokecolor']))) {
$dom[$key]['strokecolor'] = TCPDF_COLORS::convertHTMLColorToDec(
$dom[$key]['attribute']['strokecolor'], $this->spot_colors);
}
// check for width attribute
...
if (isset($dom[$key]['attribute']['align']) and
 (! TCPDF_STATIC::empty_string($dom[$key]['attribute']['align'])) and
 ($dom[$key]['value'] !== 'img')) {
...
// font stroke width
$dom[$key]['stroke'] = $this->getHTMLUnitToUnits(
$dom[$key]['attribute']['stroke'], $dom[$key]['fontsize'], 'pt', true);
}
...
// text-transform for unicode requires mb_convert_case (Multibyte String
// Functions)
...
$element = mb_convert_case($element, 
$ttm[$dom[$dom[$key]['parent']]['text-transform']], $this->encoding);
}
...
/**
 * Return an hash code used to ensure that the serialized data has been
 * generated by this TCPDF instance.
 *
 ...
 * @return string containing serialized data @public static
 */
 ...
 *
 * @param $data (string) serialized data
 * @return array containing unserialized data @protected static
 */
...
/**
 * Prints a cell (rectangular area) with optional borders, background color and
 * html text string. The upper-left corner of the cell corresponds to the
 * current position. After the call, the current position moves to the right or
 * to the next line.<br /> If automatic page breaking is enabled and the cell
 * goes beyond the limit, a page break is done before outputting. IMPORTANT: The
 * HTML must be well formatted - try to clean-up it using an application like
 * HTML-Tidy before submitting. Supported tags are: a, b, blockquote, br, dd,
 * del, div, dl, dt, em, font, h1, h2, h3, h4, h5, h6, hr, i, img, li, ol, p,
 * pre, small, span, strong, sub, sup, table, tcpdf, td, th, thead, tr, tt, u,
 * ul NOTE: all the HTML attributes must be enclosed in double-quote.
 *
 * @param $w (float) Cell width. If 0, the cell extends up to the right margin.
 * @param $h (float) Cell minimum height. The cell extends automatically if
 *            needed.
 ...
 * @param $reseth (boolean) if true reset the last cell height (default true).
 * @param $align (string) Allows to center or align the text. Possible values
 *            are:<ul><li>L : left align</li><li>C : center</li><li>R : right
 *            align</li><li>'' : empty string : left for LTR or right for
 *            RTL</li></ul>
 * @param $autopadding (boolean) if true, uses internal padding and
 *            automatically adjust it to account for line width.
 * @see Multicell(), writeHTML() @public
 */
public function writeHTMLCell($w, $h, $x, $y, $html = '', $border = 0, $ln = 0, 
$fill = false, $reseth = true, $align = '', $autopadding = true) {
return $this->MultiCell($w, $h, $html, $border, $align, $fill, $ln, $x, $y, 
$reseth, 0, true, $autopadding, 0, 'T', false);
}

/**
 * Allows to preserve some HTML formatting (limited support).<br /> IMPORTANT:
 * The HTML must be well formatted - try to clean-up it using an application
 * like HTML-Tidy before submitting. Supported tags are: a, b, blockquote, br,
 * dd, del, div, dl, dt, em, font, h1, h2, h3, h4, h5, h6, hr, i, img, li, ol,
 * p, pre, small, span, strong, sub, sup, table, tcpdf, td, th, thead, tr, tt,
 * u, ul NOTE: all the HTML attributes must be enclosed in double-quote.
 *
 ...
 *            RTL</li></ul> @public
 */
public function writeHTML($html, $ln = true, $fill = false, $reseth = false, $cell = false, 
$align = '') {
$gvars = $this->getGraphicVars();
// store current values
$prev_cell_margin = $this->cell_margin;
...
$curfontdescent = $this->getFontDescent($curfontname, $curfontstyle, 
$curfontsize);
...
while (($key < $maxel) and (! $dom[$key]['tag'] or $dom[$key]['opening'] or
...
// check for pagebreak
if (($dom[$key]['attribute']['pagebreak'] == 'true') or
 ($dom[$key]['attribute']['pagebreak'] == 'left') or
 ($dom[$key]['attribute']['pagebreak'] == 'right')) {
// add a page (or trig AcceptPageBreak() for multicolumn mode)
$this->checkPageBreak($this->PageBreakTrigger + 1);
$this->htmlvspace = ($this->PageBreakTrigger + 1);
}
if ((($dom[$key]['attribute']['pagebreak'] == 'left') and (((! $this->rtl) and
 (($this->page % 2) == 0)) or (($this->rtl) and (($this->page % 2) != 0)))) or (($dom[$key]['attribute']['pagebreak'] ==
 'right') and (((! $this->rtl) and (($this->page % 2) != 0)) or
...
if ($dom[$key]['tag'] and $dom[$key]['opening'] and
 isset($dom[$key]['attribute']['nobr']) and
 ($dom[$key]['attribute']['nobr'] == 'true')) {
...
// print THEAD block
if (($dom[$key]['value'] == 'tr') and isset($dom[$key]['thead']) and
 $dom[$key]['thead']) {
...
if (($this->y < $this->start_transaction_y) or
 ($this->checkPageBreak($this->lasth, '', false))) {
// we are on a new page or on a new column and the total object height is less
// than the available vertical space.
...
// add a page (or trig AcceptPageBreak() for multicolumn mode)
$pre_y = $this->y;
if ((! $this->checkPageBreak($this->PageBreakTrigger + 1)) and
 ($this->y < $pre_y)) {
...
$tmp_cellspacing = $this->getHTMLUnitToUnits(
$dom[$dom[$key]['parent']]['attribute']['cellspacing'], 1, 'px');
...
while (($key < $maxel) and (! (($dom[$key]['tag'] and $dom[$key]['opening'] and
 ($dom[$key]['value'] == 'tr') and
 (! isset($dom[$key]['thead']) or ! $dom[$key]['thead'])) or ($dom[$key]['tag'] and
 (! $dom[$key]['opening']) and ($dom[$key]['value'] == 'table'))))) {
++ $key;
}
}
...
if ((! $this->newline) and ($dom[$key]['value'] == 'img') and
 (isset($dom[$key]['height'])) and ($dom[$key]['height'] > 0)) {
// get image height
$imgh = $this->getHTMLUnitToUnits($dom[$key]['height'], 
($dom[$key]['fontsize'] / $this->k), 'px');
$autolinebreak = false;
if (! empty($dom[$key]['width'])) {
$imgw = $this->getHTMLUnitToUnits($dom[$key]['width'], 
($dom[$key]['fontsize'] / $this->k), 'px', false);
if (($imgw <= ($this->w - $this->lMargin - $this->rMargin -
 $this->cell_padding['L'] - $this->cell_padding['R'])) and
 ((($this->rtl) and
 (($this->x - $imgw) < ($this->lMargin + $this->cell_padding['L']))) or
 ((! $this->rtl) and
 (($this->x + $imgw) > ($this->w - $this->rMargin - $this->cell_padding['R']))))) {
...
$this->y += ($this->getCellHeight($curfontsize / $this->k) -
 ($curfontdescent * $this->cell_height_ratio) - $imgh);
$minstartliney = min($this->y, $minstartliney);
$maxbottomliney = ($startliney + $this->getCellHeight($curfontsize / $this->k));
}
} elseif (isset($dom[$key]['fontname']) or isset($dom[$key]['fontstyle']) or
 isset($dom[$key]['fontsize']) or isset($dom[$key]['line-height'])) {
...
if (($fontname != $curfontname) or ($fontstyle != $curfontstyle) or
 ($fontsize != $curfontsize) or
 ($this->cell_height_ratio != $dom[$key]['line-height']) or
 ($dom[$key]['tag'] and $dom[$key]['opening'] and ($dom[$key]['value'] == 'li'))) {
if (($key < ($maxel - 1)) and (($dom[$key]['tag'] and $dom[$key]['opening'] and
 ($dom[$key]['value'] == 'li')) or
 ($this->cell_height_ratio != $dom[$key]['line-height']) or (! $this->newline and
 is_numeric($fontsize) and is_numeric($curfontsize) and ($fontsize >= 0) and
 ($curfontsize >= 0) and (($fontsize != $curfontsize) or
...
if (! $dom[$key]['block']) {
if (! (isset($dom[($key + 1)]) and $dom[($key + 1)]['tag'] and
 (! $dom[($key + 1)]['opening']) and ($dom[($key + 1)]['value'] != 'li') and
 $dom[$key]['tag'] and (! $dom[$key]['opening']))) {
$this->y += (((($curfontsize * $this->cell_height_ratio) -
...
$minstartliney, 
$maxbottomliney);
if (isset($line_align_data) and (($line_align_data[0] == ($key - 1)) or (($line_align_data[0] ==
 ($key - 2)) and (isset($dom[($key - 1)])) and
 (preg_match('/^([\s]+)$/', $dom[($key - 1)]['value']) > 0)))) {
$minstartliney = min($this->y, $line_align_data[1]);
$maxbottomliney = max(($this->y + $this->getCellHeight($fontsize / $this->k)), 
$line_align_data[2]);
} else {
$minstartliney = min($this->y, $minstartliney);
$maxbottomliney = max(($this->y + $this->getCellHeight($fontsize / $this->k)), 
...
$textfill = isset($dom[$key]['fill']) ? $dom[$key]['fill'] : (($this->textrendermode %
 2) == 0);
$textclip = isset($dom[$key]['clip']) ? $dom[$key]['clip'] : ($this->textrendermode >
 3);
...
if (isset($dom[$key]['letter-spacing']) and
 ($dom[$key]['letter-spacing'] !== false)) {
...
// align lines
if ($this->newline and (strlen($dom[$key]['value']) > 0) and
 ($dom[$key]['value'] != 'td') and ($dom[$key]['value'] != 'th')) {
$newline = true;
$fontaligned = false;
...
if ((isset($plalign) and
 ((($plalign == 'C') or ($plalign == 'J') or
 (($plalign == 'R') and (! $this->rtl)) or (($plalign == 'L') and ($this->rtl)))))) {
...
$spacewidthu = - 1000 * ($mdiff + (($ns + $no) * $one_space_width)) / $ns /
 $this->FontSize;
if ($this->font_spacing != 0) {
// fixed spacing mode
...
preg_match(
'/([0-9\.\+\-]*)[\s](' . $strpiece[1][0] . ')[\s](' . $strpiece[2][0] .
 ')([\s]*)/x', $pmid, $xmatches);
if (! isset($xmatches[1])) {
break;
}
...
'/([0-9\.\+\-]*)[\s](' . $strpiece[1][0] . ')[\s](' . $strpiece[2][0] .
 ')([\s]*)/x', $pmid, $pmatch) == 1) {
$newpmid = sprintf('%F', (floatval($pmatch[1]) + $spacew)) . ' ' . $pmatch[2] .
...
if (preg_match(
'/(' . $xmatches[1] . ')[\s](' . $xmatches[2] . ')[\s](' . $xmatches[3] .
 ')[\s](' . $strpiece[1][0] . ')[\s](re)([\s]*)/x', $pmid, $pmatch) == 1) {
$newx = sprintf('%F', (floatval($pmatch[1]) + $x_diff));
$neww = sprintf('%F', (floatval($pmatch[3]) + $w_diff));
$newpmid = $newx . ' ' . $pmatch[2] . ' ' . $neww . ' ' . $pmatch[4] . ' x*#!#*x' .
 $pmatch[5] . $pmatch[6];
$pmid = str_replace($pmatch[0], $newpmid, $pmid);
...
if (preg_match(
'/(' . $xmatches[1] . ')[\s](' . $xmatches[2] . ')[\s](' . $xmatches[3] .
 ')[\s](' . $xmatches[4] . ')[\s](' . $xmatches[5] . ')[\s](' . $strpiece[1][0] .
...
$newpmid = $newx1 . ' ' . $pmatch[2] . ' ' . $newx2 . ' ' . $pmatch[4] . ' ' .
 $newx3 . ' ' . $pmatch[6] . ' x*#!#*x' . $pmatch[7] . $pmatch[8];
$pmid = str_replace($pmatch[0], $newpmid, $pmid);
...
if (($pac['y'] >= $minstartliney) and
 (($pac['x'] * $this->k) >= ($currentxpos - $this->feps)) and
 (($pac['x'] * $this->k) <= ($currentxpos + $this->feps))) {
if ($cxpos > $lmpos) {
$this->xobjects[$this->xobjid]['annotations'][$pak]['x'] += ($spacew / $this->k);
$this->xobjects[$this->xobjid]['annotations'][$pak]['w'] += (($spacewidth *
 $pac['numspaces']) / $this->k);
} else {
$this->xobjects[$this->xobjid]['annotations'][$pak]['w'] += (($spacewidth *
 $pac['numspaces']) / $this->k);
}
...
$this->PageAnnots[$this->page][$pak]['w'] += (($spacewidth * $pac['numspaces']) /
 $this->k);
} else {
$this->PageAnnots[$this->page][$pak]['w'] += (($spacewidth * $pac['numspaces']) /
 $this->k);
...
$newpmid = '[(' .
 str_replace(chr(0) . chr(32), ') ' . sprintf('%F', $spacew) . ' (', $replace) .
 ')]';
...
if (! ($dom[$key]['tag'] and ! $dom[$key]['opening'] and
 ($dom[$key]['value'] == 'table') and (isset($this->emptypagemrk[$this->page])) and
 ($this->emptypagemrk[$this->page] == $this->pagelen[$this->page]))) {
$this->SetFont($fontname, $fontstyle, $fontsize);
if ($wfill) {
...
// table
if (($dom[$key]['value'] == 'table') and isset($dom[$key]['cols']) and
 ($dom[$key]['cols'] > 0)) {
...
$clsp = $this->getHTMLUnitToUnits($dom[$key]['attribute']['cellspacing'], 1, 
'px');
$cellspacing = array(
'H' => $clsp, 
'V' => $clsp);
...
$table_columns_width = ($table_width -
 ($cellspacing['H'] * ($dom[$key]['cols'] - 1)));
...
$crclpd = $this->getHTMLUnitToUnits(
$dom[($dom[$trid]['parent'])]['attribute']['cellpadding'], 1, 'px');
...
$parentid = $key;
while (($key < $maxel) and
 (! (($dom[$key]['tag']) and (! $dom[$key]['opening']) and
...
$dl = ($this->pagedim[$this->page]['orm'] -
 $this->pagedim[$trwsp['startpage']]['orm']);
$rsstartx -= $dl;
$rsendx -= $dl;
} elseif ((! $this->rtl) and ($this->pagedim[$this->page]['olm'] !=
 $this->pagedim[$trwsp['startpage']]['olm'])) {
$dl = ($this->pagedim[$this->page]['olm'] -
 $this->pagedim[$trwsp['startpage']]['olm']);
$rsstartx += $dl;
$rsendx += $dl;
}
}
if (($trwsp['rowspan'] > 0) and
 ($rsstartx >
 ($this->x - $cellspacing['H'] - $current_cell_padding['L'] - $this->feps)) and
 ($rsstartx <
 ($this->x + $cellspacing['H'] + $current_cell_padding['R'] + $this->feps)) and (($trwsp['starty'] <
 ($this->y - $this->feps)) or ($trwsp['startpage'] < $this->page) or
 ($trwsp['startcolumn'] < $this->current_column))) {
// set the starting X position of the current cell
$this->x = $rsendx + $cellspacingx;
// increment column indicator
$colid += $trwsp['colspan'];
if (($trwsp['rowspan'] == 1) and (isset($dom[$trid]['endy'])) and
 (isset($dom[$trid]['endpage'])) and (isset($dom[$trid]['endcolumn'])) and
 ($trwsp['endpage'] == $dom[$trid]['endpage']) and
...
$cellw = $this->getHTMLUnitToUnits($dom[$parentid]['width'], 
$table_columns_width, 'px');
$tmpcw = ($cellw / $colspan);
for ($i = 0; $i < $colspan; ++ $i) {
...
$this->MultiCell($cellw, $cellh, $cell_content, false, $lalign, false, 2, '', 
...
if (($this->page == $dom[$trid]['endpage']) and
 ($this->current_column == $dom[$trid]['endcolumn'])) {
$dom[$trid]['endy'] = max($this->y, $dom[$trid]['endy']);
} elseif (($this->page > $dom[$trid]['endpage']) or
 ($this->current_column > $dom[$trid]['endcolumn'])) {
...
$trwsp['endy']);
} elseif (($trwsp['endpage'] < $dom[$trid]['endpage']) or
 ($trwsp['endcolumn'] < $dom[$trid]['endcolumn'])) {
...
$this->y += ($this->getCellHeight(($pfontsize - $curfontsize) / $this->k) +
 $pfontascent - $curfontascent - $pfontdescent + $curfontdescent) / 2;
$minstartliney = min($this->y, $minstartliney);
$maxbottomliney = max(($this->y + $this->getCellHeight($pfontsize / $this->k)), 
$maxbottomliney);
}
}
// text
...
$lsp = ''; // left spaces
$rsp = ''; // right spaces
if (preg_match('/^(' . $this->re_space['p'] . '+)/' . $this->re_space['m'], 
$dom[$key]['value'], $matches)) {
$lsp = $matches[1];
}
if (preg_match('/(' . $this->re_space['p'] . '+)$/' . $this->re_space['m'], 
$dom[$key]['value'], $matches)) {
...
$dom[$key]['value'] = preg_replace(
'/^' . $this->re_space['p'] . '+$/' . $this->re_space['m'], chr(32), 
$dom[$key]['value']);
}
$strrest = '';
if ($this->rtl) {
...
$strrest = $this->addHtmlLink($this->HREF['url'], $dom[$key]['value'], $wfill, 
true, $hrefcolor, $hrefstyle, true);
} else {
...
if (($strlinelen < $cwa) and (isset($dom[($key + 1)])) and
 ($dom[($key + 1)]['tag']) and (! $dom[($key + 1)]['block'])) {
...
$nextstr = TCPDF_STATIC::pregSplit('/' . $this->re_space['p'] . '+/', 
$this->re_space['m'], $dom[$nkey]['value']);
if (isset($nextstr[0]) and $same_textdir) {
$wadj += $this->GetStringWidth($nextstr[0], $tmp_fontname, $tmp_fontstyle, 
$tmp_fontsize);
if (isset($nextstr[1])) {
$write_block = false;
}
...
$reverse_dir = true;
$this->rtl = ! $this->rtl;
$revshift = ($strlinelen + $wadj + 0.000001); // add little quantity for
                                              // rounding problems
if ($this->rtl) {
$this->x += $revshift;
} else {
...
$strrest = $this->Write($this->lasth, $dom[$key]['value'], '', $wfill, '', 
false, 0, true, $firstblock, 0, $wadj);
...
++ $key;
if (isset($dom[$key]['tag']) and $dom[$key]['tag'] and
 (! isset($dom[$key]['opening']) or ! $dom[$key]['opening']) and
 isset($dom[($dom[$key]['parent'])]['attribute']['nobr']) and
 ($dom[($dom[$key]['parent'])]['attribute']['nobr'] == 'true')) {
// check if we are on a new page or on a new column
if ((! $undo) and (($this->y < $this->start_transaction_y) or (($dom[$key]['value'] ==
 'tr') and ($dom[($dom[$key]['parent'])]['endy'] < $this->start_transaction_y)))) {
// we are on a new page or on a new column and the total object height is less
// than the available vertical space.
// restore previous object
$this->rollbackTransaction(true);
...
if ((isset($plalign) and ((($plalign == 'C') or
 (($plalign == 'R') and (! $this->rtl)) or (($plalign == 'L') and ($this->rtl)))))) {
// calculate shifting amount
$tw = $w;
if ($this->lMargin != $prevlMargin) {
 ...
 * @param $cell (boolean) if true add the default left (or right if RTL) padding
 *            to each new line (default false).
 * @return $dom array @protected
 */
...
if (isset($this->tagvspaces[$tag['value']][0]['h']) and
 ($this->tagvspaces[$tag['value']][0]['h'] >= 0)) {
...
$hbc = 0;
if (isset($this->tagvspaces[$tag['value']][1]['h']) and
 ($this->tagvspaces[$tag['value']][1]['h'] >= 0)) {
...
if (! isset($dom[$key]['attribute']['nested']) or
 ($dom[$key]['attribute']['nested'] != 'true')) {
$this->htmlvspace = 0;
// set table header
...
$prev_y = $this->y;
if ($this->checkPageBreak(((2 * $cp) + (2 * $cs) + $this->lasth), '', false) or
 ($this->y < $prev_y)) {
$this->inthead = true;
// add a page (or trig AcceptPageBreak() for multicolumn mode)
$this->checkPageBreak($this->PageBreakTrigger + 1);
...
$this->addHTMLVertSpace(max($hbc, ($hrHeight / 2)), 0, $cell, 
! isset($dom[($key + 1)]));
break;
}
case 'a':
...
// data stream
$tag['attribute']['src'] = '@' .
 base64_decode(substr($tag['attribute']['src'], 1));
$type = '';
} else {
// get image type
...
if (isset($this->HREF['url']) and
 ! TCPDF_STATIC::empty_string($this->HREF['url'])) {
...
$iw = '';
if (isset($tag['width'])) {
$iw = $this->getHTMLUnitToUnits($tag['width'], ($tag['fontsize'] / $this->k), 
'px', false);
}
$ih = '';
if (isset($tag['height'])) {
$ih = $this->getHTMLUnitToUnits($tag['height'], ($tag['fontsize'] / $this->k), 
'px', false);
}
if (($type == 'eps') or ($type == 'ai')) {
$this->ImageEps($tag['attribute']['src'], $xpos, $this->y, $iw, $ih, $imglink, 
true, $align, '', $border, true);
} elseif ($type == 'svg') {
$this->ImageSVG($tag['attribute']['src'], $xpos, $this->y, $iw, $ih, $imglink, 
$align, '', $border, true);
} else {
$this->Image($tag['attribute']['src'], $xpos, $this->y, $iw, $ih, '', $imglink, 
$align, false, 300, '', false, false, $border, false, false, true);
}
switch ($align) {
case 'T':
{
...
case 'M':
{
$this->y = (($this->img_rb_y + $prevy -
 ($this->getCellHeight($tag['fontsize'] / $this->k))) / 2);
break;
}
case 'B':
{
$this->y = $this->img_rb_y - ($this->getCellHeight($tag['fontsize'] / $this->k) - ($this->getFontDescent(
$tag['fontname'], $tag['fontstyle'], $tag['fontsize']) * $this->cell_height_ratio));
break;
}
}
}
...
if (isset($parent['attribute']['type']) and
 ! TCPDF_STATIC::empty_string($parent['attribute']['type'])) {
$this->lispacer = $parent['attribute']['type'];
} elseif (isset($parent['listtype']) and
 ! TCPDF_STATIC::empty_string($parent['listtype'])) {
$this->lispacer = $parent['listtype'];
} elseif (isset($this->lisymbol) and
 ! TCPDF_STATIC::empty_string($this->lisymbol)) {
...
$this->GetY() - ((0.7 * $this->FontSizePt) / $this->k));
break;
}
case 'sub':
{
$this->SetXY($this->GetX(), 
$this->GetY() + ((0.3 * $this->FontSizePt) / $this->k));
break;
}
case 'h1':
case 'h2':
...
if (isset($tag['attribute']['name']) and
 ! TCPDF_STATIC::empty_string($tag['attribute']['name'])) {
...
if (isset($tag['attribute']['readonly']) and
 ! TCPDF_STATIC::empty_string($tag['attribute']['readonly'])) {
$prop['readonly'] = true;
}
if (isset($tag['attribute']['value']) and
 ! TCPDF_STATIC::empty_string($tag['attribute']['value'])) {
$value = $tag['attribute']['value'];
}
if (isset($tag['attribute']['maxlength']) and
 ! TCPDF_STATIC::empty_string($tag['attribute']['maxlength'])) {
$opt['maxlen'] = intval($tag['attribute']['maxlength']);
}
$h = $this->getCellHeight($this->FontSize);
if (isset($tag['attribute']['size']) and
 ! TCPDF_STATIC::empty_string($tag['attribute']['size'])) {
$w = intval($tag['attribute']['size']) * $this->GetStringWidth(chr(32)) * 2;
} else {
$w = $h;
}
if (isset($tag['attribute']['checked']) and (($tag['attribute']['checked'] ==
 'checked') or ($tag['attribute']['checked'] == 'true'))) {
$checked = true;
} else {
$checked = false;
}
...
$this->Button('FB_' . $name, $w, $h, $value, $jsaction, $prop, $opt, '', '', 
false);
break;
}
case 'hidden':
...
if (isset($tag['attribute']['src']) and
 ! TCPDF_STATIC::empty_string($tag['attribute']['src'])) {
$img = $tag['attribute']['src'];
} else {
break;
}
$value = 'img';
// $opt['mk'] = array('i'=>$img, 'tp'=>1, 'if'=>array('sw'=>'A', 's'=>'A',
// 'fb'=>false));
if (isset($tag['attribute']['onclick']) and ! empty(
...
if (isset($tag['attribute']['cols']) and
 ! TCPDF_STATIC::empty_string($tag['attribute']['cols'])) {
$w = intval($tag['attribute']['cols']) * $this->GetStringWidth(chr(32)) * 2;
} else {
$w = 40;
}
if (isset($tag['attribute']['rows']) and
 ! TCPDF_STATIC::empty_string($tag['attribute']['rows'])) {
...
if (isset($tag['attribute']['opt']) and
 ! TCPDF_STATIC::empty_string($tag['attribute']['opt'])) {
...
$w *= 2;
if (isset($tag['attribute']['multiple']) and
...
if ((($pba == 'left') and (((! $this->rtl) and (($this->page % 2) == 0)) or
 (($this->rtl) and (($this->page % 2) != 0)))) or (($pba == 'right') and (((! $this->rtl) and
 (($this->page % 2) != 0)) or (($this->rtl) and (($this->page % 2) == 0))))) {
// add a page (or trig AcceptPageBreak() for multicolumn mode)
$this->checkPageBreak($this->PageBreakTrigger + 1);
}
}
...
$tag = $dom[$key];
$parent = $dom[($dom[$key]['parent'])];
$lasttag = ((! isset($dom[($key + 1)])) or
 ((! isset($dom[($key + 2)])) and ($dom[($key + 1)]['value'] == 'marker')));
$in_table_head = false;
...
if (($dom[$table_el]['rowspans'][$k]['endpage'] == $parent['endpage']) and
 ($dom[$table_el]['rowspans'][$k]['endcolumn'] == $parent['endcolumn'])) {
$dom[($dom[$key]['parent'])]['endy'] = max(
$dom[$table_el]['rowspans'][$k]['endy'], $parent['endy']);
} elseif (($dom[$table_el]['rowspans'][$k]['endpage'] > $parent['endpage']) or
 ($dom[$table_el]['rowspans'][$k]['endcolumn'] > $parent['endcolumn'])) {
...
foreach ($dom[$table_el]['rowspans'] as $k => $trwsp) {
if ($dom[$table_el]['rowspans'][$k]['rowspan'] == 0) {
$dom[$table_el]['rowspans'][$k]['endpage'] = max(
$dom[$table_el]['rowspans'][$k]['endpage'], 
$dom[($dom[$key]['parent'])]['endpage']);
$dom[($dom[$key]['parent'])]['endpage'] = $dom[$table_el]['rowspans'][$k]['endpage'];
$dom[$table_el]['rowspans'][$k]['endcolumn'] = max(
$dom[$table_el]['rowspans'][$k]['endcolumn'], 
$dom[($dom[$key]['parent'])]['endcolumn']);
$dom[($dom[$key]['parent'])]['endcolumn'] = $dom[$table_el]['rowspans'][$k]['endcolumn'];
$dom[$table_el]['rowspans'][$k]['endy'] = max(
...
if ($this->num_columns > 1) {
if ((($this->current_column == 0) and
 ($dom[($dom[$key]['parent'])]['endcolumn'] == ($this->num_columns - 1))) or (($this->current_column ==
...
$this->y += $this->getHTMLUnitToUnits(
$dom[$table_el]['attribute']['cellspacing'], 1, 'px');
...
$this->x += ($this->pagedim[$this->page]['olm'] -
 $this->pagedim[$parent['startpage']]['olm']);
}
}
break;
...
$table_el = $parent;
// set default border
if (isset($table_el['attribute']['border']) and
 ($table_el['attribute']['border'] > 0)) {
// set default border
$border = array(
'LTRB' => array(
...
if (isset($prevtrkey) and ($trwsp['trid'] == $prevtrkey) and
 ($trwsp['mrowspan'] > 0)) {
...
if (isset($prevtrkey) and
 ($dom[$trkey]['startpage'] > $dom[$prevtrkey]['endpage'])) {
...
if (isset($dom[($dom[$key]['parent'])]['rowspans'])) {
foreach ($dom[($dom[$key]['parent'])]['rowspans'] as $k => $trwsp) {
if (($trwsp['trid'] == $prevtrkey) and ($trwsp['mrowspan'] >= 0) and
 ($trwsp['endpage'] == $dom[$prevtrkey]['endpage'])) {
...
$this->y += $this->getHTMLUnitToUnits($table_el['attribute']['cellspacing'], 1, 
'px');
...
if (($this->rtl) and
 ($this->pagedim[$endpage]['orm'] != $this->pagedim[$startpage]['orm'])) {
$this->x += ($this->pagedim[$endpage]['orm'] - $this->pagedim[$startpage]['orm']);
} elseif ((! $this->rtl) and
 ($this->pagedim[$endpage]['olm'] != $this->pagedim[$startpage]['olm'])) {
...
$plendiff = ($this->pagelen[$this->numpages] -
 $this->emptypagemrk[$this->numpages]);
if (($plendiff > 0) and ($plendiff < 60)) {
$pagediff = substr($this->getPageBuffer($this->numpages), 
$this->emptypagemrk[$this->numpages], $plendiff);
...
if (! isset($table_el['attribute']['nested']) or
 ($table_el['attribute']['nested'] != 'true')) {
...
{
$this->SetXY($this->GetX(), 
$this->GetY() + ((0.7 * $parent['fontsize']) / $this->k));
break;
}
case 'sub':
{
$this->SetXY($this->GetX(), 
$this->GetY() - ((0.3 * $parent['fontsize']) / $this->k));
break;
}
case 'div':
{
 ...
 * @param $lasttag (boolean) set to true when the tag is the last. @protected
 */
protected function addHTMLVertSpace($hbz = 0, $hb = 0, $cell = false, $firsttag = false, 
$lasttag = false) {
if ($firsttag) {
$this->Ln(0, $cell);
$this->htmlvspace = 0;
 ...
 *
 * @return array containing top-left border coordinates @protected
 * @since 5.7.000 (2010-08-03)
 */
 ...
 * @param $xmax (int) end X coordinate for border. @protected
 * @since 5.7.000 (2010-08-03)
 */
...
$border = TCPDF_STATIC::getBorderMode($border, $position = 'middle', 
$this->opencell);
}
}
 ...
 *            = automatic, '!' = auto bullet, '#' = auto numbering, 'disc',
 *            'disc', 'circle', 'square', '1', 'decimal',
 *            'decimal-leading-zero', 'i', 'lower-roman', 'I', 'upper-roman',
 *            'a', 'lower-alpha', 'lower-latin', 'A', 'upper-alpha',
 ...
 * @param $outer (float) Outer page margin. @public
 * @since 4.2.000 (2008-10-29)
 */
 ...
 *
 * @param $reverse (boolean) if true swap left and right margins. @protected
 * @since 4.2.000 (2008-10-29)
 */
...
/**
 * Set the vertical spaces for HTML tags. The array must have the following
 * structure (example): $tagvs = array('h1' => array(0 => array('h' => '', 'n'
 * => 2), 1 => array('h' => 1.3, 'n' => 1))); The first array level contains the
 * tag names, the second level contains 0 for opening tags or 1 for closing
 * tags, the third level contains the vertical space unit (h) and the number
 * spaces to add (n). If the h parameter is not specified, default values are
 * used.
 *
 * @param $tagvs (array) array of tags and relative vertical spaces. @public
 * @since 4.2.001 (2008-10-30)
 */
 ...
 *
 * @param $width (float) width of the indentation. Use negative value to disable
 *            it. @public
 * @since 4.2.007 (2008-11-12)
 */
 ...
 *            cell sides that cross the page. @public
 * @since 4.2.010 (2008-11-14)
 */
 ...
 * @param $fontstyle (string) additional font styles to add @public
 * @since 4.4.003 (2008-12-09)
 */
 ...
 *            user's units.
 * @return float value in user's unit or point if $points=true @public
 * @since 4.4.004 (2008-12-10)
 */
public function getHTMLUnitToUnits($htmlval, $refsize = 1, $defaultunit = 'px', 
$points = false) {
 ...
 * @param $size (float) current font size @protected
 * @since 4.4.004 (2008-12-10)
 */
...
$this->Circle(($this->x + $r), ($this->y + ($this->lasth / 2)), $r, 0, 360, 'F', 
array(), $color, 8);
break;
}
case 'circle':
...
$prev_line_style = $this->linestyleWidth . ' ' . $this->linestyleCap . ' ' .
 $this->linestyleJoin . ' ' . $this->linestyleDash . ' ' . $this->DrawColor;
...
'phase' => 0, 
'color' => $color);
$this->Circle(($this->x + $r), ($this->y + ($this->lasth / 2)), 
($r * (1 - (1 / 6))), 0, 360, 'D', $new_line_style, array(), 8);
...
$this->Rect($this->x, ($this->y + (($this->lasth - $l) / 2)), $l, $l, 'F', 
array(), $color);
break;
}
case 'img':
...
case 'svg':
{
$this->ImageSVG($img[4], $this->x, ($this->y + (($this->lasth - $img[3]) / 2)), 
$img[2], $img[3], '', 'T', '', 0, false);
break;
}
case 'ai':
case 'eps':
{
$this->ImageEps($img[4], $this->x, ($this->y + (($this->lasth - $img[3]) / 2)), 
$img[2], $img[3], '', true, 'T', '', 0, false);
break;
}
default:
{
$this->Image($img[4], $this->x, ($this->y + (($this->lasth - $img[3]) / 2)), 
$img[2], $img[3], $img[1], '', 'T', false, 300, '', false, false, 0, false, 
false, false);
break;
}
}
...
{
$textitem = strtolower(
TCPDF_STATIC::intToRoman($this->listcount[$this->listnum]));
break;
}
case 'I':
case 'upper-roman':
...
case 'lower-greek':
{
$textitem = TCPDF_FONTS::unichr((945 + $this->listcount[$this->listnum] - 1), 
$this->isunicode);
break;
}
/*
 * // Types to be implemented (special handling) case 'hebrew': { break; } case
 * 'armenian': { break; } case 'georgian': { break; } case 'cjk-ideographic': {
 * break; } case 'hiragana': { break; } case 'katakana': { break; } case
 * 'hiragana-iroha': { break; } case 'katakana-iroha': { break; }
 */
default:
{
$textitem = $this->listcount[$this->listnum];
 ...
 *
 * @return array of graphic variables @protected
 * @since 4.2.010 (2008-11-14)
 */
...
/**
 * Outputs the "save graphics state" operator 'q' @protected
 */
...
/**
 * Outputs the "restore graphics state" operator 'Q' @protected
 */
 ...
 *
 * @param $data (string) data @protected
 * @since 4.5.000 (2009-01-02)
 */
 ...
 * Get buffer content.
 *
 * @return string buffer content @protected
 * @since 4.5.000 (2009-01-02)
 */
 ...
 * @param $append (boolean) if true append data, false replace. @protected
 * @since 4.5.000 (2008-12-31)
 */
 ...
 *
 * @param $page (int) page number
 * @return string page buffer content or false in case of error @protected
 * @since 4.5.000 (2008-12-31)
 */
 ...
 * @return int image index number @protected
 * @since 4.5.000 (2008-12-31)
 */
 ...
 * @param $data (array) image data @protected
 * @since 4.5.000 (2008-12-31)
 */
 ...
 *
 * @param $image (string) image key
 * @return string image buffer content or false in case of error @protected
 * @since 4.5.000 (2008-12-31)
 */
 ...
 * @param $data (array) font data @protected
 * @since 4.5.000 (2009-01-02)
 */
 ...
 *
 * @param $font (string) font key
 * @return string font buffer content or false in case of error @protected
 * @since 4.5.000 (2009-01-02)
 */
...
if (isset($this->newpagegroup[$i]) and
 (($i + $this->pagegroups[$this->newpagegroup[$i]]) > $frompage)) {
...
for ($i = $topage; $i > 0; -- $i) {
if (isset($this->newpagegroup[$i]) and
 (($i + $this->pagegroups[$this->newpagegroup[$i]]) > $topage)) {
++ $this->pagegroups[$this->newpagegroup[$i]];
break;
}
}
...
$jfrompage = $frompage;
$jtopage = $topage;
if (preg_match_all('/this\.addField\(\'([^\']*)\',\'([^\']*)\',([0-9]+)/', 
$this->javascript, $pamatch) > 0) {
foreach ($pamatch[0] as $pk => $pmatch) {
...
-- $newpage;
$newjs = "this.addField(\'" . $pamatch[1][$pk] . "\',\'" . $pamatch[2][$pk] .
 "\'," . $newpage;
...
for ($i = $page; $i > 0; -- $i) {
if (isset($this->newpagegroup[$i]) and
 (($i + $this->pagegroups[$this->newpagegroup[$i]]) > $page)) {
-- $this->pagegroups[$this->newpagegroup[$i]];
break;
}
}
...
/**
 * Output a Table of Content Index (TOC). This method must be called after all
 * Bookmarks were set. Before calling this method you have to open the page
 * using the addTOCPage() method. After calling this method you have to call
 * endTOCPage() to close the TOC page. You can override this method to achieve
 * different styles.
 *
 * @param $page (int) page number where this TOC should be inserted (leave empty
 *            for current page).
...
$this->Write(0, $txt, $link, false, $aligntext, false, 0, false, false, 0, 
$numwidth, '');
if ($this->rtl) {
...
$nu = TCPDF_FONTS::UTF8ToUTF16BE($na, false, $this->isunicode, 
$this->CurrentFont);
// replace aliases with numbers
foreach ($pnalias['u'] as $u) {
$sfill = str_repeat($filler, max(0, (strlen($u) - strlen($nu . ' '))));
if ($this->rtl) {
$nr = $nu . TCPDF_FONTS::UTF8ToUTF16BE(' ' . $sfill, false, $this->isunicode, 
$this->CurrentFont);
} else {
$nr = TCPDF_FONTS::UTF8ToUTF16BE($sfill . ' ', false, $this->isunicode, 
$this->CurrentFont) . $nu;
}
...
/**
 * Output a Table Of Content Index (TOC) using HTML templates. This method must
 * be called after all Bookmarks were set. Before calling this method you have
 * to open the page using the addTOCPage() method. After calling this method you
 * have to call endTOCPage() to close the TOC page.
 *
 * @param $page (int) page number where this TOC should be inserted (leave empty
 *            for current page).
 * @param $toc_name (string) name to use for TOC bookmark.
 ...
 * @param $correct_align (boolean) if true correct the number alignment (numbers
 *            must be in monospaced font like courier and right aligned on LTR,
 *            or left aligned on RTL)
 * @param $style (string) Font style for title: B = Bold, I = Italic, BI = Bold
 *            + Italic.
 ...
 */
public function addHTMLTOC($page = '', $toc_name = 'TOC', $templates = array(), 
$correct_align = true, $style = '', $color = array(0,0,0)) {
$filler = ' ';
...
$maxwidth = ($this->w - $this->original_lMargin - $this->original_rMargin) /
 $numcols;
...
$space = (($this->w - $this->original_lMargin - $this->original_rMargin -
...
/**
 * Remove columns and reset page margins. @public
 *
...
/**
 * Set columns array. Each column is represented by an array of arrays with the
 * following keys: (w = width, s = space between columns, y = column top
 * position).
 *
 * @param $columns (array) @public
 * @since 4.9.001 (2010-03-28)
 */
...
if (($this->page > $this->maxselcol['page']) or (($this->page ==
 $this->maxselcol['page']) and ($col > $this->maxselcol['column']))) {
$enable_thead = true;
 ...
 *
 * @return int current column number @public
 ...
 *
 * @return int number of columns @public
 ...
 * @param $clip (boolean) if true activate clipping mode @public
 ...
 *            enable shadow; depth_w (float) shadow width in user units; depth_h
 *            (float) shadow height in user units; color (array) shadow color or
 *            false to use the stroke color; opacity (float) Alpha value: real
 *            value from 0 (transparent) to 1 (opaque); blend_mode (string)
 *            blend mode, one of the following: Normal, Multiply, Screen,
 *            Overlay, Darken, Lighten, ColorDodge, ColorBurn, HardLight,
 *            SoftLight, Difference, Exclusion, Hue, Saturation, Color,
 *            Luminosity.
 * @since 5.9.174 (2012-07-25) @public
 */
public function setTextShadow(
$params = array('enabled'=>false, 'depth_w'=>0, 'depth_h'=>0, 'color'=>false, 'opacity'=>1, 'blend_mode'=>'Normal')) {
...
if (isset($params['color']) and ($params['color'] !== false) and
 is_array($params['color'])) {
...
if (isset($params['blend_mode']) and in_array($params['blend_mode'], 
array(
'Normal', 
'Multiply', 
'Screen', 
...
if ((($this->txtshadow['depth_w'] == 0) and ($this->txtshadow['depth_h'] == 0)) or
 ($this->txtshadow['opacity'] == 0)) {
$this->txtshadow['enabled'] = false;
}
}
 ...
 * @param $dictionary (array) Array of words to be returned without applying the
 *            hyphenation algorithm.
 * @param $leftmin (int) Minimum number of character to leave on the left of the
 ...
 * @author Nicola Asuni
 * @since 4.9.012 (2010-04-12) @protected
 */
protected function hyphenateWord($word, $patterns, $dictionary = array(), $leftmin = 1, 
$rightmin = 2, $charmin = 1, $charmax = 8) {
...
return TCPDF_FONTS::UTF8StringToArray($dictionary[$word_string], 
$this->isunicode, $this->CurrentFont);
}
...
for ($i = 1; $i <= $imax; ++ $i) {
$subword = strtolower(
TCPDF_FONTS::UTF8ArrSubString($tmpword, $pos, ($pos + $i), $this->isunicode));
if (isset($patterns[$subword])) {
$pattern = TCPDF_FONTS::UTF8StringToArray($patterns[$subword], $this->isunicode, 
$this->CurrentFont);
$pattern_length = count($pattern);
$digits = 1;
for ($j = 0; $j < $pattern_length; ++ $j) {
// check if $pattern[$j] is a number = hyphenation level (only numbers from 1 to
// 5 are valid)
...
$level = ($pattern[$j] - 48);
// if two levels from two different patterns match at the same point, the higher
// one is selected.
 ...
 *            containing hypenation patterns. TEX patterns can be downloaded
 *            from
 ...
 * @return array text with soft hyphens
 * @author Nicola Asuni
 * @since 4.9.012 (2010-04-12) @public
 */
public function hyphenateText($text, $patterns, $dictionary = array(), $leftmin = 1, 
$rightmin = 2, $charmin = 1, $charmax = 8) {
...
$unichars = TCPDF_FONTS::UTF8StringToArray($text, $this->isunicode, 
$this->CurrentFont);
// for each char
...
$this->hyphenateWord($word, $patterns, $dictionary, $leftmin, $rightmin, 
$charmin, $charmax));
$word = array();
}
$txtarr[] = $char;
 ...
 *
 * @param $mode (boolean) if true enable rasterization, false otherwise. @public
...
return preg_replace('/^' . $this->re_space['p'] . '+/' . $this->re_space['m'], 
$replace, $str);
}
...
return (($this->CurrentFont['type'] == 'TrueTypeUnicode') or
...
if (in_array(strtolower($font), $this->fontlist) or
 in_array($font, $this->fontkeys)) {
return $font;
}
}
...
/**
 * Start a new XObject Template. An XObject Template is a PDF block that is a
 * self-contained description of any sequence of graphics objects (including
 * path objects, text objects, and sampled images). An XObject Template may be
 * painted multiple times, either on several pages or at several locations on
 * the same page and produces the same results each time, subject only to the
 * graphics state at the time it is invoked. Note: X,Y coordinates will be reset
 * to 0,0.
 *
 ...
 *            array specifying optional parameters: 'CS' (solour space name),
 *            'I' (boolean flag to indicate isolated group) and 'K' (boolean
 *            flag to indicate knockout group).
 ...
 * previous graphic state. An XObject Template is a PDF block that is a
 * self-contained description of any sequence of graphics objects (including
 * path objects, text objects, and sampled images). An XObject Template may be
 * painted multiple times, either on several pages or at several locations on
 * the same page and produces the same results each time, subject only to the
 * graphics state at the time it is invoked.
 *
 * @return int the XObject Template ID in case of success or false in case of
 *         error.
 * @author Nicola Asuni @public
...
/**
 * Print an XObject Template. You can print an XObject Template inside the
 * currently opened Template. An XObject Template is a PDF block that is a
 * self-contained description of any sequence of graphics objects (including
 * path objects, text objects, and sampled images). An XObject Template may be
 * painted multiple times, either on several pages or at several locations on
 * the same page and produces the same results each time, subject only to the
 ...
 *            template insertion relative to template height. The value can
 *            be:<ul><li>T: top-right for LTR or top-left for RTL</li><li>M:
 *            middle-right for LTR or middle-left for RTL</li><li>B:
 *            bottom-right for LTR or bottom-left for RTL</li><li>N: next
 *            line</li></ul>
 * @param $palign (string) Allows to center or align the template on the current
 *            line. Possible values are:<ul><li>L : left align</li><li>C :
 *            center</li><li>R : right align</li><li>'' : empty string : left
 *            for LTR or right for RTL</li></ul>
 ...
 */
public function printTemplate($id, $x = '', $y = '', $w = 0, $h = 0, $align = '', 
$palign = '', $fitonpage = false) {
if ($this->state != 2) {
return;
}
...
$coordlt = TCPDF_STATIC::getTransformationMatrixProduct($tm, 
array(
1, 
0, 
0, 
...
$coordrb = TCPDF_STATIC::getTransformationMatrixProduct($tm, 
array(
1, 
0, 
0, 
...
$this->Annotation($ax, $ay, $aw, $ah, $annot['text'], $annot['opt'], 
$annot['spaces']);
}
}
// set pointer to align the next text/objects
...
/**
 * Set the amount to increase or decrease the space between characters in a
 * text.
 *
...
/**
 * Get the amount to increase or decrease the space between characters in a
 * text.
 *
...
/**
 * Set no-write regions on page. A no-write region is a portion of the page with
 * a rectangular or trapezium shape that will not be covered when writing text
 * or html code. A region is always aligned on the left or right side of the
 * page ad is defined using a vertical segment. You can set multiple regions for
 * the same page.
 *
 * @param $regions (array) array of no-write regions. For each region you can
 *            define an array as follow: ('page' => page number or empy for
 *            current page, 'xt' => X top, 'yt' => Y top, 'xb' => X bottom, 'yb'
 *            => Y bottom, 'side' => page side 'L' = left or 'R' = right). Omit
 *            this parameter to remove all regions.
 * @author Nicola Asuni @public
 * @since 5.9.003 (2010-10-13)
...
/**
 * Add a single no-write region on selected page. A no-write region is a portion
 * of the page with a rectangular or trapezium shape that will not be covered
 * when writing text or html code. A region is always aligned on the left or
 * right side of the page ad is defined using a vertical segment. You can set
 * multiple regions for the same page.
 *
 * @param $region (array) array of a single no-write region array: ('page' =>
 *            page number or empy for current page, 'xt' => X top, 'yt' => Y
 *            top, 'xb' => X bottom, 'yb' => Y bottom, 'side' => page side 'L' =
 *            left or 'R' = right).
 * @author Nicola Asuni @public
 * @since 5.9.003 (2010-10-13)
...
if (isset($region['xt']) and isset($region['xb']) and ($region['xt'] > 0) and
 ($region['xb'] > 0) and isset($region['yt']) and isset($region['yb']) and
 ($region['yt'] >= 0) and ($region['yt'] < $region['yb']) and
 isset($region['side']) and
 (($region['side'] == 'L') or ($region['side'] == 'R'))) {
...
/**
 * Check page for no-write regions and adapt current coordinates and page
 * margins if necessary. A no-write region is a portion of the page with a
 * rectangular or trapezium shape that will not be covered when writing text or
 * html code. A region is always aligned on the left or right side of the page
 * ad is defined using a vertical segment.
 *
...
if ($this->num_columns > 1) {
if ($this->rtl) {
$this->lMargin = ($this->columns[$this->current_column]['x'] -
 $this->columns[$this->current_column]['w']);
} else {
$this->rMargin = ($this->w - $this->columns[$this->current_column]['x'] -
 $this->columns[$this->current_column]['w']);
}
} else {
if ($this->rtl) {
...
$minv = ($regdata['xb'] - $regdata['xt']) / ($regdata['yb'] - $regdata['yt']); // inverse
                                                                               // of
                                                                               // angular
                                                                               // coefficient
$yt = max($y, $regdata['yt']);
 ...
 * fully implemented, use the setRasterizeVectorImages() method to
 * enable/disable rasterization of vector images using ImageMagick library.
 *
 * @param $file (string) Name of the SVG file or a '@' character followed by the
 *            SVG data string.
 * @param $x (float) Abscissa of the upper-left corner.
 * @param $y (float) Ordinate of the upper-left corner.
 * @param $w (float) Width of the image in the page. If not specified or equal
 ...
 *            top-right for LTR or top-left for RTL</li><li>M: middle-right for
 *            LTR or middle-left for RTL</li><li>B: bottom-right for LTR or
 *            bottom-left for RTL</li><li>N: next line</li></ul> If the
 *            alignment is an empty string, then the pointer will be restored on
 *            the starting SVG position.
 * @param $palign (string) Allows to center or align the image on the current
 *            line. Possible values are:<ul><li>L : left align</li><li>C :
 *            center</li><li>R : right align</li><li>'' : empty string : left
 *            for LTR or right for RTL</li></ul>
 ...
 *            dimensions.
 * @author Nicola Asuni
 * @since 5.0.000 (2010-05-02) @public
 */
public function ImageSVG($file, $x = '', $y = '', $w = 0, $h = 0, $link = '', 
...
return $this->Image($file, $x, $y, $w, $h, 'SVG', $link, $align, true, 300, 
$palign, false, false, $border, false, false, false);
}
if ($file[0] === '@') { // image from string
$this->svgdir = '';
...
// get aspect ratio
$tmp = array();
if (preg_match('/[\s]+preserveAspectRatio[\s]*=[\s]*"([^"]*)"/si', $regs[1], 
$tmp)) {
...
$this->_out(
sprintf('%F %F %F %F %F %F cm', $svgscale_x, 0, 0, $svgscale_y, 
($e + $svgoffset_x), ($f + $svgoffset_y)));
...
xml_set_element_handler($this->parser, 'startSVGElementHandler', 
 ...
 * @return array transformation matrix @protected
 * @since 5.0.000 (2010-05-02)
 */
 ...
 *
 * @param $tm (array) original SVG transformation matrix @protected
 * @since 5.0.000 (2010-05-02)
 */
 ...
 * @return object style
 * @author Nicola Asuni
 * @since 5.0.000 (2010-05-02) @protected
 */
protected function setSVGStyles($svgstyle, $prevsvgstyle, $x = 0, $y = 0, $w = 1, 
$h = 1, $clip_function = '', $clip_params = array()) {
if ($this->state != 2) {
return;
}
$objstyle = '';
...
// color
$fill_color = TCPDF_COLORS::convertHTMLColorToDec($svgstyle['color'], 
$this->spot_colors);
$this->SetFillColorArray($fill_color);
// text color
$text_color = TCPDF_COLORS::convertHTMLColorToDec($svgstyle['text-color'], 
$this->spot_colors);
...
$svgstyle['clip'], $regs)) {
$top = (isset($regs[1]) ? $this->getHTMLUnitToUnits($regs[1], 0, $this->svgunit, 
false) : 0);
$right = (isset($regs[2]) ? $this->getHTMLUnitToUnits($regs[2], 0, 
$this->svgunit, false) : 0);
$bottom = (isset($regs[3]) ? $this->getHTMLUnitToUnits($regs[3], 0, 
$this->svgunit, false) : 0);
$left = (isset($regs[4]) ? $this->getHTMLUnitToUnits($regs[4], 0, 
$this->svgunit, false) : 0);
$cx = $x + $left;
$cy = $y + $top;
$cw = $w - $left - $right;
...
$this, 
$clip_function), $clip_params);
if ((! isset($gradient['type']) or ($gradient['type'] != 3)) and is_array($bbox) and
 (count($bbox) == 4)) {
list ($x, $y, $w, $h) = $bbox;
}
}
...
if (isset($gradient['gradientTransform']) and
 ! empty($gradient['gradientTransform'])) {
$gtm = $gradient['gradientTransform'];
// apply transformation matrix
$xa = ($gtm[0] * $gradient['coords'][0]) + ($gtm[2] * $gradient['coords'][1]) +
 $gtm[4];
$ya = ($gtm[1] * $gradient['coords'][0]) + ($gtm[3] * $gradient['coords'][1]) +
 $gtm[5];
$xb = ($gtm[0] * $gradient['coords'][2]) + ($gtm[2] * $gradient['coords'][3]) +
 $gtm[4];
$yb = ($gtm[1] * $gradient['coords'][2]) + ($gtm[3] * $gradient['coords'][3]) +
 $gtm[5];
$r = sqrt(
pow(($gtm[0] * $gradient['coords'][4]), 2) +
...
$gradient['coords'][0] = $this->getHTMLUnitToUnits($gradient['coords'][0], 0, 
$this->svgunit, false);
$gradient['coords'][1] = $this->getHTMLUnitToUnits($gradient['coords'][1], 0, 
$this->svgunit, false);
$gradient['coords'][2] = $this->getHTMLUnitToUnits($gradient['coords'][2], 0, 
$this->svgunit, false);
$gradient['coords'][3] = $this->getHTMLUnitToUnits($gradient['coords'][3], 0, 
$this->svgunit, false);
$gradient['coords'][4] = $this->getHTMLUnitToUnits($gradient['coords'][4], 0, 
$this->svgunit, false);
if ($w <= $minlen) {
$w = $minlen;
}
...
if (($gradient['type'] == 2) and
 ($gradient['coords'][0] == $gradient['coords'][2]) and
...
$this->_out(
sprintf('%F 0 0 %F %F %F cm', ($w * $this->k), ($h * $this->k), ($x * $this->k), 
($cy * $this->k)));
...
$fill_color = TCPDF_COLORS::convertHTMLColorToDec($svgstyle['fill'], 
$this->spot_colors);
...
$this->setAlpha($svgstyle['stroke-opacity'], 'Normal', $this->alpha['ca'], 
false);
} elseif (preg_match('/rgba\(\d+%?,\s*\d+%?,\s*\d+%?,\s*(\d+(?:\.\d+)?)\)/i', 
$svgstyle['stroke'], $rgba_matches)) {
$this->setAlpha($rgba_matches[1], 'Normal', $this->alpha['ca'], false);
}
$stroke_style = array(
'color' => TCPDF_COLORS::convertHTMLColorToDec($svgstyle['stroke'], 
$this->spot_colors), 
'width' => $this->getHTMLUnitToUnits($svgstyle['stroke-width'], 0, 
$this->svgunit, false), 
'cap' => $svgstyle['stroke-linecap'], 
'join' => $svgstyle['stroke-linejoin']);
if (isset($svgstyle['stroke-dasharray']) and
 ! empty($svgstyle['stroke-dasharray']) and
...
if (preg_match('/font-style[\s]*:[\s]*([^\s\;\"]*)/si', $svgstyle['font'], 
$regs)) {
$font_style = trim($regs[1]);
} else {
$font_style = $svgstyle['font-style'];
}
if (preg_match('/font-weight[\s]*:[\s]*([^\s\;\"]*)/si', $svgstyle['font'], 
$regs)) {
$font_weight = trim($regs[1]);
} else {
$font_weight = $svgstyle['font-weight'];
}
if (preg_match('/font-stretch[\s]*:[\s]*([^\s\;\"]*)/si', $svgstyle['font'], 
$regs)) {
$font_stretch = trim($regs[1]);
} else {
$font_stretch = $svgstyle['font-stretch'];
}
if (preg_match('/letter-spacing[\s]*:[\s]*([^\s\;\"]*)/si', $svgstyle['font'], 
$regs)) {
...
$font_size = $this->getHTMLFontUnits($font_size, 
$this->svgstyles[0]['font-size'], $prevsvgstyle['font-size'], $this->svgunit);
$font_stretch = $this->getCSSFontStretching($font_stretch, 
 ...
 * @param $style (string) Style of rendering. Possible values are: <ul> <li>D or
 *            empty string: Draw (default).</li> <li>F: Fill.</li> <li>F*: Fill
 *            using the even-odd rule to determine which regions lie inside the
 *            clipping path.</li> <li>DF or FD: Draw and fill.</li> <li>DF* or
 *            FD*: Draw and fill using the even-odd rule to determine which
 *            regions lie inside the clipping path.</li> <li>CNZ: Clipping mode
 *            (using the even-odd rule to determine which regions lie inside the
 *            clipping path).</li> <li>CEO: Clipping mode (using the nonzero
 *            winding number rule to determine which regions lie inside the
 *            clipping path).</li> </ul>
...
preg_match_all('/([ACHLMQSTVZ])[\s]*([^ACHLMQSTVZ\"]*)/si', $d, $paths, 
PREG_SET_ORDER);
$x = 0;
$y = 0;
$x1 = 0;
...
// get angles
$angs = TCPDF_STATIC::getVectorsAngle(1, 0, (($xa - $cax) / $rx), 
(($cay - $ya) / $ry));
$dang = TCPDF_STATIC::getVectorsAngle((($xa - $cax) / $rx), 
(($ya - $cay) / $ry), ((- $xa - $cax) / $rx), ((- $ya - $cay) / $ry));
if (($fs == 0) and ($dang > 0)) {
$dang -= (2 * M_PI);
...
$pie = false;
if (($key == 0) and (isset($paths[($key + 1)][1])) and
 (trim($paths[($key + 1)][1]) == 'z')) {
$pie = true;
}
list ($axmin, $aymin, $axmax, $aymax) = $this->_outellipticalarc($cx, $cy, $rx, 
$ry, $ang, $angs, $angf, $pie, 2, false, ($fs == 0), true);
 ...
 *
 * @param $name (string) Tag name @protected
 */
...
/**
 * Sets the opening SVG element handler function for the XML parser. (*** TO BE
 * COMPLETED ***)
 *
 * @param $parser (resource) The first parameter, parser, is a reference to the
 *            XML parser calling the handler.
 * @param $name (string) The second parameter, name, contains the name of the
 *            element for which this handler is called. If case-folding is in
 *            effect for this parser, the element name will be in uppercase
 *            letters.
 * @param $attribs (array) The third parameter, attribs, contains an associative
 *            array with the element's attributes (if any). The keys of this
 *            array are the attribute names, the values are the attribute
 ...
 *            order of the attributes can be retrieved by walking through
 *            attribs the normal way, using each(). The first key in the array
 *            was the first attribute, and so on.
 * @param $ctm (array) tranformation matrix for clipping mode (starting
...
$attribs['id'] = 'DF_' .
 (count($this->svgdefs[$last_svgdefs_id]['attribs']['child_elements']) + 1);
...
$prev_svgstyle = $this->svgstyles[max(0, (count($this->svgstyles) - 1))]; // previous
                                                                          // style
$svgstyle = $this->svgstyles[0]; // set default style
if ($clipping and ! isset($attribs['fill']) and (! isset($attribs['style']) or (! preg_match(
'/[;\"\s]{1}fill[\s]*:[\s]*([^;\"]*)/si', $attribs['style'], $attrval)))) {
// default fill attribute for clipping
$attribs['fill'] = 'none';
}
if (isset($attribs['style']) and ! TCPDF_STATIC::empty_string($attribs['style']) and
 ($attribs['style'][0] != ';')) {
...
$svgstyle[$key] = $attribs[$key];
 ...
 ! TCPDF_STATIC::empty_string($attribs['style'])) {
// CSS style syntax
$attrval = array();
if (preg_match('/[;\"\s]{1}' . $key . '[\s]*:[\s]*([^;\"]*)/si', 
$attribs['style'], $attrval) and isset($attrval[1])) {
...
$tm = TCPDF_STATIC::getTransformationMatrixProduct($tm, 
TCPDF_STATIC::getSVGTransformMatrix($attribs['transform']));
}
$svgstyle['transfmatrix'] = $tm;
$invisible = false;
if (($svgstyle['visibility'] == 'hidden') or
 ($svgstyle['visibility'] == 'collapse') or ($svgstyle['display'] == 'none')) {
...
$this->svgunit, false) : $this->w);
$h = (isset($attribs['height']) ? $this->getHTMLUnitToUnits($attribs['height'], 
0, $this->svgunit, false) : $this->h);
// draw clipping rect
...
$tmp = $tmp[0];
if ((sizeof($tmp) == 2) and (strlen($tmp[0]) == 8) and (in_array($tmp[1], 
array(
'meet', 
'slice', 
'none')))) {
...
if (((! isset($attribs['x1'])) and (! isset($attribs['y1'])) and
 (! isset($attribs['x2'])) and (! isset($attribs['y2']))) or ((isset(
$attribs['x1']) and (substr($attribs['x1'], - 1) == '%')) or
 (isset($attribs['y1']) and (substr($attribs['y1'], - 1) == '%')) or
 (isset($attribs['x2']) and (substr($attribs['x2'], - 1) == '%')) or
 (isset($attribs['y2']) and (substr($attribs['y2'], - 1) == '%')))) {
...
$this->svggradients[$this->svggradientid]['gradientTransform'] = TCPDF_STATIC::getSVGTransformMatrix(
...
$this->svggradients[$this->svggradientid]['xref'] = substr(
$attribs['xlink:href'], 1);
}
break;
}
case 'radialGradient':
...
// $attribs['spreadMethod']
if (((! isset($attribs['cx'])) and (! isset($attribs['cy']))) or ((isset(
$attribs['cx']) and (substr($attribs['cx'], - 1) == '%')) or
 (isset($attribs['cy']) and (substr($attribs['cy'], - 1) == '%')))) {
$this->svggradients[$this->svggradientid]['mode'] = 'percentage';
} elseif (isset($attribs['r']) and is_numeric($attribs['r']) and
 ($attribs['r']) <= 1) {
...
$stop_color = isset($svgstyle['stop-color']) ? TCPDF_COLORS::convertHTMLColorToDec(
$svgstyle['stop-color'], $this->spot_colors) : 'black';
...
$x = (isset($attribs['x']) ? $this->getHTMLUnitToUnits($attribs['x'], 0, 
$this->svgunit, false) : 0);
$y = (isset($attribs['y']) ? $this->getHTMLUnitToUnits($attribs['y'], 0, 
$this->svgunit, false) : 0);
$w = (isset($attribs['width']) ? $this->getHTMLUnitToUnits($attribs['width'], 0, 
$this->svgunit, false) : 0);
$h = (isset($attribs['height']) ? $this->getHTMLUnitToUnits($attribs['height'], 
0, $this->svgunit, false) : 0);
$rx = (isset($attribs['rx']) ? $this->getHTMLUnitToUnits($attribs['rx'], 0, 
$this->svgunit, false) : 0);
$ry = (isset($attribs['ry']) ? $this->getHTMLUnitToUnits($attribs['ry'], 0, 
$this->svgunit, false) : $rx);
if ($clipping) {
$this->SVGTransform($tm);
...
$r = (isset($attribs['r']) ? $this->getHTMLUnitToUnits($attribs['r'], 0, 
$this->svgunit, false) : 0);
$cx = (isset($attribs['cx']) ? $this->getHTMLUnitToUnits($attribs['cx'], 0, 
$this->svgunit, false) : (isset($attribs['x']) ? $this->getHTMLUnitToUnits(
$attribs['x'], 0, $this->svgunit, false) : 0));
$cy = (isset($attribs['cy']) ? $this->getHTMLUnitToUnits($attribs['cy'], 0, 
$this->svgunit, false) : (isset($attribs['y']) ? $this->getHTMLUnitToUnits(
$attribs['y'], 0, $this->svgunit, false) : 0));
$x = ($cx - $r);
$y = ($cy - $r);
$w = (2 * $r);
$h = $w;
...
$x1 = (isset($attribs['x1']) ? $this->getHTMLUnitToUnits($attribs['x1'], 0, 
$this->svgunit, false) : 0);
$y1 = (isset($attribs['y1']) ? $this->getHTMLUnitToUnits($attribs['y1'], 0, 
$this->svgunit, false) : 0);
$x2 = (isset($attribs['x2']) ? $this->getHTMLUnitToUnits($attribs['x2'], 0, 
$this->svgunit, false) : 0);
$y2 = (isset($attribs['y2']) ? $this->getHTMLUnitToUnits($attribs['y2'], 0, 
$this->svgunit, false) : 0);
$x = $x1;
$y = $y1;
$w = abs($x2 - $x1);
...
// fix image path
if (! TCPDF_STATIC::empty_string($this->svgdir) and
 (($img[0] == '.') or (basename($img) == $img))) {
...
$this->svgtextmode['stroke'] = $this->getHTMLUnitToUnits(
$svgstyle['stroke-width'], 0, $this->svgunit, false);
} else {
...
// merge styles
$attribs['style'] = str_replace(';;', ';', 
';' . $use['attribs']['style'] . $attribs['style']);
}
...
$this->startSVGElementHandler('child-tag', $child_element['name'], 
$child_element['attribs']);
} else {
...
$this->svgdefs[$last_svgdefs_id]['attribs']['child_elements'][$child_element['attribs']['id'] .
 '_CLOSE'] = array(
'name' => $name, 
'attribs' => array(
'closing_tag' => TRUE, 
...
$this->svgdefs[$last_svgdefs_id]['attribs']['child_elements'][$last_svgdefs_id .
 '_CLOSE'] = array(
'name' => $name, 
'attribs' => array(
'closing_tag' => TRUE, 
...
// If the 'visibility' property is set to hidden on a 'tspan', 'tref' or
// 'altGlyph' element, then the text is invisible but still takes up space in
 ...
 * @param $parser (resource) The first parameter, parser, is a reference to the
 *            XML parser calling the handler.
 * @param $data (string) The second parameter, data, contains the character data
 *            as a string.
 * @author Nicola Asuni
 * @since 5.0.000 (2010-05-02) @protected
 */
