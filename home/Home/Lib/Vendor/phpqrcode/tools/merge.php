...
/*
 * PHP QR Code encoder Tool for merging all library files into one, simpler to
 * incorporate. MAKE SURE THAT RESULTING PHPQRCode.php (and its dir) ARE
 * WRITABLE! PHP QR Code is distributed under LGPL 3 Copyright (C) 2010 Dominik
 * Dzienia <deltalab at poczta dot fm> This library is free software; you can
