...
class PHPExcel_NamedRange {
     ...
     * @param PHPExcel_Worksheet|null $pScope Scope. Only applies when
     *            $pLocalOnly = true. Null for global scope.
     * @throws PHPExcel_Exception
     */
    public function __construct($pName = null, PHPExcel_Worksheet $pWorksheet, 
        $pRange = 'A1', $pLocalOnly = false, $pScope = null) {
        // Validate data
    ...
    public function setName($value = null) {
        if ($value !== NULL) {
            ...
            PHPExcel_ReferenceHelper::getInstance()->updateNamedFormulas(
                $this->_worksheet->getParent(), $oldTitle, $newTitle);
        }
        return $this;
    }
     ...
     * @return PHPExcel_NamedRange
     */
    public static function resolveRange($pNamedRange = '', 
