 ...
 *            (http://www.codeplex.com/PHPExcel)
 */
class PHPExcel_Style_Borders extends PHPExcel_Style_Supervisor implements 
    ...
    public function getHashCode() {
        ...
        return md5(
            $this->getLeft()->getHashCode() . $this->getRight()->getHashCode() .
                 $this->getTop()->getHashCode() .
                 $this->getBottom()->getHashCode() .
                 $this->getDiagonal()->getHashCode() .
                 $this->getDiagonalDirection() . __CLASS__);
    }
}
