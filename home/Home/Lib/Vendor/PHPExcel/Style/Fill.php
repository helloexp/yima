 ...
 *            (http://www.codeplex.com/PHPExcel)
 */
class PHPExcel_Style_Fill extends PHPExcel_Style_Supervisor implements 
    ...
    public function __construct($isSupervisor = FALSE, $isConditional = FALSE) {
        ...
        $this->_startColor = new PHPExcel_Style_Color(
            PHPExcel_Style_Color::COLOR_WHITE, $isSupervisor, $isConditional);
        $this->_endColor = new PHPExcel_Style_Color(
     ...
     * array( 'type' => PHPExcel_Style_Fill::FILL_GRADIENT_LINEAR, 'rotation' =>
     * 0, 'startcolor' => array( 'rgb' => '000000' ), 'endcolor' => array(
     * 'argb' => 'FFFFFFFF' ) ) ); </code>
     *
    ...
    public function getHashCode() {
        ...
        return md5(
            $this->getFillType() . $this->getRotation() .
                 $this->getStartColor()->getHashCode() .
                 $this->getEndColor()->getHashCode() . __CLASS__);
    }
}
