 ...
 *            (http://www.codeplex.com/PHPExcel)
 */
class PHPExcel_Style_Border extends PHPExcel_Style_Supervisor implements 
     ...
     * Set Border style
     *
     * @param string|boolean $pValue When passing a boolean, FALSE equates
     *            PHPExcel_Style_Border::BORDER_NONE and TRUE to
    ...
    public function getHashCode() {
        ...
        return md5(
            $this->_borderStyle . $this->_color->getHashCode() . __CLASS__);
    }
}
