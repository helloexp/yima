...
class PHPExcel_Chart_Layout {
    ...
    /**
     * show category name Specifies that the category name should be shown in
     * the data label.
     *
     * @var boolean
     */
    ...
    /**
     * show data series name Specifies that the series name should be shown in
     * the data label.
     *
     * @var boolean
     */
    ...
    /**
     * show percentage Specifies that the percentage should be shown in the data
     * label.
     *
     * @var boolean
     */
    ...
    /**
     * show leader lines Specifies that leader lines should be shown for the
     * data label.
     *
     * @var boolean
     */
    ...
    /**
     * Set show legend key Specifies that legend keys should be shown in data
     * labels.
     *
    ...
    /**
     * Set show cat name Specifies that the category name should be shown in
     * data labels.
     *
    ...
    /**
     * Set show ser name Specifies that the series name should be shown in data
     * labels.
     *
    ...
    /**
     * Set show percentage Specifies that the percentage should be shown in data
     * labels.
     *
    ...
    /**
     * Set show bubble size Specifies that the bubble size should be shown in
     * data labels.
     *
    ...
    /**
     * Set show leader lines Specifies that leader lines should be shown in data
     * labels.
     *
