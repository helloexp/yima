...
class PHPExcel_Worksheet_AutoFilter_Column_Rule {
    ...
    /*
     * The only valid filter rule operators for filter and customFilter types
     * are: <xsd:enumeration value="equal"/> <xsd:enumeration value="lessThan"/>
     * <xsd:enumeration value="lessThanOrEqual"/> <xsd:enumeration
     * value="notEqual"/> <xsd:enumeration value="greaterThanOrEqual"/>
    ...
    // const AUTOFILTER_COLUMN_RULE_BETWEEN = 'between'; // greaterThanOrEqual 1
    // && lessThanOrEqual 2
    /*
     * Rule Operators (Numeric Special) which are translated to standard numeric
     * operators with calculated values
     */
    // const AUTOFILTER_COLUMN_RULE_TOPTEN = 'topTen'; // greaterThan calculated
    // value
    // const AUTOFILTER_COLUMN_RULE_TOPTENPERCENT = 'topTenPercent'; //
    // greaterThan calculated value
    // const AUTOFILTER_COLUMN_RULE_ABOVEAVERAGE = 'aboveAverage'; // Value is
    // calculated as the average
    // const AUTOFILTER_COLUMN_RULE_BELOWAVERAGE = 'belowAverage'; // Value is
    // calculated as the average
    ...
    /*
     * Rule Operators (Date Special) which are translated to standard numeric
     * operators with calculated values
     */
    ...
    // const AUTOFILTER_COLUMN_RULE_YEARTODATE = 'yearToDate'; // <dynamicFilter
    // val="40909" type="yearToDate" maxVal="41113"/>
    // const AUTOFILTER_COLUMN_RULE_ALLDATESINMONTH = 'allDatesInMonth'; //
    // <dynamicFilter type="M2"/> for Month/February
    // const AUTOFILTER_COLUMN_RULE_ALLDATESINQUARTER = 'allDatesInQuarter'; //
    // <dynamicFilter type="Q2"/> for Quarter 2
    ...
    public function setRule($pOperator = self::AUTOFILTER_COLUMN_RULE_EQUAL, $pValue = '', $pGrouping = NULL) {
        ...
        // otherwise we're calculating it when we setValue() and don't want to
        // overwrite that
        // If the user supplies an argumnet for grouping, then on their own head
        // be it
        if ($pGrouping !== NULL)
