...
class PHPExcel_Worksheet_SheetView {
    ...
    /**
     * View Valid values range from 10 to 400.
     *
     * @var string
     */
    ...
    /**
     * Set View Valid values are 'normal' self::SHEETVIEW_NORMAL 'pageLayout'
     * self::SHEETVIEW_PAGE_LAYOUT 'pageBreakPreview'
     * self::SHEETVIEW_PAGE_BREAK_PREVIEW
     *
     * @param string $pValue
     * @throws PHPExcel_Exception
    ...
    public function setView($pValue = NULL) {
        // MS Excel 2007 allows setting the view to 'normal', 'pageLayout' or
        // 'pageBreakPreview'
