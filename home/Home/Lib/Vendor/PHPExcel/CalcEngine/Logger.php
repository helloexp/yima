...
class PHPExcel_CalcEngine_Logger {
     ...
     * calculation engine If true, then a debug log will be generated If false,
    ...
    /**
     * Flag to determine whether a debug log should be echoed by the calculation
     * engine If true, then a debug log will be echoed If false, then a debug
     * log will not be echoed A debug log can only be echoed if it is generated
     *
     * @var boolean
     */
    ...
    public function writeDebugLog() {
        ...
        if ($this->_writeDebugLog) {
            ...
            $this->_debugLog[] = $cellReference .
                 ($this->_cellStack->count() > 0 ? ' => ' : '') . $message;
        }
    }
