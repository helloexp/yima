...
class PHPExcel_IOFactory {
     ...
     */
    public static function addSearchLocation($type = '', $location = '', 
        $classname = '') {
    ...
    /**
     * Loads PHPExcel from file using automatic PHPExcel_Reader_IReader
     * resolution
     *
     * @static
     *
    ...
    /**
     * Create PHPExcel_Reader_IReader for file using automatic
     * PHPExcel_Reader_IReader resolution
     *
     * @static
     *
     * @access public
    ...
    public static function createReaderForFile($pFilename) {
        ...
        if (isset($pathinfo['extension'])) {
            switch (strtolower($pathinfo['extension'])) {
                ...
                case 'xlsm': // Excel (OfficeOpenXML) Macro Spreadsheet (macros
                             // will be discarded)
                case 'xltx': // Excel (OfficeOpenXML) Template
                case 'xltm': // Excel (OfficeOpenXML) Macro Template (macros
                             // will be discarded)
