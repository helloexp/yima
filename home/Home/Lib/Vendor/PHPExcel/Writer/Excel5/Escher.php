    ...
    public function close() {
        ...
        switch (get_class($this->_object)) {
            ...
            case 'PHPExcel_Shared_Escher_DggContainer':
                ...
                // dgg data
                $dggData = pack('VVVV', $this->_object->getSpIdMax(),  // maximum
                                                                      // shape
                                                                      // identifier
                                                                      // increased
                                                                      // by one
                    $this->_object->getCDgSaved() + 1,  // number of file
                                                       // identifier clusters
                                                       // increased by one
                    $this->_object->getCSpSaved(), $this->_object->getCDgSaved()); // count
                                                                                   // total
                                                                                   // number
                                                                                   // of
                                                                                   // drawings
            ...
            case 'PHPExcel_Shared_Escher_DgContainer':
                ...
                $countShapes = count(
                    $this->_object->getSpgrContainer()->getChildren());
                $innerData .= $header .
                     pack('VV', $countShapes, $this->_object->getLastSpId());
                ...
                if ($spgrContainer = $this->_object->getSpgrContainer()) {
                    ...
                    foreach ($spOffsets as & $spOffset) {
                        $spOffset += 24; // add length of dgContainer header
                                             // data (8 bytes) plus dg data (16
                                             // bytes)
                    }
            ...
            case 'PHPExcel_Shared_Escher_DgContainer_SpgrContainer_SpContainer':
                ...
                if ($this->_object->getStartCoordinates()) {
                    ...
                    list ($column, $row) = PHPExcel_Cell::coordinateFromString(
                        $this->_object->getStartCoordinates());
                    ...
                    // end coordinates
                    list ($column, $row) = PHPExcel_Cell::coordinateFromString(
                        $this->_object->getEndCoordinates());
                    ...
                    $clientAnchorData = pack('vvvvvvvvv', 
                        $this->_object->getSpFlag(), $c1, $startOffsetX, $r1, 
