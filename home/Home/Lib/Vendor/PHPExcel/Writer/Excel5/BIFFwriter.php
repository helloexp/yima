...
// Original file header of PEAR::Spreadsheet_Excel_Writer_BIFFwriter (used as
...
class PHPExcel_Writer_Excel5_BIFFwriter {
    ...
    /**
     * The maximum length for a BIFF record (excluding record header and length
     * field). See _addContinue()
     *
     * @var integer
     * @see _addContinue()
     */
    ...
    /**
     * General storage function like _append, but returns string instead of
     ...
     * bytes. In Excel 97 the limit is 8228 bytes. Records that are longer than
     * these limits must be split up into CONTINUE blocks. This function takes a
     * long BIFF record and inserts CONTINUE records as necessary.
     *
