 ...
 *            (http://www.codeplex.com/PHPExcel)
 */
class PHPExcel_Writer_CSV extends PHPExcel_Writer_Abstract implements 
     ...
     *
     * @param boolean $pValue Set the file to be written as a fully Excel
     *            compatible csv file Note that this overrides other settings
     *            such as useBOM, enclosure and delimiter
     * @return PHPExcel_Writer_CSV
     */
