...
class PHPExcel_Writer_Excel2007_Drawing extends PHPExcel_Writer_Excel2007_WriterPart {
     ...
     * @param boolean $includeCharts Flag indicating if we should include
     *            drawing details for charts
     * @return string XML Output
     * @throws PHPExcel_Writer_Exception
     */
    public function writeDrawings(PHPExcel_Worksheet $pWorksheet = null, &$chartRef, 
        $includeCharts = FALSE) {
        // Create XML writer
        $objWriter = null;
     ...
     * @throws PHPExcel_Writer_Exception
     */
    public function _writeChart(PHPExcel_Shared_XMLWriter $objWriter = null, 
        PHPExcel_Chart $pChart = null, $pRelationId = -1) {
    ...
    public function _writeDrawing(PHPExcel_Shared_XMLWriter $objWriter = null, 
        ...
        if ($pRelationId >= 0) {
            ...
            // Image location
            $aCoordinates = PHPExcel_Cell::coordinateFromString(
                $pDrawing->getCoordinates());
            $aCoordinates[0] = PHPExcel_Cell::columnIndexFromString(
                $aCoordinates[0]);
            ...
            // $objWriter->endElement();
            /*
             * // a:ln $objWriter->startElement('a:ln');
             * $objWriter->writeAttribute('w', '88900');
             * $objWriter->writeAttribute('cap', 'sq'); // a:solidFill
             * $objWriter->startElement('a:solidFill'); // a:srgbClr
             * $objWriter->startElement('a:srgbClr');
             * $objWriter->writeAttribute('val', 'FFFFFF');
             * $objWriter->endElement(); $objWriter->endElement(); // a:miter
            ...
            /*
             * // a:scene3d $objWriter->startElement('a:scene3d'); // a:camera
             * $objWriter->startElement('a:camera');
             * $objWriter->writeAttribute('prst', 'orthographicFront');
             * $objWriter->endElement(); // a:lightRig
             * $objWriter->startElement('a:lightRig');
             * $objWriter->writeAttribute('rig', 'twoPt');
             * $objWriter->writeAttribute('dir', 't'); // a:rot
             * $objWriter->startElement('a:rot');
             * $objWriter->writeAttribute('lat', '0');
             * $objWriter->writeAttribute('lon', '0');
             * $objWriter->writeAttribute('rev', '0'); $objWriter->endElement();
             * $objWriter->endElement(); $objWriter->endElement();
             */
            /*
             * // a:sp3d $objWriter->startElement('a:sp3d'); // a:bevelT
             * $objWriter->startElement('a:bevelT');
             * $objWriter->writeAttribute('w', '25400');
             * $objWriter->writeAttribute('h', '19050');
             * $objWriter->endElement(); // a:contourClr
             * $objWriter->startElement('a:contourClr'); // a:srgbClr
             * $objWriter->startElement('a:srgbClr');
             * $objWriter->writeAttribute('val', 'FFFFFF');
             * $objWriter->endElement(); $objWriter->endElement();
             * $objWriter->endElement();
    ...
    public function _writeVMLHeaderFooterImage(
        PHPExcel_Shared_XMLWriter $objWriter = null, $pReference = '', 
