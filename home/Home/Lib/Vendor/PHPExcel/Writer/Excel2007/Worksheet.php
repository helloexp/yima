...
class PHPExcel_Writer_Excel2007_Worksheet extends PHPExcel_Writer_Excel2007_WriterPart {
     ...
     * @throws PHPExcel_Writer_Exception
     */
    private function _writeSheetPr(PHPExcel_Shared_XMLWriter $objWriter = null, 
        PHPExcel_Worksheet $pSheet = null) {
        // sheetPr
        $objWriter->startElement('sheetPr');
        // $objWriter->writeAttribute('codeName', $pSheet->getTitle());
        if ($pSheet->getParent()->hasMacros()) { // if the workbook have macros,
                                                 // we need to have codeName for
                                                 // the sheet
     ...
     * @throws PHPExcel_Writer_Exception
     */
    private function _writeDimension(PHPExcel_Shared_XMLWriter $objWriter = null, 
        PHPExcel_Worksheet $pSheet = null) {
        // dimension
    ...
    private function _writeSheetViews(
        ...
        if (($topLeftCell != '') && ($topLeftCell != 'A1')) {
            ...
            list ($xSplit, $ySplit) = PHPExcel_Cell::coordinateFromString(
                $topLeftCell);
            ...
            if (($xSplit > 1) && ($ySplit > 1)) {
                // Write additional selections if more than two panes (ie both
                // an X and a Y split)
        ...
        // We cheat a little by over-riding the active cell selection, setting
        // it to the split cell
        $objWriter->startElement('selection');
        if ($pane != '') {
    ...
    private function _writeSheetFormatPr(
        ...
        if ($pSheet->getDefaultColumnDimension()->getWidth() >= 0) {
            $objWriter->writeAttribute('defaultColWidth', 
                PHPExcel_Shared_String::FormatNumber(
                    $pSheet->getDefaultColumnDimension()
                        ->getWidth()));
        }
     ...
     * @throws PHPExcel_Writer_Exception
     */
    private function _writeCols(PHPExcel_Shared_XMLWriter $objWriter = null, 
        PHPExcel_Worksheet $pSheet = null) {
        // cols
     ...
     * @throws PHPExcel_Writer_Exception
     */
    private function _writePageSetup(PHPExcel_Shared_XMLWriter $objWriter = null, 
        PHPExcel_Worksheet $pSheet = null) {
        // pageSetup
     ...
     * @throws PHPExcel_Writer_Exception
     */
    private function _writeBreaks(PHPExcel_Shared_XMLWriter $objWriter = null, 
        PHPExcel_Worksheet $pSheet = null) {
     ...
     * @throws PHPExcel_Writer_Exception
     */
    private function _writeSheetData(PHPExcel_Shared_XMLWriter $objWriter = null, 
        PHPExcel_Worksheet $pSheet = null, $pStringTable = null) {
        if (is_array($pStringTable)) {
            ...
            // Get column count
            $colCount = PHPExcel_Cell::columnIndexFromString(
                $pSheet->getHighestColumn());
     ...
     * @param string[] $pStringTable String table
     * @param string[] $pFlippedStringTable String table (flipped), for faster
     *            index searching
     * @throws PHPExcel_Writer_Exception
     */
    private function _writeCell(PHPExcel_Shared_XMLWriter $objWriter = null, 
        PHPExcel_Worksheet $pSheet = null, $pCellAddress = null, $pStringTable = null, 
 ...
 * @param PHPExcel_Shared_XMLWriter $objWriter XML Writer
 * @param PHPExcel_Worksheet $pSheet Worksheet
 * @param boolean $includeCharts Flag indicating if we should include drawing
 *            details for charts
 * @throws PHPExcel_Writer_Exception
 */
private function _writeDrawings(PHPExcel_Shared_XMLWriter $objWriter = null, 
    PHPExcel_Worksheet $pSheet = null, $includeCharts = FALSE) {
