...
class PHPExcel_Writer_Excel2007_Workbook extends PHPExcel_Writer_Excel2007_WriterPart {
     ...
     * @param boolean $recalcRequired Indicate whether formulas should be
     ...
     * @throws PHPExcel_Writer_Exception
     */
    private function _writeBookViews(PHPExcel_Shared_XMLWriter $objWriter = null, 
    ...
    private function _writeCalcPr(PHPExcel_Shared_XMLWriter $objWriter = null, 
        ...
        // If MS Excel does do a recalc, then users opening a file in MS Excel
        // will be prompted to save on exit
     ...
     * @throws PHPExcel_Writer_Exception
     */
    private function _writeSheets(PHPExcel_Shared_XMLWriter $objWriter = null, 
        PHPExcel $pPHPExcel = null) {
        // Write sheets
     ...
     * @throws PHPExcel_Writer_Exception
     */
    private function _writeSheet(PHPExcel_Shared_XMLWriter $objWriter = null, 
        $pSheetname = '', $pSheetId = 1, $pRelId = 1, $sheetState = 'visible') {
        if ($pSheetname != '') {
            // Write sheet
    ...
    private function _writeNamedRanges(
        PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel $pPHPExcel) {
        // Loop named ranges
    ...
    private function _writeDefinedNameForPrintArea(
        ...
        if ($pSheet->getPageSetup()->isPrintAreaSet()) {
            ...
            foreach ($printArea as $printAreaRect) {
                $printAreaRect[0] = PHPExcel_Cell::absoluteReference(
                    $printAreaRect[0]);
                $printAreaRect[1] = PHPExcel_Cell::absoluteReference(
                    $printAreaRect[1]);
