...
class PHPExcel_Writer_Excel2007_Comments extends PHPExcel_Writer_Excel2007_WriterPart {
     ...
     * @throws PHPExcel_Writer_Exception
     */
    public function _writeComment(PHPExcel_Shared_XMLWriter $objWriter = null, 
        $pCellReference = 'A1', PHPExcel_Comment $pComment = null, $pAuthors = null) {
        // comment
     ...
     * @throws PHPExcel_Writer_Exception
     */
    public function _writeVMLComment(PHPExcel_Shared_XMLWriter $objWriter = null, 
        $pCellReference = 'A1', PHPExcel_Comment $pComment = null) {
        // Metadata
        ...
        // x:Anchor
        // $objWriter->writeElement('x:Anchor', $column . ', 15, ' . ($row - 2)
        // . ', 10, ' . ($column + 4) . ', 15, ' . ($row + 5) . ', 18');
