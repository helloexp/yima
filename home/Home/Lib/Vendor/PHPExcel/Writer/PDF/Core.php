...
abstract class PHPExcel_Writer_PDF_Core extends PHPExcel_Writer_HTML {
    ...
    protected static $_paperSizes = array(
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_LETTER => 'LETTER',  // (8.5 in.
                                                                    // by 11
                                                                    // in.)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_LETTER_SMALL => 'LETTER',  // (8.5
                                                                          // in.
                                                                          // by
                                                                          // 11
                                                                          // in.)
        ...
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_LEGAL => 'LEGAL',  // (8.5 in. by
                                                                  // 14 in.)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_STATEMENT => array(
            396.00, 
            612.00),  // (5.5 in. by 8.5 in.)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_EXECUTIVE => 'EXECUTIVE',  // (7.25
                                                                          // in.
                                                                          // by
                                                                          // 10.5
                                                                          // in.)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_A3 => 'A3',  // (297 mm by 420
                                                            // mm)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_A4 => 'A4',  // (210 mm by 297
                                                            // mm)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_A4_SMALL => 'A4',  // (210 mm by
                                                                  // 297 mm)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_A5 => 'A5',  // (148 mm by 210
                                                            // mm)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_B4 => 'B4',  // (250 mm by 353
                                                            // mm)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_B5 => 'B5',  // (176 mm by 250
                                                            // mm)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_FOLIO => 'FOLIO',  // (8.5 in. by
                                                                  // 13 in.)
        ...
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_STANDARD_2 => array(
            792.00, 
            1224.00),  // (11 in. by 17 in.)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_NOTE => 'LETTER',  // (8.5 in. by
                                                                  // 11 in.)
        ...
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_C5_ENVELOPE => 'C5',  // (162 mm
                                                                     // by 229
                                                                     // mm)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_C3_ENVELOPE => 'C3',  // (324 mm
                                                                     // by 458
                                                                     // mm)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_C4_ENVELOPE => 'C4',  // (229 mm
                                                                     // by 324
                                                                     // mm)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_C6_ENVELOPE => 'C6',  // (114 mm
                                                                     // by 162
                                                                     // mm)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_C65_ENVELOPE => array(
            323.15, 
            649.13),  // (114 mm by 229 mm)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_B4_ENVELOPE => 'B4',  // (250 mm
                                                                     // by 353
                                                                     // mm)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_B5_ENVELOPE => 'B5',  // (176 mm
                                                                     // by 250
                                                                     // mm)
        ...
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_GERMAN_LEGAL_FANFOLD => 'FOLIO',  // (8.5
                                                                                 // in.
                                                                                 // by
                                                                                 // 13
                                                                                 // in.)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_ISO_B4 => 'B4',  // (250 mm by
                                                                // 353 mm)
        ...
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_A4_TRANSVERSE_PAPER => 'A4',  // (210
                                                                             // mm
                                                                             // by
                                                                             // 297
                                                                             // mm)
        ...
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_A5_TRANSVERSE_PAPER => 'A5',  // (148
                                                                             // mm
                                                                             // by
                                                                             // 210
                                                                             // mm)
        ...
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_A2_PAPER => 'A2',  // (420 mm by
                                                                  // 594 mm)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_A3_TRANSVERSE_PAPER => 'A3',  // (297
                                                                             // mm
                                                                             // by
                                                                             // 420
                                                                             // mm)
    ...
    /**
     * Set font. Examples: 'arialunicid0-chinese-simplified'
     * 'arialunicid0-chinese-traditional' 'arialunicid0-korean'
