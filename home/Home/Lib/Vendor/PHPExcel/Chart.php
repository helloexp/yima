...
class PHPExcel_Chart {
     ...
     */
    public function __construct($name, PHPExcel_Chart_Title $title = null, 
        PHPExcel_Chart_Legend $legend = null, 
        PHPExcel_Chart_PlotArea $plotArea = null, $plotVisibleOnly = true, 
        $displayBlanksAs = '0', PHPExcel_Chart_Title $xAxisLabel = null, 
     ...
     *
     * @return array an associative array containing the cell address, X-Offset
     *         and Y-Offset from the top left of that cell
     */
