...
class PHPExcel_Shared_OLE_PPS {
     ...
     * @param integer $dir The index of it's first child if this is a Dir or
     *            Root PPS
     ...
     */
    public function __construct($No, $name, $type, $prev, $next, $dir, $time_1st, 
        $time_2nd, $data, $children) {
        $this->No = $No;
        $this->Name = $name;
        $this->Type = $type;
        $this->PrevPps = $prev;
