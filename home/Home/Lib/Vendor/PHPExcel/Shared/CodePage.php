...
class PHPExcel_Shared_CodePage {
    ...
    /**
     * Convert Microsoft Code Page Identifier to Code Page Name which iconv and
     * mbstring understands
     *
    ...
    public static function NumberToName($codePage = 1252) {
        switch ($codePage) {
            ...
            case 1251:
                return 'CP1251';
                break; // ANSI Cyrillic
            case 0: // CodePage is not always correctly set when the xls file
                    // was saved by Apple's Numbers program
            case 1252:
                return 'CP1252';
