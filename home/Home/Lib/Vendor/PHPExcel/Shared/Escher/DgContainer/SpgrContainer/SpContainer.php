...
class PHPExcel_Shared_Escher_DgContainer_SpgrContainer_SpContainer {
    ...
    /**
     * Horizontal offset of upper-left corner of shape measured in 1/1024 of
     * column width
     *
     * @var int
     */
    ...
    /**
     * Vertical offset of upper-left corner of shape measured in 1/256 of row
     * height
     *
     * @var int
     */
    ...
    /**
     * Horizontal offset of bottom-right corner of shape measured in 1/1024 of
     * column width
     *
     * @var int
     */
    ...
    /**
     * Vertical offset of bottom-right corner of shape measured in 1/256 of row
     * height
     *
     * @var int
     */
    ...
    /**
     * Set offset in y-direction of upper-left corner of shape measured in 1/256
     * of row height
     *
    ...
    /**
     * Get offset in y-direction of upper-left corner of shape measured in 1/256
     * of row height
     *
     * @return int
     */
    ...
    /**
     * Set offset in x-direction of bottom-right corner of shape measured in
     * 1/1024 of column width
     *
     * @param int $startOffsetX
     */
    ...
    /**
     * Get offset in x-direction of bottom-right corner of shape measured in
     * 1/1024 of column width
     *
     * @return int
     */
    ...
    /**
     * Set offset in y-direction of bottom-right corner of shape measured in
     * 1/256 of row height
     *
    ...
    /**
     * Get offset in y-direction of bottom-right corner of shape measured in
     * 1/256 of row height
     *
     * @return int
     */
     ...
     * spgrContainers between this spContainer and the dgContainer. A value of 1
     * = immediately within first spgrContainer Higher nesting level occurs if
     * and only if spContainer is part of a shape group
     *
