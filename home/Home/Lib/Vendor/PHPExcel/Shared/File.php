...
class PHPExcel_Shared_File {
    ...
    /*
     * Use Temp or File Upload Temp for temporary files @protected @var boolean
     */
    protected static $_useUploadTempDirectory = FALSE;

    /**
     * Set the flag indicating whether the File Upload Temp directory should be
     * used for temporary files
     *
     * @param boolean $useUploadTempDir Use File Upload Temporary directory
     *            (true or false)
     */
    ...
    /**
     * Get the flag indicating whether the File Upload Temp directory should be
     * used for temporary files
     *
