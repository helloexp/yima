...
class PHPExcel_Shared_OLE {
    ...
    /**
     * Returns a stream for use with fread() etc. External callers should use
    ...
    /**
     * It checks whether the PPS tree is complete (all PPS's read) starting with
     * the given PPS (not necessarily root)
     *
     * @access public
    ...
    /**
     * Checks whether a PPS is a File PPS or not. If there is no PPS for the
     * index given, it will return false.
     *
     * @access public
    ...
    /**
     * Checks whether a PPS is a Root PPS or not. If there is no PPS for the
     * index given, it will return false.
     *
     * @access public
     * @param integer $index The index for the PPS.
    ...
    /**
     * Gets data from a PPS If there is no PPS for the index given, it will
    ...
    public function getData($index, $position, $length) {
        ...
        if (! isset($this->_list[$index]) ||
             ($position >= $this->_list[$index]->Size) || ($position < 0)) {
            return '';
        }
    ...
    /**
     * Gets the data length from a PPS If there is no PPS for the index given,
     * it will return 0.
     *
     * @access public
     * @param integer $index The index for the PPS
    ...
    /**
     * Utility function Returns a string for the OLE container with the date
     * given
     *
     * @access public
     * @static
    ...
    public static function LocalDate2OLE($date = null) {
        ...
        $big_date = $days * 24 * 3600 + gmmktime(date("H", $date), 
            date("i", $date), date("s", $date), date("m", $date), 
