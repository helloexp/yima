...
class PHPExcel_Shared_TimeZone {
    ...
    /*
     * Default Timezone used for date/time conversions @private @var string
     */
     ...
     * @param integer $timestamp PHP date/time value for finding the current
     *            transition
     ...
     * This requires both the timezone and the calculated date/time to allow for
     * local DST
     *
