...
class PHPExcel_Logarithmic_Best_Fit extends PHPExcel_Best_Fit {
    ...
    public function getValueOfYForX($xValue) {
        return $this->getIntersect() +
             $this->getSlope() * log($xValue - $this->_Xoffset);
    }
    ...
    /**
     * Execute the regression and calculate the goodness of fit for a set of X
     * and Y data values
     *
    ...
    /**
     * Define the regression and calculate the goodness of fit for a set of X
     * and Y data values
     *
     * @param float[] $yValues The set of Y-values for this regression
     * @param float[] $xValues The set of X-values for this regression
