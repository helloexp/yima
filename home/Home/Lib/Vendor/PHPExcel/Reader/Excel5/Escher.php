...
class PHPExcel_Reader_Excel5_Escher {
    ...
    private function _readBSE() {
        ...
        $recInstance = (0xFFF0 &
             PHPExcel_Reader_Excel5::_GetInt2d($this->_data, $this->_pos)) >> 4;
    ...
    /**
     * Read ClientAnchor record. This record holds information about where the
     * shape is anchored in worksheet
     */
    private function _readClientAnchor() {
        ...
        // offset: 4; size: 2; upper-left corner horizontal offset in 1/1024 of
        // column width
        ...
        // offset: 8; size: 2; upper-left corner vertical offset in 1/256 of row
        // height
        ...
        // offset: 12; size: 2; bottom-right corner horizontal offset in 1/1024
        // of column width
        ...
        // offset: 16; size: 2; bottom-right corner vertical offset in 1/256 of
        // row height
        $endOffsetY = PHPExcel_Reader_Excel5::_GetInt2d($recordData, 16);
        
        // set the start coordinates
        $this->_object->setStartCoordinates(
            PHPExcel_Cell::stringFromColumnIndex($c1) . ($r1 + 1));
        ...
        $this->_object->setEndCoordinates(
            PHPExcel_Cell::stringFromColumnIndex($c2) . ($r2 + 1));
    ...
    private function _readOfficeArtRGFOPTE($data, $n) {
        ...
        for ($i = 0; $i < $n; ++ $i) {
            ...
            // bit: 15; mask 0x8000; 1 = this is a complex property, op field
            // specifies size of complex data
