...
class IndexAction extends BaseAction {
    ...
    public function index() {
        ...
        if ($phone_no != '') {
            ...
            $count = M()->table('tfb_hbtpy_trace a')
                ->where($map)
                ->count();
            ...
            $list = M()->table('tfb_hbtpy_trace a')
                ->where($map)
    ...
    public function import() {
        ...
        $num = M('tfb_hbtpy_import')->where("mid={$mid}")
