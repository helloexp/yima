...
//    private $key = "aKYdq1X2GujsIie7ANJUbDYpMTEBu7q8";

//    private $appId = "SHYM00001";
    private $appId = 'CAS00018';   //生产环境
    private $key = "QtIKREfSb4h2ECtFDWWfn0i5pmoLUHK7";  //生产环境
    ...
    public function index() {
        ...
        log_write(
            'http://' . $_SERVER['SERVER_NAME'] . ':' . $_SERVER["SERVER_PORT"] .
                 $_SERVER["REQUEST_URI"]);
        // SERVICE=user_ssoservice&VERSION=1.0&PARTNER=80010003&SIGN_TYPE=MD5&CREDTENTIAL=417718,1451280947,1451281547,1451280947,127.0.0.1,client.cmpay.com&SIGN_DATA=4e194daaef9025ceb313b6e686945d2c
        log_write("CREDTENTIAL:" . $_REQUEST['CREDTENTIAL']);
        log_write("SIGN_DATA:" . $_REQUEST['SIGN_DATA']);
        
        $phone = $this->getPhone($_REQUEST['CREDTENTIAL'], 
            $_REQUEST['SIGN_DATA'], $_REQUEST['SIGN_TYPE']);
        $phone = '13601941601';
        if ($phone) {
            ...
            header(
                'Location: ' .
//                     "http://www.wangcaio2o.com/index.php?g=Label&m=Label&a=index&id=57700");  //正式环境
                     "http://test.wangcaio2o.com/index.php?&g=Label&m=Store&a=index&id=7823");
        } else {
...
//        $getSignKeyUrl = "https://111.8.12.50:28710/ccaweb//CCLIMCA4/2208000.dor";
        $getSignKeyUrl = "https://mca.cmpay.com:28710/ccaweb/CCLIMCA4/2208000.dor";  //线上  
        $requestData = "<HEAD><TXNCD>2208000</TXNCD><MBLNO></MBLNO><SESSIONID></SESSIONID><PLAT>99</PLAT><UA>default</UA><VERSION>efault</VERSION><PLUGINVER></PLUGINVER><NETTYPE></NETTYPE><MCID>default</MCID><MAC>default</MAC><IMEI>default</IMEI><IMSI>default</IMSI><SOURCE>default</SOURCE><DEVID>" .
