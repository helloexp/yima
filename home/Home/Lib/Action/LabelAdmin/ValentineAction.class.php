...
// 情人节活动
class ValentineAction extends BaseAction {
    
    // 活动类型
    public $BATCH_TYPE = '12';
    // 图片路径
    public $img_path;
    ...
    public function editStatus() {
        ...
        if ($result) {
            node_log('天生一对状态更改|活动id:' . $data['batch_id']);
            $this->success('更新成功', 
                array(
                    '返回' => U('News/index')));
        } else {
