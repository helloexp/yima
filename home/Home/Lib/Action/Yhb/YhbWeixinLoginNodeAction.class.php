 ...
 * 机构微信登录
 */
class YhbWeixinLoginNodeAction extends Action {
    ...
    public function index() {
        ...
        // 回调地址
        $backurl = U('Yhb/YhbWeixinLoginNode/callback', 
            array(
                'type' => $type), '', '', TRUE);
        // 授权参数
        $opt_arr = array(
    ...
    public function callback() {
        ...
        // $openid = 'ovMxUt0k4v7zziYTaqU_6q9OBzHI';
        ...
        // 查询会员信息
        $memberInfo = M('tfb_yhb_member')->where("openid='{$openid}'")->find();
        if (! $memberInfo) {
            $wxSessInfo['att_flag'] = 0;
        }
