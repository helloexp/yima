...
class IndexAction extends BaseAction {
    ...
    public function index() {
        ...
        if ($phone_no != '') {
            ...
            $count = M()->table('tfb_gstpy_trace a')
                ->where($map)
                ->count();
            ...
            $list = M()->table('tfb_gstpy_trace a')
                ->where($map)
    ...
    public function import() {
        ...
        $num = M('tfb_gstpy_import')->where("mid={$mid}")
