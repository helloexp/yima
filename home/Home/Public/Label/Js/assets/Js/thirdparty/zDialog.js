...
Dialog.prototype.create = function () {
    ...
    var html = '\
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;  background: #e95960;border-radius: 2px;  overflow: hidden;box-shadow: 0 0 6px rgba(0,0,0,.5);">\
    ...
    <tr valign="top">\
      <td align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff">\
          ...
          <tr>\
            <td valign="middle" align="center" style="padding-left:20px;padding-right:20px; font-size:14px; line-height:25px; color:#333; text-align:left;position: relative; width: ' + this.Width + 'px; height: ' + this.Height + 'px;"><div id="_Container_' + this.ID + '">\
	...
	' + (function (obj) {
        ...
        return "";
          ...
          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="36"><div id="_DialogButtons_' + this.ID + '" style="border-top: 1px solid #DADEE5; padding: 8px 8px 8px 20px; text-align: right; background-color:#f6f6f6;">\
                <input type="button" style=" display: inline-block; margin:0 5px; padding:6px 10px; width:80px; background:#e95960; color:#fff; font-size:14px; line-height:16px; border-radius:3px; text-align:center; overflow:hidden; box-sizing:border-box; -webkit-appearance: none;" value="确 定" id="_ButtonOK_' + this.ID + '"/>\
                <input type="button" style=" display: inline-block; margin:0 5px; padding:6px 10px; width:80px; background:#999; color:#fff; font-size:14px; line-height:16px; border-radius:3px; text-align:center; overflow:hidden; box-sizing:border-box; -webkit-appearance: none;" value="取 消" onclick="Dialog.getInstance(\'' + this.ID + '\').close();" id="_ButtonCancel_' + this.ID + '"/>\
              </div></td>\
          </tr>\
        </table></td>\
    </tr>\
