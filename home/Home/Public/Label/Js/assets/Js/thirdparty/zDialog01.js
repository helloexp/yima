 ...
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = 'assets/Image/'; //图片路径配置
...
Dialog.prototype.attachBehaviors = function () {
    if (this.Drag && topWin.Drag)
        topWin.Drag.init(topWin.$id("_Draghandle_" + this.ID), topWin.$id("_DialogDiv_" + this.ID)); //注册拖拽方法
...
Dialog.prototype.create = function () {
    ...
    var html = '\
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;"style="-moz-user-select:none;font-size:12px; line-height:1.4;background:#e95960;overflow: hidden;box-shadow:0 0 6px rgba(0,0,0,.5);border-radius:10px">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + ';display:none">\
      <td height="40" style=""><div style="line-height:40px;float: left;padding-left:10px;"><span id="_Title_' + this.ID + '" style="line-height:40px; font-weight: bold; color:#fff; font-size:14px;">' + this.Title + '</span></div>\
        <div onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);"  style="cursor: pointer; float: right; height: 40px; width: 40px;line-height:40px;text-align:center; color:#fff' + (this.ShowCloseButton ? "" : "display:none;") + '">X</div></td>\
    </tr>\
    <tr valign="top">\
      <td align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff">\
          ...
          <tr>\
            <td valign="middle" align="center" style="padding-left:10px;padding-right:10px; font-size:14px; line-height:25px; color:#333; text-align:left;position: relative; width: ' + this.Width + 'px; height: ' + this.Height + 'px;"><div id="_Container_' + this.ID + '">\
	...
	' + (function (obj) {
        ...
        return "";
          ...
          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="36"><div id="_DialogButtons_' + this.ID + '"style="border-top:1px solid #DADEE5;text-align: right; background-color:#fff;text-align:center">\
                 <input type="button" style="display:inline-block;margin:0 auto;padding:14px 5px; width:44%; background:#fff;color:#333;border:none;font-size:14px; line-height:16px;text-align:center;overflow:hidden;border-right:1px solid rgb(218, 222, 229);box-sizing:border-box;-webkit-appearance:none;' + (this.ShowcancelButton ? "" : "display:none") + '" value="取 消" onclick="Dialog.getInstance(\'' + this.ID + '\').close();" id="_ButtonCancel_' + this.ID + '"/>\
                <input type="button" style="display:inline-block;margin:0 auto;padding:14px 5px; width:44%;background:#fff;color:#ed3f41;border:none;font-size:14px; line-height:16px;text-align:center;overflow:hidden;box-sizing:border-box;-webkit-appearance:none;" value="确 定" id="_ButtonOK_' + this.ID + '"/>\
              </div></td>\
          </tr>\
        </table></td>\
    </tr>\
