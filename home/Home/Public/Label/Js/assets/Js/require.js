...
var myScroll;
requirejs(['jquery','iscroll'], function($,iscroll) {
	$(document).ready(function(e) {
		...
		if($("#listPage").length>=1){
			myScroll.on('scrollEnd',function(){
				...
				var h = parseInt($("#wrapper").height() - $("#main").height());
				if(h<=this.y){return false;}
