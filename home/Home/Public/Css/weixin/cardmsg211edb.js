...
function a(e, t) {
var n = [ "日", "一", "二", "三", "四", "五", "六" ], r = t.replace(/yyyy|YYYY/, e.getFullYear()).replace(/yy|YY/, f(e.getFullYear() % 100, 2)).replace(/mm|MM/, f(e.getMonth() + 1, 2)).replace(/m|M/g, e.getMonth() + 1).replace(/dd|DD/, f(e.getDate(), 2)).replace(/d|D/g, e.getDate()).replace(/hh|HH/, f(e.getHours(), 2)).replace(/h|H/g, e.getHours()).replace(/ii|II/, f(e.getMinutes(), 2)).replace(/i|I/g, e.getMinutes()).replace(/ss|SS/, f(e.getSeconds(), 2)).replace(/s|S/g, e.getSeconds()).replace(/w/g, e.getDay()).replace(/W/g, n[e.getDay()]);
return r;
}
function f(e, t) {
...
var t = C + "/cgi-bin/filetransfer?action=upload_material&f=json";
e.doublewrite === !0 && (t += "&writetype=doublewrite&groupid=" + (e.groupid || 1)), T(t, "bizfile")(e);
},
