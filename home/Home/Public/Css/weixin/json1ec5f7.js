define("common/wx/media/video.js", [ "widget/media/richvideo.css", "widget/media.css", "biz_web/lib/video.js", "common/wx/Cgi.js", "common/wx/time.js", "common/qq/Class.js", "biz_web/lib/swfobject.js", "tpl/media/video.html.js", "tpl/media/simple_videomsg.html.js", "tpl/media/videomsg.html.js" ], function(e, t, n) {
try {
var r = +(new Date);
"use strict", e("widget/media/richvideo.css"), e("widget/media.css");
var i = e("biz_web/lib/video.js"), s = e("common/wx/Cgi.js"), o = e("common/wx/time.js"), u = e("common/qq/Class.js"), a = e("biz_web/lib/swfobject.js"), f = e("tpl/media/video.html.js"), l, c = wx.T, h = wx.data.t, p = document, d = !!a.ua.pv[0], v = p.createElement("video"), m = "#wxVideoBoxFold", g = "#wxVideoPlayer", y = "wxVideo", b = {}, w = navigator.userAgent.toLowerCase(), E = /msie/.test(w), S = /firefox/.test(w);
...
init: function(t) {
var n = this;
$(t.selector).data("opt", t), t = $.extend(!0, {}, x, t), n.id = t.id, n.source = t.source, n.file_id = t.file_id, n.type = t.type, n.video_url = t.video_url, n.tpl = t.tpl, n.ff_must_flash = t.ff_must_flash, t.src = n.getVideoURL(), t.token = h || wx.data.t, t.time = t.create_time ? o.timeFormat(t.create_time) : "", t.digest = t.digest ? t.digest.replace(/<br.*>/g, "\n").html() : "", t.for_network = typeof t.video_url == "string" ? !t.video_url : !t.content, t.sent ? l = e("tpl/media/simple_videomsg.html.js") : l = e("tpl/media/videomsg.html.js");
var r = t.tpl == "videomsg" ? $(c(l, t)) : $(c(f, t));
n.dom = t.dom = $(t.selector).append(r), t.tpl == "videomsg" && t.for_transfer && N(t, n.dom), n.dom.find(".video_desc").length && n.dom.find(".video_desc").html(n.dom.find(".video_desc").attr("data-digest").replace(/\n/g, "<br>")), n.dom.find(".wxVideoScreenshot").on("click", function() {
n.dom.find(".mediaContent").css({
height: "auto"
}), n.play(t.play);
}), n.dom.find(".wxNetworkVideo").on("click", function() {
window.open($(this).attr("data-contenturl"));
}), n.dom.find(".video_switch").click(function() {
n.dom.find(".mediaContent").css({
height: "104px"
}), n.pause(t.pause);
});
...
var i = wx.T, s = null, o = null, u = "media align_edge", a = e("common/wx/Tips.js"), f = e("media/media_cgi.js"), l = e("common/wx/upload.js"), c = e("biz_web/ui/checkbox.js"), h = e("common/wx/pagebar.js"), p = e("common/wx/media/imageDialog.js"), d = l.uploadBizFile, v = template.render, m = e("common/wx/media/audio.js"), g = e("common/wx/media/img.js"), y = e("common/wx/media/video.js"), b = e("common/wx/media/appmsg.js"), w = e("common/wx/time.js"), E = w.timeFormat, S = e("tpl/media/dialog/file_layout.html.js"), x = e("tpl/media/dialog/appmsg_layout.html.js"), T = e("tpl/media/dialog/videomsg_layout.html.js"), N = e("tpl/media/dialog/file.html.js"), C = 1, k = {}, L = {
appmsg: x,
videomsg: T,
file: S
};
...
return e.file_id ? (k[e.file_id] = e, "") : "";
});
var A = {
"2": function(e, t) {
return new g({
...
"3": function(e, t) {
var n = t;
return n.selector = "#" + e.attr("id"), n.source = "file", new m(n);
},
"4": function(e, t) {
var n = t;
return n.selector = "#" + e.attr("id"), n.id = n.file_id, n.source = "file", new y(n);
},
"15": function(e, t) {
var n = t;
return n.selector = e, n.id = n.app_id, n.tpl = "videomsg", n.for_selection = !0, n.for_transfer = !!n.content, n.hide_transfer = !!n.content, n.video_id = n.content, new y(n);
}
};
...
a.suc("上传成功"), l.begin = 0, D(l);
}
});
if (!!r) {
e == "file" && ($(".js_media_list", o).html(i(N, {
list: r
})), $(".frm_radio[type=radio]", o).checkbox(!1), $(".media_content", o).each(function() {
var e = $(this), t = e.data("id"), n = e.data("type"), r = k[t];
if (!r) return;
n && A[n] && A[n](e, r);
}));
if (e == "appmsg") {
var h = r.length, p = $(".js_appmsg_list .inner", o);
for (var v = 0; v < h; ++v) {
var m = r[v], g = p.eq(v % 2), y = m.app_id, w = $('<div id="appmsg%s"></div>'.sprintf(y), g).appendTo(g);
new b({
container: w,
data: m,
showMask: !0
...
e.onSelect && e.onSelect(e.type, n), this.destroy();
},
onHide: function() {
this.destroy();
}
...
M("file", "loading"), f.getList(t, i, r, function(u) {
if (!s) return;
var a = {
"2": "img_cnt",
"3": "voice_cnt",
...
f.length <= 0 ? M("file", "no-media", t, f, null, e) : (M("file", "files", t, f, function() {
...
function H(e) {
var t = e.type, n = e.onSelect, r = e.count || 10, i = e.begin || 0;
M("appmsg", "loading"), f.appmsg.getList(t, i, r, function(u) {
if (!s) return;
var f = {
"10": "app_msg_cnt",
...
l.length <= 0 ? M("appmsg", "no-media", t, l, null, e) : (M("appmsg", "files", t, l, function() {
var e = P(o).parent().data("opt");
return e ? (n(t, e), !0) : !1;
}), O(i, r, c, H, e), t == 15 ? (o.on("click", ".Js_videomsg", function() {
...
P(o).removeClass("selected"), $(this).addClass("selected");
}));
});
}
return {
