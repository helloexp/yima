;(function($){
	...
	var pcData = {'provinces':[]},//省市数据
		caData = {'cities':[]};//市区数据
	var defaultStr1 = '<a href="javascript:void(0);" val="-1">请选择省</a>',
		defaultStr2 = '<a href="javascript:void(0);" val="-1">请选择市</a>',
		defaultStr3 = '<a href="javascript:void(0);" val="-1">请选择县</a>',
		defaultId = -1,
		defaultName = '请选择市';
