				...
				if(ulContent !='' || inputContent!=''){
					...
					if(inputContent!=""){
					  	$("#Js_editorKeywordList li").each(function(){
							...
							var toappentContent = '<li class="item float-p"><input type="hidden" name="kwdId[]" value=><div class="val l">'+ appendContent +'</div><input type="text" name="keywordStr[]" class="val-input l" value="'+ appendContent +'" style="display:none;" maxlength="20" jscheckrule="null=0" jschecktitle="关键词"><button class="delKeyword btnGreenS" title="删除">删除</button><a href="javascript:;" class="keywordEditor" title="编辑">编辑</a><label class="c-gA matchMode r">模糊匹配</label><input type="hidden" name="matchMode[]" class="matchMode-input" value="0"></li>';
							uthis.closest("div.keywordsList").children(".keywordItems").append(toappentContent);
						});
						uthis.closest("div.keywordsList").children(".keywordItems").append(toappentinputContent);
					}else{
						$("#Js_editorKeywordList li").each(function(){
						var appendContent = $(this).find(".keywords_name").attr("data-content");
						var toappentContent = '<li class="item float-p"><input type="hidden" name="kwdId[]" value=><div class="val l">'+ appendContent +'</div><input type="text" name="keywordStr[]" class="val-input l" value="'+ appendContent +'" style="display:none;" maxlength="20" jscheckrule="null=0" jschecktitle="关键词"><button class="delKeyword btnGreenS" title="删除">删除</button><a href="javascript:;" class="keywordEditor" title="编辑">编辑</a><label class="c-gA matchMode r">模糊匹配</label><input type="hidden" name="matchMode[]" class="matchMode-input" value="0"></li>';
