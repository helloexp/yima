(function($) {
    $.fn.infinitescroll = function(options, callback) {
        ...
        function infscrSetup() {
            if (props.isDuringAjax || props.isInvalidp || props.isDone) return;
        ...
        function kickOffAjax() {
            ...
            box.load(path.join(props.currp) + ' ' + opts.itemSelector, null, loadCallback);
        }
        ...
        props.loadingMsg = $('<div id="infscr-loading" style="text-align: center;"><img alt="Loading..." src="' + opts.loadingImg + '" /><div>' + opts.loadingText + '</div></div>'); (new Image()).src = opts.loadingImg;
        $(document).ajaxError(function(e, xhr, opt) {
            debug('p not found. Self-destructing...');
            if (xhr.status == 404) {
                showDoneMsg();
                props.isDone = true;
    ...
    $.infinitescroll = {
        defaults: {
            ...
            loadingImg: "./Home/Label/Image/Item/loading.gif",
            loadingText: "<em>加载中...</em>",
            donetext: "<em>没有更多数据了</em>",
