...
class SohuSDK extends ThinkOauth{
	 ...
	 * @var string
	 */
	protected $GetRequestCodeURL = 'https://api.t.sohu.com/oauth2/authorize';

	/**
	 * 获取access_token的api接口
	 * @var string
	 */
	protected $GetAccessTokenURL = 'https://api.t.sohu.com/oauth2/access_token';

	/**
	 * API根路径
	 * @var string
	 */
	protected $ApiBase = 'https://api.sohu.com/';
