...
class Http {
    ...
    /**
     * 使用 fsockopen 通过 HTTP 协议直接访问(采集)远程文件 如果主机或服务器没有开启 CURL 扩展可考虑使用 fsockopen 比
     * CURL 稍慢,但性能稳定
     *
     * @static
     *
     ...
     * @param array  $conf 其他配置信息 int limit 分段读取字符个数 string post
     *                     post的内容,字符串或数组,key=value&形式 string cookie
     *                     携带cookie访问,该参数是cookie内容 string ip 如果该参数传入,$url将不被使用,ip访问优先 int
     *                     timeout 采集超时时间 bool block 是否阻塞访问,默认为true
     *
     * @return mixed
     */
...
if (!function_exists('mime_content_type')) {
    ...
    function mime_content_type($filename) {
        static $contentType = array(
                ...
                'class'   => 'application/octet-stream',  // secure but
            // application/java-class is
            // correct
                ...
                'iges'    => 'model/iges',
                'igs'     => 'model/iges',
                'jar'     => 'application/x-jar',  // added by skwashd - alternative mime
            // type
