                    ...
                    open: function (opts) {
                        ...
                        $q.all({
                            ...
                            $dialog.html((options.overlay ?
                                '<div class="ngdialog-overlay"></div><div class="ngdialog-content" style="width:'+options.width+'px" role="document">' + template + '</div>' :
                                '<div class="ngdialog-content" style="width:'+options.width+'px" role="document">' + template + '</div>'));
